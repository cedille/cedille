...
\textit{ff}.  For example, $\delta\ \mhyph x$ has type
...
also non-normalizing, for a very similar reason, but this fact
...
can guarantee properties like normalization, as demonstrated by the following
theorem:
