...
cedille-start _ws-plus-59 = (just "P182" , nothing , just _ws-plus-59 , inj₁ _aws :: inj₁ _ws-plus-59 :: []) :: (just "P181" , nothing , just _ws-plus-59 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P183" , nothing , just _ws , inj₁ _ws-plus-59 :: []) :: []
...
cedille-start _ows-star-60 = (just "P185" , nothing , just _ows-star-60 , inj₁ _aws :: inj₁ _ows-star-60 :: []) :: (just "P184" , nothing , just _ows-star-60 , []) :: []
cedille-start _ows = (just "P186" , nothing , just _ows , inj₁ _ows-star-60 :: []) :: []
...
cedille-start _comment-star-55 = (just "P172" , nothing , just _comment-star-55 , inj₁ _anychar :: inj₁ _comment-star-55 :: []) :: (just "P171" , nothing , just _comment-star-55 , []) :: []
cedille-start _comment = (just "P173" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-55 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-56 = (just "P175" , nothing , just _aws-bar-56 , inj₁ _comment :: []) :: (just "P174" , nothing , just _aws-bar-56 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P180" , nothing , just _aws , inj₁ _aws-bar-58 :: []) :: []
cedille-start _anychar-bar-54 = (just "P169" , nothing , just _anychar-bar-54 , inj₁ _anychar-bar-53 :: []) :: (just "P168" , nothing , just _anychar-bar-54 , inj₁ _varone :: []) :: []
...
cedille-start _anychar-bar-51 = (just "P163" , nothing , just _anychar-bar-51 , inj₁ _anychar-bar-50 :: []) :: (just "P162" , nothing , just _anychar-bar-51 , inj₂ '𝒌' :: []) :: []
...
cedille-start _anychar-bar-49 = (just "P159" , nothing , just _anychar-bar-49 , inj₁ _anychar-bar-48 :: []) :: (just "P158" , nothing , just _anychar-bar-49 , inj₂ '1' :: []) :: []
cedille-start _anychar-bar-48 = (just "P157" , nothing , just _anychar-bar-48 , inj₁ _anychar-bar-47 :: []) :: (just "P156" , nothing , just _anychar-bar-48 , inj₂ '2' :: []) :: []
...
cedille-start _anychar-bar-44 = (just "P149" , nothing , just _anychar-bar-44 , inj₁ _anychar-bar-43 :: []) :: (just "P148" , nothing , just _anychar-bar-44 , inj₂ 'Π' :: []) :: []
cedille-start _anychar-bar-43 = (just "P147" , nothing , just _anychar-bar-43 , inj₁ _anychar-bar-42 :: []) :: (just "P146" , nothing , just _anychar-bar-43 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-42 = (just "P145" , nothing , just _anychar-bar-42 , inj₁ _anychar-bar-41 :: []) :: (just "P144" , nothing , just _anychar-bar-42 , inj₂ 'λ' :: []) :: []
...
cedille-start _anychar-bar-40 = (just "P141" , nothing , just _anychar-bar-40 , inj₁ _anychar-bar-39 :: []) :: (just "P140" , nothing , just _anychar-bar-40 , inj₂ 'π' :: []) :: []
...
cedille-start _anychar-bar-36 = (just "P133" , nothing , just _anychar-bar-36 , inj₁ _anychar-bar-35 :: []) :: (just "P132" , nothing , just _anychar-bar-36 , inj₂ 'ξ' :: []) :: []
...
cedille-start _anychar-bar-33 = (just "P127" , nothing , just _anychar-bar-33 , inj₁ _anychar-bar-32 :: []) :: (just "P126" , nothing , just _anychar-bar-33 , inj₂ 'ν' :: []) :: []
...
cedille-start _anychar-bar-30 = (just "P121" , nothing , just _anychar-bar-30 , inj₁ _anychar-bar-29 :: []) :: (just "P120" , nothing , just _anychar-bar-30 , inj₂ '𝓤' :: []) :: []
...
cedille-start _anychar-bar-24 = (just "P109" , nothing , just _anychar-bar-24 , inj₁ _anychar-bar-23 :: []) :: (just "P108" , nothing , just _anychar-bar-24 , inj₂ 'χ' :: []) :: []
cedille-start _anychar-bar-23 = (just "P107" , nothing , just _anychar-bar-23 , inj₁ _anychar-bar-22 :: []) :: (just "P106" , nothing , just _anychar-bar-23 , inj₂ 'β' :: []) :: []
cedille-start _anychar-bar-22 = (just "P105" , nothing , just _anychar-bar-22 , inj₁ _anychar-bar-21 :: []) :: (just "P104" , nothing , just _anychar-bar-22 , inj₂ 'δ' :: []) :: []
cedille-start _anychar-bar-21 = (just "P103" , nothing , just _anychar-bar-21 , inj₁ _anychar-bar-20 :: []) :: (just "P102" , nothing , just _anychar-bar-21 , inj₂ 'ζ' :: []) :: []
...
cedille-start _anychar-bar-12 = (just "P85" , nothing , just _anychar-bar-12 , inj₁ _anychar-bar-11 :: []) :: (just "P84" , nothing , just _anychar-bar-12 , inj₂ '~' :: []) :: []
cedille-start _anychar-bar-11 = (just "P83" , nothing , just _anychar-bar-11 , inj₁ _numone :: []) :: (just "P82" , nothing , just _anychar-bar-11 , inj₂ 'η' :: []) :: []
cedille-start _anychar = (just "P170" , nothing , just _anychar , inj₁ _anychar-bar-54 :: []) :: []
...
len-dec-rewrite {- P102-} ((Id "P102") :: _::_(InputChar 'ζ') rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P103-} ((Id "P103") :: _::_(ParseTree parsed-anychar-bar-20) rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar 'δ') rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(ParseTree parsed-anychar-bar-21) rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-anychar-bar-23 ::' rest , 2)
len-dec-rewrite {- P107-} ((Id "P107") :: _::_(ParseTree parsed-anychar-bar-22) rest) = just (ParseTree parsed-anychar-bar-23 ::' rest , 2)
len-dec-rewrite {- P108-} ((Id "P108") :: _::_(InputChar 'χ') rest) = just (ParseTree parsed-anychar-bar-24 ::' rest , 2)
...
len-dec-rewrite {- P120-} ((Id "P120") :: _::_(InputChar '𝓤') rest) = just (ParseTree parsed-anychar-bar-30 ::' rest , 2)
...
len-dec-rewrite {- P126-} ((Id "P126") :: _::_(InputChar 'ν') rest) = just (ParseTree parsed-anychar-bar-33 ::' rest , 2)
...
len-dec-rewrite {- P132-} ((Id "P132") :: _::_(InputChar 'ξ') rest) = just (ParseTree parsed-anychar-bar-36 ::' rest , 2)
...
len-dec-rewrite {- P140-} ((Id "P140") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-anychar-bar-40 ::' rest , 2)
...
len-dec-rewrite {- P144-} ((Id "P144") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-42 ::' rest , 2)
len-dec-rewrite {- P145-} ((Id "P145") :: _::_(ParseTree parsed-anychar-bar-41) rest) = just (ParseTree parsed-anychar-bar-42 ::' rest , 2)
len-dec-rewrite {- P146-} ((Id "P146") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-43 ::' rest , 2)
len-dec-rewrite {- P147-} ((Id "P147") :: _::_(ParseTree parsed-anychar-bar-42) rest) = just (ParseTree parsed-anychar-bar-43 ::' rest , 2)
len-dec-rewrite {- P148-} ((Id "P148") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-anychar-bar-44 ::' rest , 2)
...
len-dec-rewrite {- P156-} ((Id "P156") :: _::_(InputChar '2') rest) = just (ParseTree parsed-anychar-bar-48 ::' rest , 2)
len-dec-rewrite {- P157-} ((Id "P157") :: _::_(ParseTree parsed-anychar-bar-47) rest) = just (ParseTree parsed-anychar-bar-48 ::' rest , 2)
len-dec-rewrite {- P158-} ((Id "P158") :: _::_(InputChar '1') rest) = just (ParseTree parsed-anychar-bar-49 ::' rest , 2)
...
len-dec-rewrite {- P162-} ((Id "P162") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-51 ::' rest , 2)
...
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(ParseTree (parsed-varone x0)) rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(ParseTree parsed-anychar-bar-54) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-55) rest) = just (ParseTree parsed-comment-star-55 ::' rest , 3)
len-dec-rewrite {- P173-} ((Id "P173") :: (InputChar '%') :: (ParseTree parsed-comment-star-55) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-56 ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-56 ::' rest , 2)
...
len-dec-rewrite {- P180-} ((Id "P180") :: _::_(ParseTree parsed-aws-bar-58) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-59 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-59) rest) = just (ParseTree parsed-ws-plus-59 ::' rest , 3)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree parsed-ws-plus-59) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-60) rest) = just (ParseTree parsed-ows-star-60 ::' rest , 3)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(ParseTree parsed-ows-star-60) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P82-} ((Id "P82") :: _::_(InputChar 'η') rest) = just (ParseTree parsed-anychar-bar-11 ::' rest , 2)
len-dec-rewrite {- P83-} ((Id "P83") :: _::_(ParseTree (parsed-numone x0)) rest) = just (ParseTree parsed-anychar-bar-11 ::' rest , 2)
len-dec-rewrite {- P84-} ((Id "P84") :: _::_(InputChar '~') rest) = just (ParseTree parsed-anychar-bar-12 ::' rest , 2)
...
len-dec-rewrite {- P171-} (_::_(Id "P171") rest) = just (ParseTree parsed-comment-star-55 ::' rest , 1)
len-dec-rewrite {- P184-} (_::_(Id "P184") rest) = just (ParseTree parsed-ows-star-60 ::' rest , 1)
