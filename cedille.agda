...
cedille-start _evidence = (just "embed" , just "embed_end" , just _evidence , inj₁ _levidence :: []) :: (just "Xi" , nothing , just _evidence , inj₂ 'ξ' :: inj₁ _ows :: inj₁ _var :: inj₁ _opt_eclass :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Rbeta" , nothing , just _evidence , inj₂ 'r' :: inj₂ 'β' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₁ _term :: []) :: (just "Pair" , nothing , just _evidence , inj₂ '[' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ']' :: []) :: (just "Eta" , nothing , just _evidence , inj₂ 'η' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₁ _term :: []) :: (just "Eprint" , nothing , just _evidence , inj₂ '?' :: inj₁ _showCtxt :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Enu" , nothing , just _evidence , inj₂ 'ν' :: inj₁ _ws :: inj₁ _var :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₂ '[' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ']' :: []) :: (just "Elift" , nothing , just _evidence , inj₂ '↑' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Elet" , nothing , just _evidence , inj₂ 'δ' :: inj₁ _ws :: inj₁ _def :: inj₁ _ws :: inj₂ '-' :: inj₁ _ws :: inj₁ _evidence :: []) :: (just "Ctora" , nothing , just _evidence , inj₂ 'ζ' :: inj₁ _ws :: inj₁ _var :: []) :: (just "Ctor" , nothing , just _evidence , inj₂ 'ζ' :: inj₁ _ws :: inj₁ _evidence :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _type :: []) :: (just "Cast" , nothing , just _evidence , inj₂ 'χ' :: inj₁ _ws :: inj₁ _evidence :: inj₁ _ows :: inj₁ _castDir :: inj₁ _ows :: inj₁ _evidence :: []) :: []
...
len-dec-rewrite {- Eta-} ((Id "Eta") :: (InputChar 'η') :: (ParseTree parsed-ows) :: (ParseTree (parsed-evidence x0)) :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-term x1)) rest) = just (ParseTree (parsed-evidence (norm-evidence (Eta x0 x1))) ::' rest , 6)
...
len-dec-rewrite {- Rbeta-} ((Id "Rbeta") :: (InputChar 'r') :: (InputChar 'β') :: (ParseTree parsed-ows) :: (ParseTree (parsed-evidence x0)) :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-term x1)) rest) = just (ParseTree (parsed-evidence (norm-evidence (Rbeta x0 x1))) ::' rest , 7)
