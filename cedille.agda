...
cedille-start _decl = (just "Decl" , nothing , just _decl , inj₂ '(' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _tk :: inj₁ _ows :: inj₂ ')' :: []) :: []
...
len-dec-rewrite {- Decl-} ((Id "Decl") :: (InputChar '(') :: (ParseTree parsed-ows) :: (ParseTree (parsed-var x0)) :: (ParseTree parsed-ows) :: (InputChar ':') :: (ParseTree parsed-ows) :: (ParseTree (parsed-tk x1)) :: (ParseTree parsed-ows) :: _::_(InputChar ')') rest) = just (ParseTree (parsed-decl (norm-decl (Decl x0 x1))) ::' rest , 10)
...
len-dec-rewrite {- Rec-} ((Id "Rec") :: (InputChar 'r') :: (InputChar 'e') :: (InputChar 'c') :: (ParseTree parsed-ws) :: (ParseTree (parsed-var x0)) :: (ParseTree (parsed-decls x1)) :: (ParseTree (parsed-indices x2)) :: (ParseTree parsed-ows) :: (InputChar '|') :: (ParseTree (parsed-ctordecls x3)) :: (ParseTree parsed-ows) :: (InputChar '=') :: (ParseTree parsed-ows) :: (ParseTree (parsed-type x4)) :: (ParseTree parsed-ws) :: (InputChar 'w') :: (InputChar 'i') :: (InputChar 't') :: (InputChar 'h') :: (ParseTree (parsed-udefs x5)) :: (ParseTree parsed-ows) :: _::_(InputChar '.') rest) = just (ParseTree (parsed-cmd (norm-cmd (Rec x0 x1 x2 x3 x4 x5))) ::' rest , 23)
