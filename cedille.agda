...
cedille-start _ltype = (just "TpVar" , nothing , just _ltype , inj₁ _posinfo :: inj₁ _var :: []) :: (just "TpParens" , nothing , just _ltype , inj₂ '(' :: inj₁ _ows :: inj₁ _type :: inj₁ _ows :: inj₂ ')' :: []) :: (just "TpEq" , nothing , just _ltype , inj₁ _lterm :: inj₁ _ows :: inj₂ '≃' :: inj₁ _ows :: inj₁ _lterm :: []) :: (just "Lft" , nothing , just _ltype , inj₂ '↑' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _lliftingType :: []) :: []
cedille-start _lterm = (just "Var" , nothing , just _lterm , inj₁ _posinfo :: inj₁ _var :: []) :: (just "Parens" , nothing , just _lterm , inj₂ '(' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ')' :: []) :: (just "Hole" , nothing , just _lterm , inj₂ '●' :: []) :: []
