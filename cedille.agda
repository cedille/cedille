...
cedille-start _cmdTerminator = (just "Normalize" , nothing , just _cmdTerminator , inj₂ '!' :: inj₂ '!' :: []) :: (just "Hnf" , nothing , just _cmdTerminator , inj₂ '!' :: []) :: (just "EraseOnly" , nothing , just _cmdTerminator , inj₂ '.' :: []) :: []
...
len-dec-rewrite {- Hnf-} ((Id "Hnf") :: _::_(InputChar '!') rest) = just (ParseTree (parsed-cmdTerminator (norm-cmdTerminator Hnf)) ::' rest , 2)
...
len-dec-rewrite {- Normalize-} ((Id "Normalize") :: (InputChar '!') :: _::_(InputChar '!') rest) = just (ParseTree (parsed-cmdTerminator (norm-cmdTerminator Normalize)) ::' rest , 3)
