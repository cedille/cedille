...
data gratr2-nt : Set where
  ...
  _showCtxt : gratr2-nt
  _posinfo : gratr2-nt
  _ows-star-61 : gratr2-nt
  _ows : gratr2-nt
  _opt_eclass : gratr2-nt
  _numone-range-9 : gratr2-nt
  _numone : gratr2-nt
  _num-plus-10 : gratr2-nt
  _num : gratr2-nt
  _ltype : gratr2-nt
  _lterm : gratr2-nt
  ...
  _def : gratr2-nt
  _ctorset : gratr2-nt
  _comment-star-56 : gratr2-nt
  _comment : gratr2-nt
  _cmds : gratr2-nt
  _cmd : gratr2-nt
  _class : gratr2-nt
  _castDir : gratr2-nt
  _aws-bar-59 : gratr2-nt
  _aws-bar-58 : gratr2-nt
  _aws-bar-57 : gratr2-nt
  _aws : gratr2-nt
  _anychar-bar-55 : gratr2-nt
...
gratr2-nt-eq  _ws-plus-60 _ws-plus-60 = tt
...
gratr2-nt-eq  _ows-star-61 _ows-star-61 = tt
gratr2-nt-eq  _ows _ows = tt
gratr2-nt-eq  _opt_eclass _opt_eclass = tt
gratr2-nt-eq  _numone-range-9 _numone-range-9 = tt
gratr2-nt-eq  _numone _numone = tt
gratr2-nt-eq  _num-plus-10 _num-plus-10 = tt
...
gratr2-nt-eq  _comment-star-56 _comment-star-56 = tt
...
cedille-start _ws-plus-60 = (just "P184" , nothing , just _ws-plus-60 , inj₁ _aws :: inj₁ _ws-plus-60 :: []) :: (just "P183" , nothing , just _ws-plus-60 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P185" , nothing , just _ws , inj₁ _ws-plus-60 :: []) :: []
...
cedille-start _ows-star-61 = (just "P187" , nothing , just _ows-star-61 , inj₁ _aws :: inj₁ _ows-star-61 :: []) :: (just "P186" , nothing , just _ows-star-61 , []) :: []
cedille-start _ows = (just "P188" , nothing , just _ows , inj₁ _ows-star-61 :: []) :: []
...
cedille-start _numone-range-9 = (just "P77" , nothing , just _numone-range-9 , inj₂ '9' :: []) :: (just "P76" , nothing , just _numone-range-9 , inj₂ '8' :: []) :: (just "P75" , nothing , just _numone-range-9 , inj₂ '7' :: []) :: (just "P74" , nothing , just _numone-range-9 , inj₂ '6' :: []) :: (just "P73" , nothing , just _numone-range-9 , inj₂ '5' :: []) :: (just "P72" , nothing , just _numone-range-9 , inj₂ '4' :: []) :: (just "P71" , nothing , just _numone-range-9 , inj₂ '3' :: []) :: (just "P70" , nothing , just _numone-range-9 , inj₂ '2' :: []) :: (just "P69" , nothing , just _numone-range-9 , inj₂ '1' :: []) :: (just "P68" , nothing , just _numone-range-9 , inj₂ '0' :: []) :: []
cedille-start _numone = (just "P78" , nothing , just _numone , inj₁ _numone-range-9 :: []) :: []
cedille-start _num-plus-10 = (just "P80" , nothing , just _num-plus-10 , inj₁ _numone :: inj₁ _num-plus-10 :: []) :: (just "P79" , nothing , just _num-plus-10 , inj₁ _numone :: []) :: []
cedille-start _num = (just "P81" , nothing , just _num , inj₁ _num-plus-10 :: []) :: []
cedille-start _ltype = (just "U" , nothing , just _ltype , inj₂ '𝓤' :: []) :: (just "TpVar" , nothing , just _ltype , inj₁ _var :: []) :: (just "TpParens" , nothing , just _ltype , inj₂ '(' :: inj₁ _ows :: inj₁ _type :: inj₁ _ows :: inj₂ ')' :: []) :: (just "TpEq" , nothing , just _ltype , inj₁ _term :: inj₁ _ows :: inj₂ '≃' :: inj₁ _ows :: inj₁ _term :: []) :: (just "Lft" , nothing , just _ltype , inj₂ '↑' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _lliftingType :: []) :: []
...
cedille-start _evidence = (just "embed" , just "embed_end" , just _evidence , inj₁ _levidence :: []) :: (just "Xi" , nothing , just _evidence , inj₂ 'ξ' :: inj₁ _ows :: inj₁ _var :: inj₁ _opt_eclass :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Rbeta" , nothing , just _evidence , inj₂ 'r' :: inj₂ 'β' :: inj₁ _ws :: inj₁ _evidence :: inj₁ _ws :: inj₁ _term :: inj₁ _ows :: inj₂ '⇒' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Pair" , nothing , just _evidence , inj₂ '[' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ']' :: []) :: (just "LamCong" , nothing , just _evidence , inj₂ 'ξ' :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "EtaAll" , nothing , just _evidence , inj₂ 'η' :: inj₂ '∀' :: inj₁ _ws :: inj₁ _evidence :: inj₁ _ws :: inj₁ _term :: []) :: (just "Eprint" , nothing , just _evidence , inj₂ '?' :: inj₁ _showCtxt :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Enu" , nothing , just _evidence , inj₂ 'ν' :: inj₁ _ws :: inj₁ _var :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₂ '[' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ']' :: []) :: (just "EliftCong" , nothing , just _evidence , inj₂ '↑' :: inj₂ 'c' :: inj₁ _ws :: inj₁ _evidence :: []) :: (just "Elift" , nothing , just _evidence , inj₂ '↑' :: inj₁ _ws :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Elet" , nothing , just _evidence , inj₂ 'δ' :: inj₁ _ws :: inj₁ _def :: inj₁ _ws :: inj₂ '-' :: inj₁ _ws :: inj₁ _evidence :: []) :: (just "Ctora" , nothing , just _evidence , inj₂ 'ζ' :: inj₁ _ws :: inj₁ _var :: []) :: (just "Ctor" , nothing , just _evidence , inj₂ 'ζ' :: inj₁ _ws :: inj₁ _evidence :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _type :: []) :: (just "Cast" , nothing , just _evidence , inj₂ 'χ' :: inj₁ _ws :: inj₁ _evidence :: inj₁ _ows :: inj₁ _castDir :: inj₁ _ows :: inj₁ _evidence :: []) :: []
...
cedille-start _comment-star-56 = (just "P174" , nothing , just _comment-star-56 , inj₁ _anychar :: inj₁ _comment-star-56 :: []) :: (just "P173" , nothing , just _comment-star-56 , []) :: []
cedille-start _comment = (just "P175" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-56 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-59 = (just "P181" , nothing , just _aws-bar-59 , inj₁ _aws-bar-58 :: []) :: (just "P180" , nothing , just _aws-bar-59 , inj₂ '\n' :: []) :: []
cedille-start _aws-bar-58 = (just "P179" , nothing , just _aws-bar-58 , inj₁ _aws-bar-57 :: []) :: (just "P178" , nothing , just _aws-bar-58 , inj₂ '\t' :: []) :: []
cedille-start _aws-bar-57 = (just "P177" , nothing , just _aws-bar-57 , inj₁ _comment :: []) :: (just "P176" , nothing , just _aws-bar-57 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P182" , nothing , just _aws , inj₁ _aws-bar-59 :: []) :: []
cedille-start _anychar-bar-55 = (just "P171" , nothing , just _anychar-bar-55 , inj₁ _anychar-bar-54 :: []) :: (just "P170" , nothing , just _anychar-bar-55 , inj₁ _varone :: []) :: []
cedille-start _anychar-bar-54 = (just "P169" , nothing , just _anychar-bar-54 , inj₁ _anychar-bar-53 :: []) :: (just "P168" , nothing , just _anychar-bar-54 , inj₂ '\t' :: []) :: []
cedille-start _anychar-bar-53 = (just "P167" , nothing , just _anychar-bar-53 , inj₁ _anychar-bar-52 :: []) :: (just "P166" , nothing , just _anychar-bar-53 , inj₂ ' ' :: []) :: []
cedille-start _anychar-bar-52 = (just "P165" , nothing , just _anychar-bar-52 , inj₁ _anychar-bar-51 :: []) :: (just "P164" , nothing , just _anychar-bar-52 , inj₂ '𝒌' :: []) :: []
cedille-start _anychar-bar-51 = (just "P163" , nothing , just _anychar-bar-51 , inj₁ _anychar-bar-50 :: []) :: (just "P162" , nothing , just _anychar-bar-51 , inj₂ '%' :: []) :: []
cedille-start _anychar-bar-50 = (just "P161" , nothing , just _anychar-bar-50 , inj₁ _anychar-bar-49 :: []) :: (just "P160" , nothing , just _anychar-bar-50 , inj₂ '1' :: []) :: []
cedille-start _anychar-bar-49 = (just "P159" , nothing , just _anychar-bar-49 , inj₁ _anychar-bar-48 :: []) :: (just "P158" , nothing , just _anychar-bar-49 , inj₂ '2' :: []) :: []
...
cedille-start _anychar-bar-46 = (just "P153" , nothing , just _anychar-bar-46 , inj₁ _anychar-bar-45 :: []) :: (just "P152" , nothing , just _anychar-bar-46 , inj₂ '□' :: []) :: []
cedille-start _anychar-bar-45 = (just "P151" , nothing , just _anychar-bar-45 , inj₁ _anychar-bar-44 :: []) :: (just "P150" , nothing , just _anychar-bar-45 , inj₂ 'Π' :: []) :: []
cedille-start _anychar-bar-44 = (just "P149" , nothing , just _anychar-bar-44 , inj₁ _anychar-bar-43 :: []) :: (just "P148" , nothing , just _anychar-bar-44 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-43 = (just "P147" , nothing , just _anychar-bar-43 , inj₁ _anychar-bar-42 :: []) :: (just "P146" , nothing , just _anychar-bar-43 , inj₂ 'λ' :: []) :: []
cedille-start _anychar-bar-42 = (just "P145" , nothing , just _anychar-bar-42 , inj₁ _anychar-bar-41 :: []) :: (just "P144" , nothing , just _anychar-bar-42 , inj₂ '∀' :: []) :: []
cedille-start _anychar-bar-41 = (just "P143" , nothing , just _anychar-bar-41 , inj₁ _anychar-bar-40 :: []) :: (just "P142" , nothing , just _anychar-bar-41 , inj₂ 'π' :: []) :: []
...
cedille-start _anychar-bar-37 = (just "P135" , nothing , just _anychar-bar-37 , inj₁ _anychar-bar-36 :: []) :: (just "P134" , nothing , just _anychar-bar-37 , inj₂ 'ξ' :: []) :: []
...
cedille-start _anychar-bar-34 = (just "P129" , nothing , just _anychar-bar-34 , inj₁ _anychar-bar-33 :: []) :: (just "P128" , nothing , just _anychar-bar-34 , inj₂ 'ν' :: []) :: []
...
cedille-start _anychar-bar-31 = (just "P123" , nothing , just _anychar-bar-31 , inj₁ _anychar-bar-30 :: []) :: (just "P122" , nothing , just _anychar-bar-31 , inj₂ '𝓤' :: []) :: []
...
cedille-start _anychar-bar-25 = (just "P111" , nothing , just _anychar-bar-25 , inj₁ _anychar-bar-24 :: []) :: (just "P110" , nothing , just _anychar-bar-25 , inj₂ 'χ' :: []) :: []
cedille-start _anychar-bar-24 = (just "P109" , nothing , just _anychar-bar-24 , inj₁ _anychar-bar-23 :: []) :: (just "P108" , nothing , just _anychar-bar-24 , inj₂ 'β' :: []) :: []
cedille-start _anychar-bar-23 = (just "P107" , nothing , just _anychar-bar-23 , inj₁ _anychar-bar-22 :: []) :: (just "P106" , nothing , just _anychar-bar-23 , inj₂ 'δ' :: []) :: []
cedille-start _anychar-bar-22 = (just "P105" , nothing , just _anychar-bar-22 , inj₁ _anychar-bar-21 :: []) :: (just "P104" , nothing , just _anychar-bar-22 , inj₂ 'ζ' :: []) :: []
cedille-start _anychar-bar-21 = (just "P103" , nothing , just _anychar-bar-21 , inj₁ _anychar-bar-20 :: []) :: (just "P102" , nothing , just _anychar-bar-21 , inj₂ '[' :: []) :: []
cedille-start _anychar-bar-20 = (just "P101" , nothing , just _anychar-bar-20 , inj₁ _anychar-bar-19 :: []) :: (just "P100" , nothing , just _anychar-bar-20 , inj₂ ']' :: []) :: []
...
cedille-start _anychar-bar-18 = (just "P97" , nothing , just _anychar-bar-18 , inj₁ _anychar-bar-17 :: []) :: (just "P96" , nothing , just _anychar-bar-18 , inj₂ '!' :: []) :: []
...
cedille-start _anychar-bar-16 = (just "P93" , nothing , just _anychar-bar-16 , inj₁ _anychar-bar-15 :: []) :: (just "P92" , nothing , just _anychar-bar-16 , inj₂ '}' :: []) :: []
cedille-start _anychar-bar-15 = (just "P91" , nothing , just _anychar-bar-15 , inj₁ _anychar-bar-14 :: []) :: (just "P90" , nothing , just _anychar-bar-15 , inj₂ '⇒' :: []) :: []
...
cedille-start _anychar-bar-13 = (just "P87" , nothing , just _anychar-bar-13 , inj₁ _anychar-bar-12 :: []) :: (just "P86" , nothing , just _anychar-bar-13 , inj₂ '~' :: []) :: []
cedille-start _anychar-bar-12 = (just "P85" , nothing , just _anychar-bar-12 , inj₁ _anychar-bar-11 :: []) :: (just "P84" , nothing , just _anychar-bar-12 , inj₂ 'η' :: []) :: []
cedille-start _anychar-bar-11 = (just "P83" , nothing , just _anychar-bar-11 , inj₂ '*' :: []) :: (just "P82" , nothing , just _anychar-bar-11 , inj₁ _numone :: []) :: []
cedille-start _anychar = (just "P172" , nothing , just _anychar , inj₁ _anychar-bar-55 :: []) :: []
...
len-dec-rewrite {- BetaAll-} ((Id "BetaAll") :: (InputChar 'β') :: _::_(InputChar '*') rest) = just (ParseTree (parsed-levidence (norm-evidence BetaAll)) ::' rest , 3)
...
len-dec-rewrite {- EholeSilent-} ((Id "EholeSilent") :: (InputChar '●') :: _::_(InputChar '.') rest) = just (ParseTree (parsed-levidence (norm-evidence EholeSilent)) ::' rest , 3)
...
len-dec-rewrite {- Elift-} ((Id "Elift") :: (InputChar '↑') :: (ParseTree parsed-ws) :: (ParseTree (parsed-var x0)) :: (ParseTree parsed-ows) :: (InputChar '.') :: (ParseTree parsed-ows) :: (ParseTree (parsed-evidence x1)) :: (ParseTree parsed-ows) :: (InputChar ':') :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-evidence x2)) rest) = just (ParseTree (parsed-evidence (norm-evidence (Elift x0 x1 x2))) ::' rest , 12)
len-dec-rewrite {- EliftCong-} ((Id "EliftCong") :: (InputChar '↑') :: (InputChar 'c') :: (ParseTree parsed-ws) :: _::_(ParseTree (parsed-evidence x0)) rest) = just (ParseTree (parsed-evidence (norm-evidence (EliftCong x0))) ::' rest , 5)
...
len-dec-rewrite {- EtaAll-} ((Id "EtaAll") :: (InputChar 'η') :: (InputChar '∀') :: (ParseTree parsed-ws) :: (ParseTree (parsed-evidence x0)) :: (ParseTree parsed-ws) :: _::_(ParseTree (parsed-term x1)) rest) = just (ParseTree (parsed-evidence (norm-evidence (EtaAll x0 x1))) ::' rest , 7)
len-dec-rewrite {- EtaLift-} ((Id "EtaLift") :: (InputChar 'η') :: (InputChar '↑') :: (ParseTree parsed-ws) :: _::_(ParseTree (parsed-num x0)) rest) = just (ParseTree (parsed-levidence (norm-evidence (EtaLift x0))) ::' rest , 5)
...
len-dec-rewrite {- LamCong-} ((Id "LamCong") :: (InputChar 'ξ') :: (ParseTree parsed-ows) :: (InputChar '.') :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-evidence x0)) rest) = just (ParseTree (parsed-evidence (norm-evidence (LamCong x0))) ::' rest , 6)
...
len-dec-rewrite {- P100-} ((Id "P100") :: _::_(InputChar ']') rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P101-} ((Id "P101") :: _::_(ParseTree parsed-anychar-bar-19) rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P102-} ((Id "P102") :: _::_(InputChar '[') rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P103-} ((Id "P103") :: _::_(ParseTree parsed-anychar-bar-20) rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar 'ζ') rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(ParseTree parsed-anychar-bar-21) rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar 'δ') rest) = just (ParseTree parsed-anychar-bar-23 ::' rest , 2)
len-dec-rewrite {- P107-} ((Id "P107") :: _::_(ParseTree parsed-anychar-bar-22) rest) = just (ParseTree parsed-anychar-bar-23 ::' rest , 2)
len-dec-rewrite {- P108-} ((Id "P108") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-anychar-bar-24 ::' rest , 2)
...
len-dec-rewrite {- P110-} ((Id "P110") :: _::_(InputChar 'χ') rest) = just (ParseTree parsed-anychar-bar-25 ::' rest , 2)
...
len-dec-rewrite {- P122-} ((Id "P122") :: _::_(InputChar '𝓤') rest) = just (ParseTree parsed-anychar-bar-31 ::' rest , 2)
...
len-dec-rewrite {- P128-} ((Id "P128") :: _::_(InputChar 'ν') rest) = just (ParseTree parsed-anychar-bar-34 ::' rest , 2)
...
len-dec-rewrite {- P134-} ((Id "P134") :: _::_(InputChar 'ξ') rest) = just (ParseTree parsed-anychar-bar-37 ::' rest , 2)
...
len-dec-rewrite {- P142-} ((Id "P142") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-anychar-bar-41 ::' rest , 2)
len-dec-rewrite {- P143-} ((Id "P143") :: _::_(ParseTree parsed-anychar-bar-40) rest) = just (ParseTree parsed-anychar-bar-41 ::' rest , 2)
len-dec-rewrite {- P144-} ((Id "P144") :: _::_(InputChar '∀') rest) = just (ParseTree parsed-anychar-bar-42 ::' rest , 2)
len-dec-rewrite {- P145-} ((Id "P145") :: _::_(ParseTree parsed-anychar-bar-41) rest) = just (ParseTree parsed-anychar-bar-42 ::' rest , 2)
len-dec-rewrite {- P146-} ((Id "P146") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-43 ::' rest , 2)
len-dec-rewrite {- P147-} ((Id "P147") :: _::_(ParseTree parsed-anychar-bar-42) rest) = just (ParseTree parsed-anychar-bar-43 ::' rest , 2)
len-dec-rewrite {- P148-} ((Id "P148") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-44 ::' rest , 2)
...
len-dec-rewrite {- P150-} ((Id "P150") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-anychar-bar-45 ::' rest , 2)
len-dec-rewrite {- P151-} ((Id "P151") :: _::_(ParseTree parsed-anychar-bar-44) rest) = just (ParseTree parsed-anychar-bar-45 ::' rest , 2)
len-dec-rewrite {- P152-} ((Id "P152") :: _::_(InputChar '□') rest) = just (ParseTree parsed-anychar-bar-46 ::' rest , 2)
...
len-dec-rewrite {- P158-} ((Id "P158") :: _::_(InputChar '2') rest) = just (ParseTree parsed-anychar-bar-49 ::' rest , 2)
...
len-dec-rewrite {- P160-} ((Id "P160") :: _::_(InputChar '1') rest) = just (ParseTree parsed-anychar-bar-50 ::' rest , 2)
len-dec-rewrite {- P161-} ((Id "P161") :: _::_(ParseTree parsed-anychar-bar-49) rest) = just (ParseTree parsed-anychar-bar-50 ::' rest , 2)
len-dec-rewrite {- P162-} ((Id "P162") :: _::_(InputChar '%') rest) = just (ParseTree parsed-anychar-bar-51 ::' rest , 2)
len-dec-rewrite {- P163-} ((Id "P163") :: _::_(ParseTree parsed-anychar-bar-50) rest) = just (ParseTree parsed-anychar-bar-51 ::' rest , 2)
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-52 ::' rest , 2)
len-dec-rewrite {- P165-} ((Id "P165") :: _::_(ParseTree parsed-anychar-bar-51) rest) = just (ParseTree parsed-anychar-bar-52 ::' rest , 2)
len-dec-rewrite {- P166-} ((Id "P166") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(ParseTree parsed-anychar-bar-52) rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
len-dec-rewrite {- P169-} ((Id "P169") :: _::_(ParseTree parsed-anychar-bar-53) rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(ParseTree (parsed-varone x0)) rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(ParseTree parsed-anychar-bar-54) rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree parsed-anychar-bar-55) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-56) rest) = just (ParseTree parsed-comment-star-56 ::' rest , 3)
len-dec-rewrite {- P175-} ((Id "P175") :: (InputChar '%') :: (ParseTree parsed-comment-star-56) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-57 ::' rest , 2)
len-dec-rewrite {- P177-} ((Id "P177") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-57 ::' rest , 2)
len-dec-rewrite {- P178-} ((Id "P178") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-58 ::' rest , 2)
len-dec-rewrite {- P179-} ((Id "P179") :: _::_(ParseTree parsed-aws-bar-57) rest) = just (ParseTree parsed-aws-bar-58 ::' rest , 2)
...
len-dec-rewrite {- P180-} ((Id "P180") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-59 ::' rest , 2)
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(ParseTree parsed-aws-bar-58) rest) = just (ParseTree parsed-aws-bar-59 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(ParseTree parsed-aws-bar-59) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-60 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-60) rest) = just (ParseTree parsed-ws-plus-60 ::' rest , 3)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree parsed-ws-plus-60) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-61) rest) = just (ParseTree parsed-ows-star-61 ::' rest , 3)
len-dec-rewrite {- P188-} ((Id "P188") :: _::_(ParseTree parsed-ows-star-61) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P68-} ((Id "P68") :: _::_(InputChar '0') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '0'))) ::' rest , 2)
len-dec-rewrite {- P69-} ((Id "P69") :: _::_(InputChar '1') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '1'))) ::' rest , 2)
...
len-dec-rewrite {- P70-} ((Id "P70") :: _::_(InputChar '2') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '2'))) ::' rest , 2)
len-dec-rewrite {- P71-} ((Id "P71") :: _::_(InputChar '3') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '3'))) ::' rest , 2)
len-dec-rewrite {- P72-} ((Id "P72") :: _::_(InputChar '4') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '4'))) ::' rest , 2)
len-dec-rewrite {- P73-} ((Id "P73") :: _::_(InputChar '5') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '5'))) ::' rest , 2)
len-dec-rewrite {- P74-} ((Id "P74") :: _::_(InputChar '6') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '6'))) ::' rest , 2)
len-dec-rewrite {- P75-} ((Id "P75") :: _::_(InputChar '7') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '7'))) ::' rest , 2)
len-dec-rewrite {- P76-} ((Id "P76") :: _::_(InputChar '8') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '8'))) ::' rest , 2)
len-dec-rewrite {- P77-} ((Id "P77") :: _::_(InputChar '9') rest) = just (ParseTree (parsed-numone-range-9 (string-append 0 (char-to-string '9'))) ::' rest , 2)
len-dec-rewrite {- P78-} ((Id "P78") :: _::_(ParseTree (parsed-numone-range-9 x0)) rest) = just (ParseTree (parsed-numone (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P79-} ((Id "P79") :: _::_(ParseTree (parsed-numone x0)) rest) = just (ParseTree (parsed-num-plus-10 (string-append 0 x0)) ::' rest , 2)
...
len-dec-rewrite {- P80-} ((Id "P80") :: (ParseTree (parsed-numone x0)) :: _::_(ParseTree (parsed-num-plus-10 x1)) rest) = just (ParseTree (parsed-num-plus-10 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P81-} ((Id "P81") :: _::_(ParseTree (parsed-num-plus-10 x0)) rest) = just (ParseTree (parsed-num (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P82-} ((Id "P82") :: _::_(ParseTree (parsed-numone x0)) rest) = just (ParseTree parsed-anychar-bar-11 ::' rest , 2)
len-dec-rewrite {- P83-} ((Id "P83") :: _::_(InputChar '*') rest) = just (ParseTree parsed-anychar-bar-11 ::' rest , 2)
len-dec-rewrite {- P84-} ((Id "P84") :: _::_(InputChar 'η') rest) = just (ParseTree parsed-anychar-bar-12 ::' rest , 2)
len-dec-rewrite {- P85-} ((Id "P85") :: _::_(ParseTree parsed-anychar-bar-11) rest) = just (ParseTree parsed-anychar-bar-12 ::' rest , 2)
len-dec-rewrite {- P86-} ((Id "P86") :: _::_(InputChar '~') rest) = just (ParseTree parsed-anychar-bar-13 ::' rest , 2)
len-dec-rewrite {- P87-} ((Id "P87") :: _::_(ParseTree parsed-anychar-bar-12) rest) = just (ParseTree parsed-anychar-bar-13 ::' rest , 2)
...
len-dec-rewrite {- P90-} ((Id "P90") :: _::_(InputChar '⇒') rest) = just (ParseTree parsed-anychar-bar-15 ::' rest , 2)
len-dec-rewrite {- P91-} ((Id "P91") :: _::_(ParseTree parsed-anychar-bar-14) rest) = just (ParseTree parsed-anychar-bar-15 ::' rest , 2)
len-dec-rewrite {- P92-} ((Id "P92") :: _::_(InputChar '}') rest) = just (ParseTree parsed-anychar-bar-16 ::' rest , 2)
...
len-dec-rewrite {- P96-} ((Id "P96") :: _::_(InputChar '!') rest) = just (ParseTree parsed-anychar-bar-18 ::' rest , 2)
...
len-dec-rewrite {- Rbeta-} ((Id "Rbeta") :: (InputChar 'r') :: (InputChar 'β') :: (ParseTree parsed-ws) :: (ParseTree (parsed-evidence x0)) :: (ParseTree parsed-ws) :: (ParseTree (parsed-term x1)) :: (ParseTree parsed-ows) :: (InputChar '⇒') :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-evidence x2)) rest) = just (ParseTree (parsed-evidence (norm-evidence (Rbeta x0 x1 x2))) ::' rest , 11)
len-dec-rewrite {- RbetaLift-} ((Id "RbetaLift") :: (InputChar 'r') :: (InputChar 'β') :: (InputChar '↑') :: (ParseTree parsed-ws) :: _::_(ParseTree (parsed-num x0)) rest) = just (ParseTree (parsed-levidence (norm-evidence (RbetaLift x0))) ::' rest , 6)
...
len-dec-rewrite {- TpEq-} ((Id "TpEq") :: (ParseTree (parsed-term x0)) :: (ParseTree parsed-ows) :: (InputChar '≃') :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-term x1)) rest) = just (ParseTree (parsed-ltype (norm-type (TpEq x0 x1))) ::' rest , 6)
...
len-dec-rewrite {- P173-} (_::_(Id "P173") rest) = just (ParseTree parsed-comment-star-56 ::' rest , 1)
len-dec-rewrite {- P186-} (_::_(Id "P186") rest) = just (ParseTree parsed-ows-star-61 ::' rest , 1)
