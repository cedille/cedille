...
cedille-start _ws-plus-58 = (just "P220" , nothing , just _ws-plus-58 , inj₁ _aws :: inj₁ _ws-plus-58 :: []) :: (just "P219" , nothing , just _ws-plus-58 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P221" , nothing , just _ws , inj₁ _ws-plus-58 :: []) :: []
...
cedille-start _term = (just "Var" , nothing , just _term , inj₁ _var :: []) :: (just "Parens" , nothing , just _term , inj₂ '(' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ')' :: []) :: (just "Lam" , nothing , just _term , inj₂ 'λ' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _term :: []) :: []
...
cedille-start _ows-star-59 = (just "P223" , nothing , just _ows-star-59 , inj₁ _aws :: inj₁ _ows-star-59 :: []) :: (just "P222" , nothing , just _ows-star-59 , []) :: []
cedille-start _ows = (just "P224" , nothing , just _ows , inj₁ _ows-star-59 :: []) :: []
...
cedille-start _ltype = (just "U" , nothing , just _ltype , inj₂ '𝓤' :: []) :: (just "TpVar" , nothing , just _ltype , inj₁ _var :: []) :: (just "TpParens" , nothing , just _ltype , inj₂ '(' :: inj₁ _ows :: inj₁ _type :: inj₁ _ows :: inj₂ ')' :: []) :: (just "Lft" , nothing , just _ltype , inj₂ '↑' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _term :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _lliftingType :: []) :: []
cedille-start _lliftingType = (just "LiftParens" , nothing , just _lliftingType , inj₂ '(' :: inj₁ _ows :: inj₁ _liftingType :: inj₁ _ows :: inj₂ ')' :: []) :: []
cedille-start _liftingType = (just "embed" , nothing , just _liftingType , inj₁ _lliftingType :: []) :: (just "LiftVar" , nothing , just _liftingType , inj₁ _var :: []) :: (just "LiftPi" , nothing , just _liftingType , inj₂ 'Π' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _type :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _liftingType :: []) :: []
...
cedille-start _evidence = (just "embed" , just "embed_end" , just _evidence , inj₁ _levidence :: []) :: (just "Xi" , nothing , just _evidence , inj₂ 'ξ' :: inj₁ _ows :: inj₁ _var :: inj₁ _opt_eclass :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Pair" , nothing , just _evidence , inj₂ '[' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ']' :: []) :: (just "Eprint" , nothing , just _evidence , inj₂ '?' :: inj₁ _showCtxt :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Enu" , nothing , just _evidence , inj₂ 'ν' :: inj₁ _ws :: inj₁ _var :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₂ '[' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ',' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ']' :: []) :: (just "Elift" , nothing , just _evidence , inj₂ '↑' :: inj₁ _ows :: inj₁ _var :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Elet" , nothing , just _evidence , inj₂ 'δ' :: inj₁ _ws :: inj₁ _def :: inj₁ _ws :: inj₂ '-' :: inj₁ _ws :: inj₁ _evidence :: []) :: (just "Ctora" , nothing , just _evidence , inj₂ 'ζ' :: inj₁ _ws :: inj₁ _var :: []) :: (just "Ctor" , nothing , just _evidence , inj₂ 'ζ' :: inj₁ _ws :: inj₁ _evidence :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _type :: []) :: (just "Cast" , nothing , just _evidence , inj₂ 'χ' :: inj₁ _ws :: inj₁ _evidence :: inj₁ _ows :: inj₁ _castDir :: inj₁ _ows :: inj₁ _evidence :: []) :: []
...
cedille-start _def = (just "Tdefine" , just "Tdefine_end" , just _def , inj₁ _var :: inj₁ _ows :: inj₂ '=' :: inj₁ _ows :: inj₁ _term :: []) :: (just "Kdefine" , nothing , just _def , inj₁ _kvar :: inj₁ _ows :: inj₂ '∷' :: inj₁ _ows :: inj₁ _kind :: inj₁ _ows :: inj₂ '⇐' :: inj₁ _ows :: inj₂ '□' :: inj₁ _ows :: inj₂ '=' :: inj₁ _ows :: inj₁ _evidence :: []) :: (just "Edefine" , nothing , just _def , inj₁ _var :: inj₁ _ows :: inj₂ '∷' :: inj₁ _ows :: inj₁ _class :: inj₁ _ows :: inj₂ '=' :: inj₁ _ows :: inj₁ _evidence :: inj₁ _ows :: inj₂ '⇐' :: inj₁ _ows :: inj₁ _evidence :: []) :: []
...
cedille-start _comment-star-54 = (just "P210" , nothing , just _comment-star-54 , inj₁ _anychar :: inj₁ _comment-star-54 :: []) :: (just "P209" , nothing , just _comment-star-54 , []) :: []
cedille-start _comment = (just "P211" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-54 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-56 = (just "P215" , nothing , just _aws-bar-56 , inj₁ _aws-bar-55 :: []) :: (just "P214" , nothing , just _aws-bar-56 , inj₂ '\t' :: []) :: []
cedille-start _aws-bar-55 = (just "P213" , nothing , just _aws-bar-55 , inj₁ _comment :: []) :: (just "P212" , nothing , just _aws-bar-55 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P218" , nothing , just _aws , inj₁ _aws-bar-57 :: []) :: []
...
cedille-start _anychar-bar-53 = (just "P207" , nothing , just _anychar-bar-53 , inj₁ _anychar-bar-52 :: []) :: (just "P206" , nothing , just _anychar-bar-53 , inj₁ _anychar-range-9 :: []) :: []
...
cedille-start _anychar-bar-51 = (just "P203" , nothing , just _anychar-bar-51 , inj₁ _anychar-bar-50 :: []) :: (just "P202" , nothing , just _anychar-bar-51 , inj₂ ' ' :: []) :: []
cedille-start _anychar-bar-50 = (just "P201" , nothing , just _anychar-bar-50 , inj₁ _anychar-bar-49 :: []) :: (just "P200" , nothing , just _anychar-bar-50 , inj₂ '𝒌' :: []) :: []
cedille-start _anychar-bar-49 = (just "P199" , nothing , just _anychar-bar-49 , inj₁ _anychar-bar-48 :: []) :: (just "P198" , nothing , just _anychar-bar-49 , inj₂ '%' :: []) :: []
cedille-start _anychar-bar-48 = (just "P197" , nothing , just _anychar-bar-48 , inj₁ _anychar-bar-47 :: []) :: (just "P196" , nothing , just _anychar-bar-48 , inj₂ '1' :: []) :: []
cedille-start _anychar-bar-47 = (just "P195" , nothing , just _anychar-bar-47 , inj₁ _anychar-bar-46 :: []) :: (just "P194" , nothing , just _anychar-bar-47 , inj₂ '2' :: []) :: []
...
cedille-start _anychar-bar-43 = (just "P187" , nothing , just _anychar-bar-43 , inj₁ _anychar-bar-42 :: []) :: (just "P186" , nothing , just _anychar-bar-43 , inj₂ '□' :: []) :: []
cedille-start _anychar-bar-42 = (just "P185" , nothing , just _anychar-bar-42 , inj₁ _anychar-bar-41 :: []) :: (just "P184" , nothing , just _anychar-bar-42 , inj₂ 'Π' :: []) :: []
cedille-start _anychar-bar-41 = (just "P183" , nothing , just _anychar-bar-41 , inj₁ _anychar-bar-40 :: []) :: (just "P182" , nothing , just _anychar-bar-41 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-40 = (just "P181" , nothing , just _anychar-bar-40 , inj₁ _anychar-bar-39 :: []) :: (just "P180" , nothing , just _anychar-bar-40 , inj₂ 'λ' :: []) :: []
cedille-start _anychar-bar-39 = (just "P179" , nothing , just _anychar-bar-39 , inj₁ _anychar-bar-38 :: []) :: (just "P178" , nothing , just _anychar-bar-39 , inj₂ '∀' :: []) :: []
cedille-start _anychar-bar-38 = (just "P177" , nothing , just _anychar-bar-38 , inj₁ _anychar-bar-37 :: []) :: (just "P176" , nothing , just _anychar-bar-38 , inj₂ 'π' :: []) :: []
...
cedille-start _anychar-bar-35 = (just "P171" , nothing , just _anychar-bar-35 , inj₁ _anychar-bar-34 :: []) :: (just "P170" , nothing , just _anychar-bar-35 , inj₂ '·' :: []) :: []
cedille-start _anychar-bar-34 = (just "P169" , nothing , just _anychar-bar-34 , inj₁ _anychar-bar-33 :: []) :: (just "P168" , nothing , just _anychar-bar-34 , inj₂ 'ξ' :: []) :: []
...
cedille-start _anychar-bar-32 = (just "P165" , nothing , just _anychar-bar-32 , inj₁ _anychar-bar-31 :: []) :: (just "P164" , nothing , just _anychar-bar-32 , inj₂ '∈' :: []) :: []
cedille-start _anychar-bar-31 = (just "P163" , nothing , just _anychar-bar-31 , inj₁ _anychar-bar-30 :: []) :: (just "P162" , nothing , just _anychar-bar-31 , inj₂ 'ν' :: []) :: []
...
cedille-start _anychar-bar-29 = (just "P159" , nothing , just _anychar-bar-29 , inj₁ _anychar-bar-28 :: []) :: (just "P158" , nothing , just _anychar-bar-29 , inj₂ '↑' :: []) :: []
cedille-start _anychar-bar-28 = (just "P157" , nothing , just _anychar-bar-28 , inj₁ _anychar-bar-27 :: []) :: (just "P156" , nothing , just _anychar-bar-28 , inj₂ '𝓤' :: []) :: []
...
cedille-start _anychar-bar-23 = (just "P147" , nothing , just _anychar-bar-23 , inj₁ _anychar-bar-22 :: []) :: (just "P146" , nothing , just _anychar-bar-23 , inj₂ '.' :: []) :: []
cedille-start _anychar-bar-22 = (just "P145" , nothing , just _anychar-bar-22 , inj₁ _anychar-bar-21 :: []) :: (just "P144" , nothing , just _anychar-bar-22 , inj₂ 'χ' :: []) :: []
cedille-start _anychar-bar-21 = (just "P143" , nothing , just _anychar-bar-21 , inj₁ _anychar-bar-20 :: []) :: (just "P142" , nothing , just _anychar-bar-21 , inj₂ 'β' :: []) :: []
cedille-start _anychar-bar-20 = (just "P141" , nothing , just _anychar-bar-20 , inj₁ _anychar-bar-19 :: []) :: (just "P140" , nothing , just _anychar-bar-20 , inj₂ 'δ' :: []) :: []
cedille-start _anychar-bar-19 = (just "P139" , nothing , just _anychar-bar-19 , inj₁ _anychar-bar-18 :: []) :: (just "P138" , nothing , just _anychar-bar-19 , inj₂ 'ζ' :: []) :: []
...
cedille-start _anychar-bar-10 = (just "P121" , nothing , just _anychar-bar-10 , inj₂ '~' :: []) :: (just "P120" , nothing , just _anychar-bar-10 , inj₂ '?' :: []) :: []
cedille-start _anychar = (just "P208" , nothing , just _anychar , inj₁ _anychar-bar-53 :: []) :: []
...
cedille-return (just _term) = (nothing , nothing , just _term , inj₁ _ws :: inj₁ _term :: []) :: []
cedille-return (just _ltype) = (nothing , just "TpAppt_end" , just _ltype , inj₁ _ws :: inj₁ _term :: []) :: (nothing , nothing , just _ltype , inj₁ _ws :: inj₂ '·' :: inj₁ _ws :: inj₁ _ltype :: []) :: []
...
len-dec-rewrite {- Lft-} ((Id "Lft") :: (InputChar '↑') :: (ParseTree parsed-ows) :: (ParseTree (parsed-var x0)) :: (ParseTree parsed-ows) :: (InputChar '.') :: (ParseTree parsed-ows) :: (ParseTree (parsed-term x1)) :: (ParseTree parsed-ows) :: (InputChar ':') :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-lliftingType x2)) rest) = just (ParseTree (parsed-ltype (norm-type (Lft x0 x1 x2))) ::' rest , 12)
...
len-dec-rewrite {- LiftVar-} ((Id "LiftVar") :: _::_(ParseTree (parsed-var x0)) rest) = just (ParseTree (parsed-liftingType (norm-liftingType (LiftVar x0))) ::' rest , 2)
...
len-dec-rewrite {- P121-} ((Id "P121") :: _::_(InputChar '~') rest) = just (ParseTree parsed-anychar-bar-10 ::' rest , 2)
...
len-dec-rewrite {- P138-} ((Id "P138") :: _::_(InputChar 'ζ') rest) = just (ParseTree parsed-anychar-bar-19 ::' rest , 2)
...
len-dec-rewrite {- P140-} ((Id "P140") :: _::_(InputChar 'δ') rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P141-} ((Id "P141") :: _::_(ParseTree parsed-anychar-bar-19) rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P142-} ((Id "P142") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P143-} ((Id "P143") :: _::_(ParseTree parsed-anychar-bar-20) rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P144-} ((Id "P144") :: _::_(InputChar 'χ') rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P145-} ((Id "P145") :: _::_(ParseTree parsed-anychar-bar-21) rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P146-} ((Id "P146") :: _::_(InputChar '.') rest) = just (ParseTree parsed-anychar-bar-23 ::' rest , 2)
...
len-dec-rewrite {- P156-} ((Id "P156") :: _::_(InputChar '𝓤') rest) = just (ParseTree parsed-anychar-bar-28 ::' rest , 2)
len-dec-rewrite {- P157-} ((Id "P157") :: _::_(ParseTree parsed-anychar-bar-27) rest) = just (ParseTree parsed-anychar-bar-28 ::' rest , 2)
len-dec-rewrite {- P158-} ((Id "P158") :: _::_(InputChar '↑') rest) = just (ParseTree parsed-anychar-bar-29 ::' rest , 2)
...
len-dec-rewrite {- P162-} ((Id "P162") :: _::_(InputChar 'ν') rest) = just (ParseTree parsed-anychar-bar-31 ::' rest , 2)
len-dec-rewrite {- P163-} ((Id "P163") :: _::_(ParseTree parsed-anychar-bar-30) rest) = just (ParseTree parsed-anychar-bar-31 ::' rest , 2)
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(InputChar '∈') rest) = just (ParseTree parsed-anychar-bar-32 ::' rest , 2)
...
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(InputChar 'ξ') rest) = just (ParseTree parsed-anychar-bar-34 ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(InputChar '·') rest) = just (ParseTree parsed-anychar-bar-35 ::' rest , 2)
...
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-anychar-bar-38 ::' rest , 2)
len-dec-rewrite {- P177-} ((Id "P177") :: _::_(ParseTree parsed-anychar-bar-37) rest) = just (ParseTree parsed-anychar-bar-38 ::' rest , 2)
len-dec-rewrite {- P178-} ((Id "P178") :: _::_(InputChar '∀') rest) = just (ParseTree parsed-anychar-bar-39 ::' rest , 2)
...
len-dec-rewrite {- P180-} ((Id "P180") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-40 ::' rest , 2)
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(ParseTree parsed-anychar-bar-39) rest) = just (ParseTree parsed-anychar-bar-40 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-41 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree parsed-anychar-bar-40) rest) = just (ParseTree parsed-anychar-bar-41 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-anychar-bar-42 ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree parsed-anychar-bar-41) rest) = just (ParseTree parsed-anychar-bar-42 ::' rest , 2)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(InputChar '□') rest) = just (ParseTree parsed-anychar-bar-43 ::' rest , 2)
...
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(InputChar '2') rest) = just (ParseTree parsed-anychar-bar-47 ::' rest , 2)
len-dec-rewrite {- P195-} ((Id "P195") :: _::_(ParseTree parsed-anychar-bar-46) rest) = just (ParseTree parsed-anychar-bar-47 ::' rest , 2)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(InputChar '1') rest) = just (ParseTree parsed-anychar-bar-48 ::' rest , 2)
len-dec-rewrite {- P197-} ((Id "P197") :: _::_(ParseTree parsed-anychar-bar-47) rest) = just (ParseTree parsed-anychar-bar-48 ::' rest , 2)
len-dec-rewrite {- P198-} ((Id "P198") :: _::_(InputChar '%') rest) = just (ParseTree parsed-anychar-bar-49 ::' rest , 2)
...
len-dec-rewrite {- P200-} ((Id "P200") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-50 ::' rest , 2)
len-dec-rewrite {- P201-} ((Id "P201") :: _::_(ParseTree parsed-anychar-bar-49) rest) = just (ParseTree parsed-anychar-bar-50 ::' rest , 2)
len-dec-rewrite {- P202-} ((Id "P202") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-anychar-bar-51 ::' rest , 2)
...
len-dec-rewrite {- P206-} ((Id "P206") :: _::_(ParseTree parsed-anychar-range-9) rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P207-} ((Id "P207") :: _::_(ParseTree parsed-anychar-bar-52) rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P208-} ((Id "P208") :: _::_(ParseTree parsed-anychar-bar-53) rest) = just (ParseTree parsed-anychar ::' rest , 2)
...
len-dec-rewrite {- P210-} ((Id "P210") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-54) rest) = just (ParseTree parsed-comment-star-54 ::' rest , 3)
len-dec-rewrite {- P211-} ((Id "P211") :: (InputChar '%') :: (ParseTree parsed-comment-star-54) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P212-} ((Id "P212") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-55 ::' rest , 2)
len-dec-rewrite {- P213-} ((Id "P213") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-55 ::' rest , 2)
len-dec-rewrite {- P214-} ((Id "P214") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-56 ::' rest , 2)
len-dec-rewrite {- P215-} ((Id "P215") :: _::_(ParseTree parsed-aws-bar-55) rest) = just (ParseTree parsed-aws-bar-56 ::' rest , 2)
...
len-dec-rewrite {- P218-} ((Id "P218") :: _::_(ParseTree parsed-aws-bar-57) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P219-} ((Id "P219") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-58 ::' rest , 2)
...
len-dec-rewrite {- P220-} ((Id "P220") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-58) rest) = just (ParseTree parsed-ws-plus-58 ::' rest , 3)
len-dec-rewrite {- P221-} ((Id "P221") :: _::_(ParseTree parsed-ws-plus-58) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P223-} ((Id "P223") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-59) rest) = just (ParseTree parsed-ows-star-59 ::' rest , 3)
len-dec-rewrite {- P224-} ((Id "P224") :: _::_(ParseTree parsed-ows-star-59) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- Parens-} ((Id "Parens") :: (InputChar '(') :: (ParseTree parsed-ows) :: (ParseTree (parsed-term x0)) :: (ParseTree parsed-ows) :: _::_(InputChar ')') rest) = just (ParseTree (parsed-term (norm-term (Parens x0))) ::' rest , 6)
...
len-dec-rewrite {- Tdefine-} ((Id "Tdefine") :: (ParseTree (parsed-var x0)) :: (ParseTree parsed-ows) :: (InputChar '=') :: (ParseTree parsed-ows) :: (ParseTree (parsed-term x1)) :: _::_(Id "Tdefine_end") rest) = just (ParseTree (parsed-def (norm-def (Tdefine x0 x1))) ::' rest , 7)
...
len-dec-rewrite {- TpAppt-} ((ParseTree (parsed-ltype x0)) :: (ParseTree parsed-ws) :: (ParseTree (parsed-term x1)) :: _::_(Id "TpAppt_end") rest) = just (ParseTree (parsed-ltype (norm-type (TpAppt x0 x1))) ::' rest , 4)
...
len-dec-rewrite {- P209-} (_::_(Id "P209") rest) = just (ParseTree parsed-comment-star-54 ::' rest , 1)
len-dec-rewrite {- P222-} (_::_(Id "P222") rest) = just (ParseTree parsed-ows-star-59 ::' rest , 1)
