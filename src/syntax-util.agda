...
term-start-pos (OpenType pi _ _) = pi
term-start-pos (OpenTerm pi _) = pi
...
term-end-pos (OpenType pi _ t) = term-end-pos t
term-end-pos (OpenTerm pi x) = posinfo-plus (posinfo-plus-str pi x) 5 
...
erase-term (OpenType _ _ t) = erase-term t
erase-term (OpenTerm _ _) = id-term
