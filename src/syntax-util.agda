...
term-start-pos (Fold pi _ _ _) = pi
term-start-pos (Unfold pi _ _ _) = pi
...
term-end-pos (Fold _ _ _ t) = term-end-pos t
term-end-pos (Unfold _ _ _ t) = term-end-pos t
...
erase-term (Fold _ _ _ t) = erase-term t
erase-term (Unfold _ _ _ t) = erase-term t
