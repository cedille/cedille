...
data gratr2-nt : Set where
  ...
  _anynonwschar-bar-62 : gratr2-nt
...
gratr2-nt-eq  _nonws-plus-64 _nonws-plus-64 = tt
...
gratr2-nt-eq  _anynonwschar-bar-62 _anynonwschar-bar-62 = tt
...
cws-start _ws-plus-61 = (just "P185" , nothing , just _ws-plus-61 , inj₁ _aws :: inj₁ _ws-plus-61 :: []) :: (just "P184" , nothing , just _ws-plus-61 , inj₁ _aws :: []) :: []
cws-start _ws = (just "P186" , nothing , just _ws , inj₁ _ws-plus-61 :: []) :: []
...
cws-start _otherpunct-bar-50 = (just "P159" , nothing , just _otherpunct-bar-50 , inj₁ _otherpunct-bar-49 :: []) :: (just "P158" , nothing , just _otherpunct-bar-50 , inj₂ 'Π' :: []) :: []
cws-start _otherpunct-bar-49 = (just "P157" , nothing , just _otherpunct-bar-49 , inj₁ _otherpunct-bar-48 :: []) :: (just "P156" , nothing , just _otherpunct-bar-49 , inj₂ 'ι' :: []) :: []
cws-start _otherpunct-bar-48 = (just "P155" , nothing , just _otherpunct-bar-48 , inj₁ _otherpunct-bar-47 :: []) :: (just "P154" , nothing , just _otherpunct-bar-48 , inj₂ 'λ' :: []) :: []
...
cws-start _otherpunct-bar-46 = (just "P151" , nothing , just _otherpunct-bar-46 , inj₁ _otherpunct-bar-45 :: []) :: (just "P150" , nothing , just _otherpunct-bar-46 , inj₂ 'π' :: []) :: []
...
cws-start _otherpunct-bar-26 = (just "P111" , nothing , just _otherpunct-bar-26 , inj₁ _otherpunct-bar-25 :: []) :: (just "P110" , nothing , just _otherpunct-bar-26 , inj₂ 'Λ' :: []) :: []
cws-start _otherpunct-bar-25 = (just "P109" , nothing , just _otherpunct-bar-25 , inj₁ _otherpunct-bar-24 :: []) :: (just "P108" , nothing , just _otherpunct-bar-25 , inj₂ 'ρ' :: []) :: []
cws-start _otherpunct-bar-24 = (just "P107" , nothing , just _otherpunct-bar-24 , inj₁ _otherpunct-bar-23 :: []) :: (just "P106" , nothing , just _otherpunct-bar-24 , inj₂ 'ε' :: []) :: []
cws-start _otherpunct-bar-23 = (just "P105" , nothing , just _otherpunct-bar-23 , inj₁ _otherpunct-bar-22 :: []) :: (just "P104" , nothing , just _otherpunct-bar-23 , inj₂ 'β' :: []) :: []
...
cws-start _otherpunct-bar-21 = (just "P101" , nothing , just _otherpunct-bar-21 , inj₁ _otherpunct-bar-20 :: []) :: (just "P100" , nothing , just _otherpunct-bar-21 , inj₂ '𝒌' :: []) :: []
...
cws-start _otherpunct-bar-19 = (just "P97" , nothing , just _otherpunct-bar-19 , inj₁ _otherpunct-bar-18 :: []) :: (just "P96" , nothing , just _otherpunct-bar-19 , inj₂ 'ς' :: []) :: []
cws-start _otherpunct-bar-18 = (just "P95" , nothing , just _otherpunct-bar-18 , inj₁ _otherpunct-bar-17 :: []) :: (just "P94" , nothing , just _otherpunct-bar-18 , inj₂ 'θ' :: []) :: []
...
cws-start _otherpunct-bar-13 = (just "P85" , nothing , just _otherpunct-bar-13 , inj₁ _otherpunct-bar-12 :: []) :: (just "P84" , nothing , just _otherpunct-bar-13 , inj₂ '\"' :: []) :: []
cws-start _otherpunct-bar-12 = (just "P83" , nothing , just _otherpunct-bar-12 , inj₂ 'χ' :: []) :: (just "P82" , nothing , just _otherpunct-bar-12 , inj₂ 'δ' :: []) :: []
cws-start _otherpunct = (just "P164" , nothing , just _otherpunct , inj₁ _otherpunct-bar-52 :: []) :: []
...
cws-start _nonws-plus-64 = (just "P193" , nothing , just _nonws-plus-64 , inj₁ _anynonwschar :: inj₁ _nonws-plus-64 :: []) :: (just "P192" , nothing , just _nonws-plus-64 , inj₁ _anynonwschar :: []) :: []
cws-start _nonws = (just "P194" , nothing , just _nonws , inj₁ _nonws-plus-64 :: []) :: []
...
cws-start _comment-star-58 = (just "P177" , nothing , just _comment-star-58 , inj₁ _anychar :: inj₁ _comment-star-58 :: []) :: (just "P176" , nothing , just _comment-star-58 , []) :: []
cws-start _comment = (just "P178" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-58 :: inj₂ '\n' :: []) :: []
cws-start _aws-bar-60 = (just "P182" , nothing , just _aws-bar-60 , inj₁ _aws-bar-59 :: []) :: (just "P181" , nothing , just _aws-bar-60 , inj₂ '\n' :: []) :: []
cws-start _aws-bar-59 = (just "P180" , nothing , just _aws-bar-59 , inj₂ ' ' :: []) :: (just "P179" , nothing , just _aws-bar-59 , inj₂ '\t' :: []) :: []
cws-start _aws = (just "P183" , nothing , just _aws , inj₁ _aws-bar-60 :: []) :: []
cws-start _anynonwschar-bar-63 = (just "P190" , nothing , just _anynonwschar-bar-63 , inj₁ _anynonwschar-bar-62 :: []) :: (just "P189" , nothing , just _anynonwschar-bar-63 , inj₁ _alpha :: []) :: []
cws-start _anynonwschar-bar-62 = (just "P188" , nothing , just _anynonwschar-bar-62 , inj₁ _otherpunct :: []) :: (just "P187" , nothing , just _anynonwschar-bar-62 , inj₁ _numpunct :: []) :: []
cws-start _anynonwschar = (just "P191" , nothing , just _anynonwschar , inj₁ _anynonwschar-bar-63 :: []) :: []
cws-start _anychar-bar-57 = (just "P174" , nothing , just _anychar-bar-57 , inj₁ _anychar-bar-56 :: []) :: (just "P173" , nothing , just _anychar-bar-57 , inj₁ _alpha :: []) :: []
cws-start _anychar-bar-56 = (just "P172" , nothing , just _anychar-bar-56 , inj₁ _anychar-bar-55 :: []) :: (just "P171" , nothing , just _anychar-bar-56 , inj₁ _numpunct :: []) :: []
...
cws-start _anychar-bar-54 = (just "P168" , nothing , just _anychar-bar-54 , inj₁ _anychar-bar-53 :: []) :: (just "P167" , nothing , just _anychar-bar-54 , inj₂ ' ' :: []) :: []
cws-start _anychar-bar-53 = (just "P166" , nothing , just _anychar-bar-53 , inj₁ _otherpunct :: []) :: (just "P165" , nothing , just _anychar-bar-53 , inj₂ '%' :: []) :: []
cws-start _anychar = (just "P175" , nothing , just _anychar , inj₁ _anychar-bar-57 :: []) :: []
...
len-dec-rewrite {- P100-} ((Id "P100") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-otherpunct-bar-21 ::' rest , 2)
...
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-otherpunct-bar-23 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(ParseTree parsed-otherpunct-bar-22) rest) = just (ParseTree parsed-otherpunct-bar-23 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
len-dec-rewrite {- P107-} ((Id "P107") :: _::_(ParseTree parsed-otherpunct-bar-23) rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
len-dec-rewrite {- P108-} ((Id "P108") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-otherpunct-bar-25 ::' rest , 2)
...
len-dec-rewrite {- P110-} ((Id "P110") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-otherpunct-bar-26 ::' rest , 2)
...
len-dec-rewrite {- P150-} ((Id "P150") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-otherpunct-bar-46 ::' rest , 2)
...
len-dec-rewrite {- P154-} ((Id "P154") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-otherpunct-bar-48 ::' rest , 2)
len-dec-rewrite {- P155-} ((Id "P155") :: _::_(ParseTree parsed-otherpunct-bar-47) rest) = just (ParseTree parsed-otherpunct-bar-48 ::' rest , 2)
len-dec-rewrite {- P156-} ((Id "P156") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-otherpunct-bar-49 ::' rest , 2)
len-dec-rewrite {- P157-} ((Id "P157") :: _::_(ParseTree parsed-otherpunct-bar-48) rest) = just (ParseTree parsed-otherpunct-bar-49 ::' rest , 2)
len-dec-rewrite {- P158-} ((Id "P158") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-otherpunct-bar-50 ::' rest , 2)
...
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(ParseTree parsed-otherpunct-bar-52) rest) = just (ParseTree parsed-otherpunct ::' rest , 2)
len-dec-rewrite {- P165-} ((Id "P165") :: _::_(InputChar '%') rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P166-} ((Id "P166") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(ParseTree parsed-anychar-bar-53) rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
...
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree parsed-anychar-bar-55) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree parsed-anychar-bar-56) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(ParseTree parsed-anychar-bar-57) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P177-} ((Id "P177") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-58) rest) = just (ParseTree parsed-comment-star-58 ::' rest , 3)
len-dec-rewrite {- P178-} ((Id "P178") :: (InputChar '%') :: (ParseTree parsed-comment-star-58) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P179-} ((Id "P179") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-59 ::' rest , 2)
...
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-60 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(ParseTree parsed-aws-bar-59) rest) = just (ParseTree parsed-aws-bar-60 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree parsed-aws-bar-60) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-61 ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-61) rest) = just (ParseTree parsed-ws-plus-61 ::' rest , 3)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(ParseTree parsed-ws-plus-61) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anynonwschar-bar-62 ::' rest , 2)
len-dec-rewrite {- P188-} ((Id "P188") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anynonwschar-bar-62 ::' rest , 2)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anynonwschar-bar-63 ::' rest , 2)
len-dec-rewrite {- P19-} ((Id "P19") :: _::_(InputChar 't') rest) = just (ParseTree parsed-alpha-range-1 ::' rest , 2)
len-dec-rewrite {- P190-} ((Id "P190") :: _::_(ParseTree parsed-anynonwschar-bar-62) rest) = just (ParseTree parsed-anynonwschar-bar-63 ::' rest , 2)
len-dec-rewrite {- P191-} ((Id "P191") :: _::_(ParseTree parsed-anynonwschar-bar-63) rest) = just (ParseTree parsed-anynonwschar ::' rest , 2)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-anynonwschar) rest) = just (ParseTree parsed-nonws-plus-64 ::' rest , 2)
len-dec-rewrite {- P193-} ((Id "P193") :: (ParseTree parsed-anynonwschar) :: _::_(ParseTree parsed-nonws-plus-64) rest) = just (ParseTree parsed-nonws-plus-64 ::' rest , 3)
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(ParseTree parsed-nonws-plus-64) rest) = just (ParseTree parsed-nonws ::' rest , 2)
...
len-dec-rewrite {- P82-} ((Id "P82") :: _::_(InputChar 'δ') rest) = just (ParseTree parsed-otherpunct-bar-12 ::' rest , 2)
len-dec-rewrite {- P83-} ((Id "P83") :: _::_(InputChar 'χ') rest) = just (ParseTree parsed-otherpunct-bar-12 ::' rest , 2)
len-dec-rewrite {- P84-} ((Id "P84") :: _::_(InputChar '\"') rest) = just (ParseTree parsed-otherpunct-bar-13 ::' rest , 2)
...
len-dec-rewrite {- P94-} ((Id "P94") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-otherpunct-bar-18 ::' rest , 2)
len-dec-rewrite {- P95-} ((Id "P95") :: _::_(ParseTree parsed-otherpunct-bar-17) rest) = just (ParseTree parsed-otherpunct-bar-18 ::' rest , 2)
len-dec-rewrite {- P96-} ((Id "P96") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-otherpunct-bar-19 ::' rest , 2)
...
len-dec-rewrite {- P176-} (_::_(Id "P176") rest) = just (ParseTree parsed-comment-star-58 ::' rest , 1)
