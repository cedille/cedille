...
data gratr2-nt : Set where
  ...
  _num : gratr2-nt
  _nonws-plus-65 : gratr2-nt
  _nonws : gratr2-nt
  _entity : gratr2-nt
  _entities : gratr2-nt
  _comment-star-59 : gratr2-nt
  _comment : gratr2-nt
  _aws-bar-61 : gratr2-nt
  _aws-bar-60 : gratr2-nt
  _aws : gratr2-nt
  _anynonwschar-bar-64 : gratr2-nt
  _anynonwschar-bar-63 : gratr2-nt
...
gratr2-nt-eq  _anynonwschar-bar-64 _anynonwschar-bar-64 = tt
gratr2-nt-eq  _anynonwschar-bar-63 _anynonwschar-bar-63 = tt
...
cws-start _ws-plus-62 = (just "P187" , nothing , just _ws-plus-62 , inj₁ _aws :: inj₁ _ws-plus-62 :: []) :: (just "P186" , nothing , just _ws-plus-62 , inj₁ _aws :: []) :: []
cws-start _ws = (just "P188" , nothing , just _ws , inj₁ _ws-plus-62 :: []) :: []
...
cws-start _otherpunct-bar-52 = (just "P163" , nothing , just _otherpunct-bar-52 , inj₁ _otherpunct-bar-51 :: []) :: (just "P162" , nothing , just _otherpunct-bar-52 , inj₂ '□' :: []) :: []
cws-start _otherpunct-bar-51 = (just "P161" , nothing , just _otherpunct-bar-51 , inj₁ _otherpunct-bar-50 :: []) :: (just "P160" , nothing , just _otherpunct-bar-51 , inj₂ 'Π' :: []) :: []
cws-start _otherpunct-bar-50 = (just "P159" , nothing , just _otherpunct-bar-50 , inj₁ _otherpunct-bar-49 :: []) :: (just "P158" , nothing , just _otherpunct-bar-50 , inj₂ 'ι' :: []) :: []
cws-start _otherpunct-bar-49 = (just "P157" , nothing , just _otherpunct-bar-49 , inj₁ _otherpunct-bar-48 :: []) :: (just "P156" , nothing , just _otherpunct-bar-49 , inj₂ 'λ' :: []) :: []
...
cws-start _otherpunct-bar-47 = (just "P153" , nothing , just _otherpunct-bar-47 , inj₁ _otherpunct-bar-46 :: []) :: (just "P152" , nothing , just _otherpunct-bar-47 , inj₂ 'π' :: []) :: []
...
cws-start _otherpunct-bar-31 = (just "P121" , nothing , just _otherpunct-bar-31 , inj₁ _otherpunct-bar-30 :: []) :: (just "P120" , nothing , just _otherpunct-bar-31 , inj₂ '{' :: []) :: []
cws-start _otherpunct-bar-30 = (just "P119" , nothing , just _otherpunct-bar-30 , inj₁ _otherpunct-bar-29 :: []) :: (just "P118" , nothing , just _otherpunct-bar-30 , inj₂ '}' :: []) :: []
cws-start _otherpunct-bar-29 = (just "P117" , nothing , just _otherpunct-bar-29 , inj₁ _otherpunct-bar-28 :: []) :: (just "P116" , nothing , just _otherpunct-bar-29 , inj₂ '⇒' :: []) :: []
cws-start _otherpunct-bar-28 = (just "P115" , nothing , just _otherpunct-bar-28 , inj₁ _otherpunct-bar-27 :: []) :: (just "P114" , nothing , just _otherpunct-bar-28 , inj₂ '?' :: []) :: []
cws-start _otherpunct-bar-27 = (just "P113" , nothing , just _otherpunct-bar-27 , inj₁ _otherpunct-bar-26 :: []) :: (just "P112" , nothing , just _otherpunct-bar-27 , inj₂ 'Λ' :: []) :: []
cws-start _otherpunct-bar-26 = (just "P111" , nothing , just _otherpunct-bar-26 , inj₁ _otherpunct-bar-25 :: []) :: (just "P110" , nothing , just _otherpunct-bar-26 , inj₂ 'ρ' :: []) :: []
cws-start _otherpunct-bar-25 = (just "P109" , nothing , just _otherpunct-bar-25 , inj₁ _otherpunct-bar-24 :: []) :: (just "P108" , nothing , just _otherpunct-bar-25 , inj₂ 'ε' :: []) :: []
cws-start _otherpunct-bar-24 = (just "P107" , nothing , just _otherpunct-bar-24 , inj₁ _otherpunct-bar-23 :: []) :: (just "P106" , nothing , just _otherpunct-bar-24 , inj₂ 'β' :: []) :: []
cws-start _otherpunct-bar-23 = (just "P105" , nothing , just _otherpunct-bar-23 , inj₁ _otherpunct-bar-22 :: []) :: (just "P104" , nothing , just _otherpunct-bar-23 , inj₂ '-' :: []) :: []
cws-start _otherpunct-bar-22 = (just "P103" , nothing , just _otherpunct-bar-22 , inj₁ _otherpunct-bar-21 :: []) :: (just "P102" , nothing , just _otherpunct-bar-22 , inj₂ '𝒌' :: []) :: []
...
cws-start _otherpunct-bar-20 = (just "P99" , nothing , just _otherpunct-bar-20 , inj₁ _otherpunct-bar-19 :: []) :: (just "P98" , nothing , just _otherpunct-bar-20 , inj₂ 'ς' :: []) :: []
cws-start _otherpunct-bar-19 = (just "P97" , nothing , just _otherpunct-bar-19 , inj₁ _otherpunct-bar-18 :: []) :: (just "P96" , nothing , just _otherpunct-bar-19 , inj₂ 'θ' :: []) :: []
...
cws-start _otherpunct-bar-17 = (just "P93" , nothing , just _otherpunct-bar-17 , inj₁ _otherpunct-bar-16 :: []) :: (just "P92" , nothing , just _otherpunct-bar-17 , inj₂ '<' :: []) :: []
cws-start _otherpunct-bar-16 = (just "P91" , nothing , just _otherpunct-bar-16 , inj₁ _otherpunct-bar-15 :: []) :: (just "P90" , nothing , just _otherpunct-bar-16 , inj₂ '>' :: []) :: []
cws-start _otherpunct-bar-15 = (just "P89" , nothing , just _otherpunct-bar-15 , inj₁ _otherpunct-bar-14 :: []) :: (just "P88" , nothing , just _otherpunct-bar-15 , inj₂ '≃' :: []) :: []
cws-start _otherpunct-bar-14 = (just "P87" , nothing , just _otherpunct-bar-14 , inj₁ _otherpunct-bar-13 :: []) :: (just "P86" , nothing , just _otherpunct-bar-14 , inj₂ '\"' :: []) :: []
cws-start _otherpunct-bar-13 = (just "P85" , nothing , just _otherpunct-bar-13 , inj₁ _otherpunct-bar-12 :: []) :: (just "P84" , nothing , just _otherpunct-bar-13 , inj₂ 'δ' :: []) :: []
cws-start _otherpunct-bar-12 = (just "P83" , nothing , just _otherpunct-bar-12 , inj₂ 'μ' :: []) :: (just "P82" , nothing , just _otherpunct-bar-12 , inj₂ 'χ' :: []) :: []
cws-start _otherpunct = (just "P166" , nothing , just _otherpunct , inj₁ _otherpunct-bar-53 :: []) :: []
...
cws-start _nonws-plus-65 = (just "P195" , nothing , just _nonws-plus-65 , inj₁ _anynonwschar :: inj₁ _nonws-plus-65 :: []) :: (just "P194" , nothing , just _nonws-plus-65 , inj₁ _anynonwschar :: []) :: []
cws-start _nonws = (just "P196" , nothing , just _nonws , inj₁ _nonws-plus-65 :: []) :: []
...
cws-start _comment-star-59 = (just "P179" , nothing , just _comment-star-59 , inj₁ _anychar :: inj₁ _comment-star-59 :: []) :: (just "P178" , nothing , just _comment-star-59 , []) :: []
cws-start _comment = (just "P180" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-59 :: inj₂ '\n' :: []) :: []
cws-start _aws-bar-61 = (just "P184" , nothing , just _aws-bar-61 , inj₁ _aws-bar-60 :: []) :: (just "P183" , nothing , just _aws-bar-61 , inj₂ '\n' :: []) :: []
cws-start _aws-bar-60 = (just "P182" , nothing , just _aws-bar-60 , inj₂ ' ' :: []) :: (just "P181" , nothing , just _aws-bar-60 , inj₂ '\t' :: []) :: []
cws-start _aws = (just "P185" , nothing , just _aws , inj₁ _aws-bar-61 :: []) :: []
cws-start _anynonwschar-bar-64 = (just "P192" , nothing , just _anynonwschar-bar-64 , inj₁ _anynonwschar-bar-63 :: []) :: (just "P191" , nothing , just _anynonwschar-bar-64 , inj₁ _alpha :: []) :: []
cws-start _anynonwschar-bar-63 = (just "P190" , nothing , just _anynonwschar-bar-63 , inj₁ _otherpunct :: []) :: (just "P189" , nothing , just _anynonwschar-bar-63 , inj₁ _numpunct :: []) :: []
cws-start _anynonwschar = (just "P193" , nothing , just _anynonwschar , inj₁ _anynonwschar-bar-64 :: []) :: []
cws-start _anychar-bar-58 = (just "P176" , nothing , just _anychar-bar-58 , inj₁ _anychar-bar-57 :: []) :: (just "P175" , nothing , just _anychar-bar-58 , inj₁ _alpha :: []) :: []
cws-start _anychar-bar-57 = (just "P174" , nothing , just _anychar-bar-57 , inj₁ _anychar-bar-56 :: []) :: (just "P173" , nothing , just _anychar-bar-57 , inj₁ _numpunct :: []) :: []
cws-start _anychar-bar-56 = (just "P172" , nothing , just _anychar-bar-56 , inj₁ _anychar-bar-55 :: []) :: (just "P171" , nothing , just _anychar-bar-56 , inj₂ '\t' :: []) :: []
cws-start _anychar-bar-55 = (just "P170" , nothing , just _anychar-bar-55 , inj₁ _anychar-bar-54 :: []) :: (just "P169" , nothing , just _anychar-bar-55 , inj₂ ' ' :: []) :: []
cws-start _anychar-bar-54 = (just "P168" , nothing , just _anychar-bar-54 , inj₁ _otherpunct :: []) :: (just "P167" , nothing , just _anychar-bar-54 , inj₂ '%' :: []) :: []
cws-start _anychar = (just "P177" , nothing , just _anychar , inj₁ _anychar-bar-58 :: []) :: []
...
len-dec-rewrite {- P102-} ((Id "P102") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-otherpunct-bar-22 ::' rest , 2)
len-dec-rewrite {- P103-} ((Id "P103") :: _::_(ParseTree parsed-otherpunct-bar-21) rest) = just (ParseTree parsed-otherpunct-bar-22 ::' rest , 2)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar '-') rest) = just (ParseTree parsed-otherpunct-bar-23 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(ParseTree parsed-otherpunct-bar-22) rest) = just (ParseTree parsed-otherpunct-bar-23 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
len-dec-rewrite {- P107-} ((Id "P107") :: _::_(ParseTree parsed-otherpunct-bar-23) rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
len-dec-rewrite {- P108-} ((Id "P108") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-otherpunct-bar-25 ::' rest , 2)
...
len-dec-rewrite {- P120-} ((Id "P120") :: _::_(InputChar '{') rest) = just (ParseTree parsed-otherpunct-bar-31 ::' rest , 2)
...
len-dec-rewrite {- P152-} ((Id "P152") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-otherpunct-bar-47 ::' rest , 2)
...
len-dec-rewrite {- P156-} ((Id "P156") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-otherpunct-bar-49 ::' rest , 2)
len-dec-rewrite {- P157-} ((Id "P157") :: _::_(ParseTree parsed-otherpunct-bar-48) rest) = just (ParseTree parsed-otherpunct-bar-49 ::' rest , 2)
len-dec-rewrite {- P158-} ((Id "P158") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-otherpunct-bar-50 ::' rest , 2)
...
len-dec-rewrite {- P160-} ((Id "P160") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-otherpunct-bar-51 ::' rest , 2)
len-dec-rewrite {- P161-} ((Id "P161") :: _::_(ParseTree parsed-otherpunct-bar-50) rest) = just (ParseTree parsed-otherpunct-bar-51 ::' rest , 2)
len-dec-rewrite {- P162-} ((Id "P162") :: _::_(InputChar '□') rest) = just (ParseTree parsed-otherpunct-bar-52 ::' rest , 2)
...
len-dec-rewrite {- P166-} ((Id "P166") :: _::_(ParseTree parsed-otherpunct-bar-53) rest) = just (ParseTree parsed-otherpunct ::' rest , 2)
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(InputChar '%') rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
len-dec-rewrite {- P169-} ((Id "P169") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P17-} ((Id "P17") :: _::_(InputChar 'r') rest) = just (ParseTree parsed-alpha-range-1 ::' rest , 2)
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(ParseTree parsed-anychar-bar-54) rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree parsed-anychar-bar-55) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree parsed-anychar-bar-56) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anychar-bar-58 ::' rest , 2)
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(ParseTree parsed-anychar-bar-57) rest) = just (ParseTree parsed-anychar-bar-58 ::' rest , 2)
len-dec-rewrite {- P177-} ((Id "P177") :: _::_(ParseTree parsed-anychar-bar-58) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P179-} ((Id "P179") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-59) rest) = just (ParseTree parsed-comment-star-59 ::' rest , 3)
len-dec-rewrite {- P18-} ((Id "P18") :: _::_(InputChar 's') rest) = just (ParseTree parsed-alpha-range-1 ::' rest , 2)
len-dec-rewrite {- P180-} ((Id "P180") :: (InputChar '%') :: (ParseTree parsed-comment-star-59) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-60 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-60 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-61 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(ParseTree parsed-aws-bar-60) rest) = just (ParseTree parsed-aws-bar-61 ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree parsed-aws-bar-61) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-62 ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-62) rest) = just (ParseTree parsed-ws-plus-62 ::' rest , 3)
len-dec-rewrite {- P188-} ((Id "P188") :: _::_(ParseTree parsed-ws-plus-62) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anynonwschar-bar-63 ::' rest , 2)
len-dec-rewrite {- P19-} ((Id "P19") :: _::_(InputChar 't') rest) = just (ParseTree parsed-alpha-range-1 ::' rest , 2)
len-dec-rewrite {- P190-} ((Id "P190") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anynonwschar-bar-63 ::' rest , 2)
len-dec-rewrite {- P191-} ((Id "P191") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anynonwschar-bar-64 ::' rest , 2)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-anynonwschar-bar-63) rest) = just (ParseTree parsed-anynonwschar-bar-64 ::' rest , 2)
len-dec-rewrite {- P193-} ((Id "P193") :: _::_(ParseTree parsed-anynonwschar-bar-64) rest) = just (ParseTree parsed-anynonwschar ::' rest , 2)
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(ParseTree parsed-anynonwschar) rest) = just (ParseTree parsed-nonws-plus-65 ::' rest , 2)
len-dec-rewrite {- P195-} ((Id "P195") :: (ParseTree parsed-anynonwschar) :: _::_(ParseTree parsed-nonws-plus-65) rest) = just (ParseTree parsed-nonws-plus-65 ::' rest , 3)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(ParseTree parsed-nonws-plus-65) rest) = just (ParseTree parsed-nonws ::' rest , 2)
...
len-dec-rewrite {- P82-} ((Id "P82") :: _::_(InputChar 'χ') rest) = just (ParseTree parsed-otherpunct-bar-12 ::' rest , 2)
len-dec-rewrite {- P83-} ((Id "P83") :: _::_(InputChar 'μ') rest) = just (ParseTree parsed-otherpunct-bar-12 ::' rest , 2)
len-dec-rewrite {- P84-} ((Id "P84") :: _::_(InputChar 'δ') rest) = just (ParseTree parsed-otherpunct-bar-13 ::' rest , 2)
len-dec-rewrite {- P85-} ((Id "P85") :: _::_(ParseTree parsed-otherpunct-bar-12) rest) = just (ParseTree parsed-otherpunct-bar-13 ::' rest , 2)
len-dec-rewrite {- P86-} ((Id "P86") :: _::_(InputChar '\"') rest) = just (ParseTree parsed-otherpunct-bar-14 ::' rest , 2)
len-dec-rewrite {- P87-} ((Id "P87") :: _::_(ParseTree parsed-otherpunct-bar-13) rest) = just (ParseTree parsed-otherpunct-bar-14 ::' rest , 2)
len-dec-rewrite {- P88-} ((Id "P88") :: _::_(InputChar '≃') rest) = just (ParseTree parsed-otherpunct-bar-15 ::' rest , 2)
...
len-dec-rewrite {- P90-} ((Id "P90") :: _::_(InputChar '>') rest) = just (ParseTree parsed-otherpunct-bar-16 ::' rest , 2)
len-dec-rewrite {- P91-} ((Id "P91") :: _::_(ParseTree parsed-otherpunct-bar-15) rest) = just (ParseTree parsed-otherpunct-bar-16 ::' rest , 2)
len-dec-rewrite {- P92-} ((Id "P92") :: _::_(InputChar '<') rest) = just (ParseTree parsed-otherpunct-bar-17 ::' rest , 2)
...
len-dec-rewrite {- P96-} ((Id "P96") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-otherpunct-bar-19 ::' rest , 2)
len-dec-rewrite {- P97-} ((Id "P97") :: _::_(ParseTree parsed-otherpunct-bar-18) rest) = just (ParseTree parsed-otherpunct-bar-19 ::' rest , 2)
len-dec-rewrite {- P98-} ((Id "P98") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-otherpunct-bar-20 ::' rest , 2)
len-dec-rewrite {- P99-} ((Id "P99") :: _::_(ParseTree parsed-otherpunct-bar-19) rest) = just (ParseTree parsed-otherpunct-bar-20 ::' rest , 2)
len-dec-rewrite {- P178-} (_::_(Id "P178") rest) = just (ParseTree parsed-comment-star-59 ::' rest , 1)
