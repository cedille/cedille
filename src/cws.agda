...
data gratr2-nt : Set where
  ...
  _num : gratr2-nt
  _nonws-plus-67 : gratr2-nt
  _nonws : gratr2-nt
  _entity : gratr2-nt
  _entities : gratr2-nt
  _comment-star-61 : gratr2-nt
  _comment : gratr2-nt
  _aws-bar-63 : gratr2-nt
  _aws-bar-62 : gratr2-nt
  _aws : gratr2-nt
  _anynonwschar-bar-66 : gratr2-nt
  _anynonwschar-bar-65 : gratr2-nt
...
gratr2-nt-eq  _ws-plus-64 _ws-plus-64 = tt
...
gratr2-nt-eq  _nonws-plus-67 _nonws-plus-67 = tt
gratr2-nt-eq  _nonws _nonws = tt
gratr2-nt-eq  _entity _entity = tt
gratr2-nt-eq  _entities _entities = tt
gratr2-nt-eq  _comment-star-61 _comment-star-61 = tt
gratr2-nt-eq  _comment _comment = tt
gratr2-nt-eq  _aws-bar-63 _aws-bar-63 = tt
gratr2-nt-eq  _aws-bar-62 _aws-bar-62 = tt
gratr2-nt-eq  _aws _aws = tt
gratr2-nt-eq  _anynonwschar-bar-66 _anynonwschar-bar-66 = tt
gratr2-nt-eq  _anynonwschar-bar-65 _anynonwschar-bar-65 = tt
...
cws-start _ws-plus-64 = (just "P191" , nothing , just _ws-plus-64 , inj₁ _aws :: inj₁ _ws-plus-64 :: []) :: (just "P190" , nothing , just _ws-plus-64 , inj₁ _aws :: []) :: []
cws-start _ws = (just "P192" , nothing , just _ws , inj₁ _ws-plus-64 :: []) :: []
cws-start _start = (just "File" , nothing , just _start , inj₁ _entities :: []) :: []
cws-start _posinfo = (just "Posinfo" , nothing , just _posinfo , []) :: []
cws-start _otherpunct-bar-55 = (just "P169" , nothing , just _otherpunct-bar-55 , inj₁ _otherpunct-bar-54 :: []) :: (just "P168" , nothing , just _otherpunct-bar-55 , inj₂ '|' :: []) :: []
cws-start _otherpunct-bar-54 = (just "P167" , nothing , just _otherpunct-bar-54 , inj₁ _otherpunct-bar-53 :: []) :: (just "P166" , nothing , just _otherpunct-bar-54 , inj₂ '□' :: []) :: []
cws-start _otherpunct-bar-53 = (just "P165" , nothing , just _otherpunct-bar-53 , inj₁ _otherpunct-bar-52 :: []) :: (just "P164" , nothing , just _otherpunct-bar-53 , inj₂ 'Π' :: []) :: []
cws-start _otherpunct-bar-52 = (just "P163" , nothing , just _otherpunct-bar-52 , inj₁ _otherpunct-bar-51 :: []) :: (just "P162" , nothing , just _otherpunct-bar-52 , inj₂ 'ι' :: []) :: []
cws-start _otherpunct-bar-51 = (just "P161" , nothing , just _otherpunct-bar-51 , inj₁ _otherpunct-bar-50 :: []) :: (just "P160" , nothing , just _otherpunct-bar-51 , inj₂ 'λ' :: []) :: []
...
cws-start _otherpunct-bar-49 = (just "P157" , nothing , just _otherpunct-bar-49 , inj₁ _otherpunct-bar-48 :: []) :: (just "P156" , nothing , just _otherpunct-bar-49 , inj₂ 'π' :: []) :: []
...
cws-start _otherpunct-bar-29 = (just "P117" , nothing , just _otherpunct-bar-29 , inj₁ _otherpunct-bar-28 :: []) :: (just "P116" , nothing , just _otherpunct-bar-29 , inj₂ 'Λ' :: []) :: []
cws-start _otherpunct-bar-28 = (just "P115" , nothing , just _otherpunct-bar-28 , inj₁ _otherpunct-bar-27 :: []) :: (just "P114" , nothing , just _otherpunct-bar-28 , inj₂ 'ρ' :: []) :: []
cws-start _otherpunct-bar-27 = (just "P113" , nothing , just _otherpunct-bar-27 , inj₁ _otherpunct-bar-26 :: []) :: (just "P112" , nothing , just _otherpunct-bar-27 , inj₂ 'ε' :: []) :: []
cws-start _otherpunct-bar-26 = (just "P111" , nothing , just _otherpunct-bar-26 , inj₁ _otherpunct-bar-25 :: []) :: (just "P110" , nothing , just _otherpunct-bar-26 , inj₂ 'β' :: []) :: []
...
cws-start _otherpunct-bar-24 = (just "P107" , nothing , just _otherpunct-bar-24 , inj₁ _otherpunct-bar-23 :: []) :: (just "P106" , nothing , just _otherpunct-bar-24 , inj₂ '𝒌' :: []) :: []
...
cws-start _otherpunct-bar-22 = (just "P103" , nothing , just _otherpunct-bar-22 , inj₁ _otherpunct-bar-21 :: []) :: (just "P102" , nothing , just _otherpunct-bar-22 , inj₂ 'ς' :: []) :: []
cws-start _otherpunct-bar-21 = (just "P101" , nothing , just _otherpunct-bar-21 , inj₁ _otherpunct-bar-20 :: []) :: (just "P100" , nothing , just _otherpunct-bar-21 , inj₂ 'θ' :: []) :: []
...
cws-start _otherpunct-bar-15 = (just "P89" , nothing , just _otherpunct-bar-15 , inj₁ _otherpunct-bar-14 :: []) :: (just "P88" , nothing , just _otherpunct-bar-15 , inj₂ 'δ' :: []) :: []
cws-start _otherpunct-bar-14 = (just "P87" , nothing , just _otherpunct-bar-14 , inj₁ _otherpunct-bar-13 :: []) :: (just "P86" , nothing , just _otherpunct-bar-14 , inj₂ 'χ' :: []) :: []
cws-start _otherpunct-bar-13 = (just "P85" , nothing , just _otherpunct-bar-13 , inj₁ _otherpunct-bar-12 :: []) :: (just "P84" , nothing , just _otherpunct-bar-13 , inj₂ 'μ' :: []) :: []
cws-start _otherpunct-bar-12 = (just "P83" , nothing , just _otherpunct-bar-12 , inj₂ 'φ' :: []) :: (just "P82" , nothing , just _otherpunct-bar-12 , inj₂ 'υ' :: []) :: []
cws-start _otherpunct = (just "P170" , nothing , just _otherpunct , inj₁ _otherpunct-bar-55 :: []) :: []
...
cws-start _nonws-plus-67 = (just "P199" , nothing , just _nonws-plus-67 , inj₁ _anynonwschar :: inj₁ _nonws-plus-67 :: []) :: (just "P198" , nothing , just _nonws-plus-67 , inj₁ _anynonwschar :: []) :: []
cws-start _nonws = (just "P200" , nothing , just _nonws , inj₁ _nonws-plus-67 :: []) :: []
...
cws-start _comment-star-61 = (just "P183" , nothing , just _comment-star-61 , inj₁ _anychar :: inj₁ _comment-star-61 :: []) :: (just "P182" , nothing , just _comment-star-61 , []) :: []
cws-start _comment = (just "P184" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-61 :: inj₂ '\n' :: []) :: []
cws-start _aws-bar-63 = (just "P188" , nothing , just _aws-bar-63 , inj₁ _aws-bar-62 :: []) :: (just "P187" , nothing , just _aws-bar-63 , inj₂ '\n' :: []) :: []
cws-start _aws-bar-62 = (just "P186" , nothing , just _aws-bar-62 , inj₂ ' ' :: []) :: (just "P185" , nothing , just _aws-bar-62 , inj₂ '\t' :: []) :: []
cws-start _aws = (just "P189" , nothing , just _aws , inj₁ _aws-bar-63 :: []) :: []
cws-start _anynonwschar-bar-66 = (just "P196" , nothing , just _anynonwschar-bar-66 , inj₁ _anynonwschar-bar-65 :: []) :: (just "P195" , nothing , just _anynonwschar-bar-66 , inj₁ _alpha :: []) :: []
cws-start _anynonwschar-bar-65 = (just "P194" , nothing , just _anynonwschar-bar-65 , inj₁ _otherpunct :: []) :: (just "P193" , nothing , just _anynonwschar-bar-65 , inj₁ _numpunct :: []) :: []
cws-start _anynonwschar = (just "P197" , nothing , just _anynonwschar , inj₁ _anynonwschar-bar-66 :: []) :: []
cws-start _anychar-bar-60 = (just "P180" , nothing , just _anychar-bar-60 , inj₁ _anychar-bar-59 :: []) :: (just "P179" , nothing , just _anychar-bar-60 , inj₁ _alpha :: []) :: []
cws-start _anychar-bar-59 = (just "P178" , nothing , just _anychar-bar-59 , inj₁ _anychar-bar-58 :: []) :: (just "P177" , nothing , just _anychar-bar-59 , inj₁ _numpunct :: []) :: []
cws-start _anychar-bar-58 = (just "P176" , nothing , just _anychar-bar-58 , inj₁ _anychar-bar-57 :: []) :: (just "P175" , nothing , just _anychar-bar-58 , inj₂ '\t' :: []) :: []
cws-start _anychar-bar-57 = (just "P174" , nothing , just _anychar-bar-57 , inj₁ _anychar-bar-56 :: []) :: (just "P173" , nothing , just _anychar-bar-57 , inj₂ ' ' :: []) :: []
cws-start _anychar-bar-56 = (just "P172" , nothing , just _anychar-bar-56 , inj₁ _otherpunct :: []) :: (just "P171" , nothing , just _anychar-bar-56 , inj₂ '%' :: []) :: []
cws-start _anychar = (just "P181" , nothing , just _anychar , inj₁ _anychar-bar-60 :: []) :: []
...
len-dec-rewrite {- P100-} ((Id "P100") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-otherpunct-bar-21 ::' rest , 2)
len-dec-rewrite {- P101-} ((Id "P101") :: _::_(ParseTree parsed-otherpunct-bar-20) rest) = just (ParseTree parsed-otherpunct-bar-21 ::' rest , 2)
len-dec-rewrite {- P102-} ((Id "P102") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-otherpunct-bar-22 ::' rest , 2)
...
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
...
len-dec-rewrite {- P110-} ((Id "P110") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-otherpunct-bar-26 ::' rest , 2)
len-dec-rewrite {- P111-} ((Id "P111") :: _::_(ParseTree parsed-otherpunct-bar-25) rest) = just (ParseTree parsed-otherpunct-bar-26 ::' rest , 2)
len-dec-rewrite {- P112-} ((Id "P112") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-otherpunct-bar-27 ::' rest , 2)
len-dec-rewrite {- P113-} ((Id "P113") :: _::_(ParseTree parsed-otherpunct-bar-26) rest) = just (ParseTree parsed-otherpunct-bar-27 ::' rest , 2)
len-dec-rewrite {- P114-} ((Id "P114") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-otherpunct-bar-28 ::' rest , 2)
len-dec-rewrite {- P115-} ((Id "P115") :: _::_(ParseTree parsed-otherpunct-bar-27) rest) = just (ParseTree parsed-otherpunct-bar-28 ::' rest , 2)
len-dec-rewrite {- P116-} ((Id "P116") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-otherpunct-bar-29 ::' rest , 2)
...
len-dec-rewrite {- P156-} ((Id "P156") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-otherpunct-bar-49 ::' rest , 2)
...
len-dec-rewrite {- P160-} ((Id "P160") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-otherpunct-bar-51 ::' rest , 2)
len-dec-rewrite {- P161-} ((Id "P161") :: _::_(ParseTree parsed-otherpunct-bar-50) rest) = just (ParseTree parsed-otherpunct-bar-51 ::' rest , 2)
len-dec-rewrite {- P162-} ((Id "P162") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-otherpunct-bar-52 ::' rest , 2)
len-dec-rewrite {- P163-} ((Id "P163") :: _::_(ParseTree parsed-otherpunct-bar-51) rest) = just (ParseTree parsed-otherpunct-bar-52 ::' rest , 2)
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-otherpunct-bar-53 ::' rest , 2)
len-dec-rewrite {- P165-} ((Id "P165") :: _::_(ParseTree parsed-otherpunct-bar-52) rest) = just (ParseTree parsed-otherpunct-bar-53 ::' rest , 2)
len-dec-rewrite {- P166-} ((Id "P166") :: _::_(InputChar '□') rest) = just (ParseTree parsed-otherpunct-bar-54 ::' rest , 2)
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(ParseTree parsed-otherpunct-bar-53) rest) = just (ParseTree parsed-otherpunct-bar-54 ::' rest , 2)
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(InputChar '|') rest) = just (ParseTree parsed-otherpunct-bar-55 ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(ParseTree parsed-otherpunct-bar-55) rest) = just (ParseTree parsed-otherpunct ::' rest , 2)
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(InputChar '%') rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree parsed-anychar-bar-56) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-anychar-bar-58 ::' rest , 2)
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(ParseTree parsed-anychar-bar-57) rest) = just (ParseTree parsed-anychar-bar-58 ::' rest , 2)
len-dec-rewrite {- P177-} ((Id "P177") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anychar-bar-59 ::' rest , 2)
len-dec-rewrite {- P178-} ((Id "P178") :: _::_(ParseTree parsed-anychar-bar-58) rest) = just (ParseTree parsed-anychar-bar-59 ::' rest , 2)
len-dec-rewrite {- P179-} ((Id "P179") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anychar-bar-60 ::' rest , 2)
...
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(ParseTree parsed-anychar-bar-60) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-61) rest) = just (ParseTree parsed-comment-star-61 ::' rest , 3)
len-dec-rewrite {- P184-} ((Id "P184") :: (InputChar '%') :: (ParseTree parsed-comment-star-61) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-62 ::' rest , 2)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-62 ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-63 ::' rest , 2)
len-dec-rewrite {- P188-} ((Id "P188") :: _::_(ParseTree parsed-aws-bar-62) rest) = just (ParseTree parsed-aws-bar-63 ::' rest , 2)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(ParseTree parsed-aws-bar-63) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P19-} ((Id "P19") :: _::_(InputChar 't') rest) = just (ParseTree parsed-alpha-range-1 ::' rest , 2)
len-dec-rewrite {- P190-} ((Id "P190") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-64 ::' rest , 2)
len-dec-rewrite {- P191-} ((Id "P191") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-64) rest) = just (ParseTree parsed-ws-plus-64 ::' rest , 3)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-ws-plus-64) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P193-} ((Id "P193") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anynonwschar-bar-65 ::' rest , 2)
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anynonwschar-bar-65 ::' rest , 2)
len-dec-rewrite {- P195-} ((Id "P195") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anynonwschar-bar-66 ::' rest , 2)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(ParseTree parsed-anynonwschar-bar-65) rest) = just (ParseTree parsed-anynonwschar-bar-66 ::' rest , 2)
len-dec-rewrite {- P197-} ((Id "P197") :: _::_(ParseTree parsed-anynonwschar-bar-66) rest) = just (ParseTree parsed-anynonwschar ::' rest , 2)
len-dec-rewrite {- P198-} ((Id "P198") :: _::_(ParseTree parsed-anynonwschar) rest) = just (ParseTree parsed-nonws-plus-67 ::' rest , 2)
len-dec-rewrite {- P199-} ((Id "P199") :: (ParseTree parsed-anynonwschar) :: _::_(ParseTree parsed-nonws-plus-67) rest) = just (ParseTree parsed-nonws-plus-67 ::' rest , 3)
...
len-dec-rewrite {- P200-} ((Id "P200") :: _::_(ParseTree parsed-nonws-plus-67) rest) = just (ParseTree parsed-nonws ::' rest , 2)
...
len-dec-rewrite {- P82-} ((Id "P82") :: _::_(InputChar 'υ') rest) = just (ParseTree parsed-otherpunct-bar-12 ::' rest , 2)
len-dec-rewrite {- P83-} ((Id "P83") :: _::_(InputChar 'φ') rest) = just (ParseTree parsed-otherpunct-bar-12 ::' rest , 2)
len-dec-rewrite {- P84-} ((Id "P84") :: _::_(InputChar 'μ') rest) = just (ParseTree parsed-otherpunct-bar-13 ::' rest , 2)
len-dec-rewrite {- P85-} ((Id "P85") :: _::_(ParseTree parsed-otherpunct-bar-12) rest) = just (ParseTree parsed-otherpunct-bar-13 ::' rest , 2)
len-dec-rewrite {- P86-} ((Id "P86") :: _::_(InputChar 'χ') rest) = just (ParseTree parsed-otherpunct-bar-14 ::' rest , 2)
len-dec-rewrite {- P87-} ((Id "P87") :: _::_(ParseTree parsed-otherpunct-bar-13) rest) = just (ParseTree parsed-otherpunct-bar-14 ::' rest , 2)
len-dec-rewrite {- P88-} ((Id "P88") :: _::_(InputChar 'δ') rest) = just (ParseTree parsed-otherpunct-bar-15 ::' rest , 2)
...
len-dec-rewrite {- P182-} (_::_(Id "P182") rest) = just (ParseTree parsed-comment-star-61 ::' rest , 1)
