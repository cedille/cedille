...
gratr2-nt-eq  _nonws-plus-69 _nonws-plus-69 = tt
...
cws-start _ws-plus-66 = (just "P195" , nothing , just _ws-plus-66 , inj₁ _aws :: inj₁ _ws-plus-66 :: []) :: (just "P194" , nothing , just _ws-plus-66 , inj₁ _aws :: []) :: []
cws-start _ws = (just "P196" , nothing , just _ws , inj₁ _ws-plus-66 :: []) :: []
...
cws-start _otherpunct-bar-55 = (just "P169" , nothing , just _otherpunct-bar-55 , inj₁ _otherpunct-bar-54 :: []) :: (just "P168" , nothing , just _otherpunct-bar-55 , inj₂ 'Π' :: []) :: []
cws-start _otherpunct-bar-54 = (just "P167" , nothing , just _otherpunct-bar-54 , inj₁ _otherpunct-bar-53 :: []) :: (just "P166" , nothing , just _otherpunct-bar-54 , inj₂ 'ι' :: []) :: []
cws-start _otherpunct-bar-53 = (just "P165" , nothing , just _otherpunct-bar-53 , inj₁ _otherpunct-bar-52 :: []) :: (just "P164" , nothing , just _otherpunct-bar-53 , inj₂ 'λ' :: []) :: []
...
cws-start _otherpunct-bar-30 = (just "P119" , nothing , just _otherpunct-bar-30 , inj₁ _otherpunct-bar-29 :: []) :: (just "P118" , nothing , just _otherpunct-bar-30 , inj₂ 'Λ' :: []) :: []
cws-start _otherpunct-bar-29 = (just "P117" , nothing , just _otherpunct-bar-29 , inj₁ _otherpunct-bar-28 :: []) :: (just "P116" , nothing , just _otherpunct-bar-29 , inj₂ 'ρ' :: []) :: []
cws-start _otherpunct-bar-28 = (just "P115" , nothing , just _otherpunct-bar-28 , inj₁ _otherpunct-bar-27 :: []) :: (just "P114" , nothing , just _otherpunct-bar-28 , inj₂ 'ε' :: []) :: []
cws-start _otherpunct-bar-27 = (just "P113" , nothing , just _otherpunct-bar-27 , inj₁ _otherpunct-bar-26 :: []) :: (just "P112" , nothing , just _otherpunct-bar-27 , inj₂ 'β' :: []) :: []
cws-start _otherpunct-bar-26 = (just "P111" , nothing , just _otherpunct-bar-26 , inj₁ _otherpunct-bar-25 :: []) :: (just "P110" , nothing , just _otherpunct-bar-26 , inj₂ '-' :: []) :: []
cws-start _otherpunct-bar-25 = (just "P109" , nothing , just _otherpunct-bar-25 , inj₁ _otherpunct-bar-24 :: []) :: (just "P108" , nothing , just _otherpunct-bar-25 , inj₂ '𝒌' :: []) :: []
cws-start _otherpunct-bar-24 = (just "P107" , nothing , just _otherpunct-bar-24 , inj₁ _otherpunct-bar-23 :: []) :: (just "P106" , nothing , just _otherpunct-bar-24 , inj₂ '=' :: []) :: []
cws-start _otherpunct-bar-23 = (just "P105" , nothing , just _otherpunct-bar-23 , inj₁ _otherpunct-bar-22 :: []) :: (just "P104" , nothing , just _otherpunct-bar-23 , inj₂ 'ς' :: []) :: []
cws-start _otherpunct-bar-22 = (just "P103" , nothing , just _otherpunct-bar-22 , inj₁ _otherpunct-bar-21 :: []) :: (just "P102" , nothing , just _otherpunct-bar-22 , inj₂ 'θ' :: []) :: []
...
cws-start _otherpunct-bar-16 = (just "P91" , nothing , just _otherpunct-bar-16 , inj₁ _otherpunct-bar-15 :: []) :: (just "P90" , nothing , just _otherpunct-bar-16 , inj₂ 'δ' :: []) :: []
cws-start _otherpunct-bar-15 = (just "P89" , nothing , just _otherpunct-bar-15 , inj₁ _otherpunct-bar-14 :: []) :: (just "P88" , nothing , just _otherpunct-bar-15 , inj₂ 'χ' :: []) :: []
cws-start _otherpunct-bar-14 = (just "P87" , nothing , just _otherpunct-bar-14 , inj₁ _otherpunct-bar-13 :: []) :: (just "P86" , nothing , just _otherpunct-bar-14 , inj₂ 'μ' :: []) :: []
cws-start _otherpunct-bar-13 = (just "P85" , nothing , just _otherpunct-bar-13 , inj₁ _otherpunct-bar-12 :: []) :: (just "P84" , nothing , just _otherpunct-bar-13 , inj₂ 'υ' :: []) :: []
cws-start _otherpunct-bar-12 = (just "P83" , nothing , just _otherpunct-bar-12 , inj₂ '◂' :: []) :: (just "P82" , nothing , just _otherpunct-bar-12 , inj₂ 'φ' :: []) :: []
cws-start _otherpunct = (just "P174" , nothing , just _otherpunct , inj₁ _otherpunct-bar-57 :: []) :: []
...
cws-start _nonws-plus-69 = (just "P203" , nothing , just _nonws-plus-69 , inj₁ _anynonwschar :: inj₁ _nonws-plus-69 :: []) :: (just "P202" , nothing , just _nonws-plus-69 , inj₁ _anynonwschar :: []) :: []
cws-start _nonws = (just "P204" , nothing , just _nonws , inj₁ _nonws-plus-69 :: []) :: []
...
cws-start _comment-star-63 = (just "P187" , nothing , just _comment-star-63 , inj₁ _anychar :: inj₁ _comment-star-63 :: []) :: (just "P186" , nothing , just _comment-star-63 , []) :: []
cws-start _comment = (just "P188" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-63 :: inj₂ '\n' :: []) :: []
cws-start _aws-bar-65 = (just "P192" , nothing , just _aws-bar-65 , inj₁ _aws-bar-64 :: []) :: (just "P191" , nothing , just _aws-bar-65 , inj₂ '\n' :: []) :: []
cws-start _aws-bar-64 = (just "P190" , nothing , just _aws-bar-64 , inj₂ ' ' :: []) :: (just "P189" , nothing , just _aws-bar-64 , inj₂ '\t' :: []) :: []
cws-start _aws = (just "P193" , nothing , just _aws , inj₁ _aws-bar-65 :: []) :: []
cws-start _anynonwschar-bar-68 = (just "P200" , nothing , just _anynonwschar-bar-68 , inj₁ _anynonwschar-bar-67 :: []) :: (just "P199" , nothing , just _anynonwschar-bar-68 , inj₁ _alpha :: []) :: []
cws-start _anynonwschar-bar-67 = (just "P198" , nothing , just _anynonwschar-bar-67 , inj₁ _otherpunct :: []) :: (just "P197" , nothing , just _anynonwschar-bar-67 , inj₁ _numpunct :: []) :: []
cws-start _anynonwschar = (just "P201" , nothing , just _anynonwschar , inj₁ _anynonwschar-bar-68 :: []) :: []
cws-start _anychar-bar-62 = (just "P184" , nothing , just _anychar-bar-62 , inj₁ _anychar-bar-61 :: []) :: (just "P183" , nothing , just _anychar-bar-62 , inj₁ _alpha :: []) :: []
cws-start _anychar-bar-61 = (just "P182" , nothing , just _anychar-bar-61 , inj₁ _anychar-bar-60 :: []) :: (just "P181" , nothing , just _anychar-bar-61 , inj₁ _numpunct :: []) :: []
...
cws-start _anychar-bar-58 = (just "P176" , nothing , just _anychar-bar-58 , inj₁ _otherpunct :: []) :: (just "P175" , nothing , just _anychar-bar-58 , inj₂ '%' :: []) :: []
cws-start _anychar = (just "P185" , nothing , just _anychar , inj₁ _anychar-bar-62 :: []) :: []
...
len-dec-rewrite {- P102-} ((Id "P102") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-otherpunct-bar-22 ::' rest , 2)
len-dec-rewrite {- P103-} ((Id "P103") :: _::_(ParseTree parsed-otherpunct-bar-21) rest) = just (ParseTree parsed-otherpunct-bar-22 ::' rest , 2)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-otherpunct-bar-23 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(ParseTree parsed-otherpunct-bar-22) rest) = just (ParseTree parsed-otherpunct-bar-23 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar '=') rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
len-dec-rewrite {- P107-} ((Id "P107") :: _::_(ParseTree parsed-otherpunct-bar-23) rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
len-dec-rewrite {- P108-} ((Id "P108") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-otherpunct-bar-25 ::' rest , 2)
...
len-dec-rewrite {- P110-} ((Id "P110") :: _::_(InputChar '-') rest) = just (ParseTree parsed-otherpunct-bar-26 ::' rest , 2)
len-dec-rewrite {- P111-} ((Id "P111") :: _::_(ParseTree parsed-otherpunct-bar-25) rest) = just (ParseTree parsed-otherpunct-bar-26 ::' rest , 2)
len-dec-rewrite {- P112-} ((Id "P112") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-otherpunct-bar-27 ::' rest , 2)
len-dec-rewrite {- P113-} ((Id "P113") :: _::_(ParseTree parsed-otherpunct-bar-26) rest) = just (ParseTree parsed-otherpunct-bar-27 ::' rest , 2)
len-dec-rewrite {- P114-} ((Id "P114") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-otherpunct-bar-28 ::' rest , 2)
len-dec-rewrite {- P115-} ((Id "P115") :: _::_(ParseTree parsed-otherpunct-bar-27) rest) = just (ParseTree parsed-otherpunct-bar-28 ::' rest , 2)
len-dec-rewrite {- P116-} ((Id "P116") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-otherpunct-bar-29 ::' rest , 2)
len-dec-rewrite {- P117-} ((Id "P117") :: _::_(ParseTree parsed-otherpunct-bar-28) rest) = just (ParseTree parsed-otherpunct-bar-29 ::' rest , 2)
len-dec-rewrite {- P118-} ((Id "P118") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-otherpunct-bar-30 ::' rest , 2)
...
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-otherpunct-bar-53 ::' rest , 2)
len-dec-rewrite {- P165-} ((Id "P165") :: _::_(ParseTree parsed-otherpunct-bar-52) rest) = just (ParseTree parsed-otherpunct-bar-53 ::' rest , 2)
len-dec-rewrite {- P166-} ((Id "P166") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-otherpunct-bar-54 ::' rest , 2)
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(ParseTree parsed-otherpunct-bar-53) rest) = just (ParseTree parsed-otherpunct-bar-54 ::' rest , 2)
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-otherpunct-bar-55 ::' rest , 2)
...
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree parsed-otherpunct-bar-57) rest) = just (ParseTree parsed-otherpunct ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(InputChar '%') rest) = just (ParseTree parsed-anychar-bar-58 ::' rest , 2)
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anychar-bar-58 ::' rest , 2)
...
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anychar-bar-61 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(ParseTree parsed-anychar-bar-60) rest) = just (ParseTree parsed-anychar-bar-61 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anychar-bar-62 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(ParseTree parsed-anychar-bar-61) rest) = just (ParseTree parsed-anychar-bar-62 ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree parsed-anychar-bar-62) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-63) rest) = just (ParseTree parsed-comment-star-63 ::' rest , 3)
len-dec-rewrite {- P188-} ((Id "P188") :: (InputChar '%') :: (ParseTree parsed-comment-star-63) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-64 ::' rest , 2)
len-dec-rewrite {- P19-} ((Id "P19") :: _::_(InputChar 't') rest) = just (ParseTree parsed-alpha-range-1 ::' rest , 2)
len-dec-rewrite {- P190-} ((Id "P190") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-64 ::' rest , 2)
len-dec-rewrite {- P191-} ((Id "P191") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-65 ::' rest , 2)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-aws-bar-64) rest) = just (ParseTree parsed-aws-bar-65 ::' rest , 2)
len-dec-rewrite {- P193-} ((Id "P193") :: _::_(ParseTree parsed-aws-bar-65) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-66 ::' rest , 2)
len-dec-rewrite {- P195-} ((Id "P195") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-66) rest) = just (ParseTree parsed-ws-plus-66 ::' rest , 3)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(ParseTree parsed-ws-plus-66) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P197-} ((Id "P197") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anynonwschar-bar-67 ::' rest , 2)
len-dec-rewrite {- P198-} ((Id "P198") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anynonwschar-bar-67 ::' rest , 2)
len-dec-rewrite {- P199-} ((Id "P199") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anynonwschar-bar-68 ::' rest , 2)
...
len-dec-rewrite {- P200-} ((Id "P200") :: _::_(ParseTree parsed-anynonwschar-bar-67) rest) = just (ParseTree parsed-anynonwschar-bar-68 ::' rest , 2)
len-dec-rewrite {- P201-} ((Id "P201") :: _::_(ParseTree parsed-anynonwschar-bar-68) rest) = just (ParseTree parsed-anynonwschar ::' rest , 2)
len-dec-rewrite {- P202-} ((Id "P202") :: _::_(ParseTree parsed-anynonwschar) rest) = just (ParseTree parsed-nonws-plus-69 ::' rest , 2)
len-dec-rewrite {- P203-} ((Id "P203") :: (ParseTree parsed-anynonwschar) :: _::_(ParseTree parsed-nonws-plus-69) rest) = just (ParseTree parsed-nonws-plus-69 ::' rest , 3)
len-dec-rewrite {- P204-} ((Id "P204") :: _::_(ParseTree parsed-nonws-plus-69) rest) = just (ParseTree parsed-nonws ::' rest , 2)
...
len-dec-rewrite {- P82-} ((Id "P82") :: _::_(InputChar 'φ') rest) = just (ParseTree parsed-otherpunct-bar-12 ::' rest , 2)
len-dec-rewrite {- P83-} ((Id "P83") :: _::_(InputChar '◂') rest) = just (ParseTree parsed-otherpunct-bar-12 ::' rest , 2)
len-dec-rewrite {- P84-} ((Id "P84") :: _::_(InputChar 'υ') rest) = just (ParseTree parsed-otherpunct-bar-13 ::' rest , 2)
len-dec-rewrite {- P85-} ((Id "P85") :: _::_(ParseTree parsed-otherpunct-bar-12) rest) = just (ParseTree parsed-otherpunct-bar-13 ::' rest , 2)
len-dec-rewrite {- P86-} ((Id "P86") :: _::_(InputChar 'μ') rest) = just (ParseTree parsed-otherpunct-bar-14 ::' rest , 2)
len-dec-rewrite {- P87-} ((Id "P87") :: _::_(ParseTree parsed-otherpunct-bar-13) rest) = just (ParseTree parsed-otherpunct-bar-14 ::' rest , 2)
len-dec-rewrite {- P88-} ((Id "P88") :: _::_(InputChar 'χ') rest) = just (ParseTree parsed-otherpunct-bar-15 ::' rest , 2)
...
len-dec-rewrite {- P90-} ((Id "P90") :: _::_(InputChar 'δ') rest) = just (ParseTree parsed-otherpunct-bar-16 ::' rest , 2)
...
len-dec-rewrite {- P186-} (_::_(Id "P186") rest) = just (ParseTree parsed-comment-star-63 ::' rest , 1)
