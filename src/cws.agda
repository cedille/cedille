...
data gratr2-nt : Set where
  ...
  _aws : gratr2-nt
  _anynonwschar-bar-67 : gratr2-nt
...
gratr2-nt-eq  _ws-plus-65 _ws-plus-65 = tt
...
gratr2-nt-eq  _nonws-plus-68 _nonws-plus-68 = tt
...
gratr2-nt-eq  _anynonwschar-bar-67 _anynonwschar-bar-67 = tt
...
cws-start _ws-plus-65 = (just "P193" , nothing , just _ws-plus-65 , inj₁ _aws :: inj₁ _ws-plus-65 :: []) :: (just "P192" , nothing , just _ws-plus-65 , inj₁ _aws :: []) :: []
cws-start _ws = (just "P194" , nothing , just _ws , inj₁ _ws-plus-65 :: []) :: []
cws-start _start = (just "File" , nothing , just _start , inj₁ _entities :: []) :: []
cws-start _posinfo = (just "Posinfo" , nothing , just _posinfo , []) :: []
cws-start _otherpunct-bar-56 = (just "P171" , nothing , just _otherpunct-bar-56 , inj₁ _otherpunct-bar-55 :: []) :: (just "P170" , nothing , just _otherpunct-bar-56 , inj₂ '|' :: []) :: []
...
cws-start _otherpunct-bar-54 = (just "P167" , nothing , just _otherpunct-bar-54 , inj₁ _otherpunct-bar-53 :: []) :: (just "P166" , nothing , just _otherpunct-bar-54 , inj₂ 'Π' :: []) :: []
cws-start _otherpunct-bar-53 = (just "P165" , nothing , just _otherpunct-bar-53 , inj₁ _otherpunct-bar-52 :: []) :: (just "P164" , nothing , just _otherpunct-bar-53 , inj₂ 'ι' :: []) :: []
cws-start _otherpunct-bar-52 = (just "P163" , nothing , just _otherpunct-bar-52 , inj₁ _otherpunct-bar-51 :: []) :: (just "P162" , nothing , just _otherpunct-bar-52 , inj₂ 'λ' :: []) :: []
...
cws-start _otherpunct = (just "P172" , nothing , just _otherpunct , inj₁ _otherpunct-bar-56 :: []) :: []
...
cws-start _nonws-plus-68 = (just "P201" , nothing , just _nonws-plus-68 , inj₁ _anynonwschar :: inj₁ _nonws-plus-68 :: []) :: (just "P200" , nothing , just _nonws-plus-68 , inj₁ _anynonwschar :: []) :: []
cws-start _nonws = (just "P202" , nothing , just _nonws , inj₁ _nonws-plus-68 :: []) :: []
...
cws-start _comment-star-62 = (just "P185" , nothing , just _comment-star-62 , inj₁ _anychar :: inj₁ _comment-star-62 :: []) :: (just "P184" , nothing , just _comment-star-62 , []) :: []
cws-start _comment = (just "P186" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-62 :: inj₂ '\n' :: []) :: []
cws-start _aws-bar-64 = (just "P190" , nothing , just _aws-bar-64 , inj₁ _aws-bar-63 :: []) :: (just "P189" , nothing , just _aws-bar-64 , inj₂ '\n' :: []) :: []
cws-start _aws-bar-63 = (just "P188" , nothing , just _aws-bar-63 , inj₂ ' ' :: []) :: (just "P187" , nothing , just _aws-bar-63 , inj₂ '\t' :: []) :: []
cws-start _aws = (just "P191" , nothing , just _aws , inj₁ _aws-bar-64 :: []) :: []
cws-start _anynonwschar-bar-67 = (just "P198" , nothing , just _anynonwschar-bar-67 , inj₁ _anynonwschar-bar-66 :: []) :: (just "P197" , nothing , just _anynonwschar-bar-67 , inj₁ _alpha :: []) :: []
cws-start _anynonwschar-bar-66 = (just "P196" , nothing , just _anynonwschar-bar-66 , inj₁ _otherpunct :: []) :: (just "P195" , nothing , just _anynonwschar-bar-66 , inj₁ _numpunct :: []) :: []
cws-start _anynonwschar = (just "P199" , nothing , just _anynonwschar , inj₁ _anynonwschar-bar-67 :: []) :: []
cws-start _anychar-bar-61 = (just "P182" , nothing , just _anychar-bar-61 , inj₁ _anychar-bar-60 :: []) :: (just "P181" , nothing , just _anychar-bar-61 , inj₁ _alpha :: []) :: []
cws-start _anychar-bar-60 = (just "P180" , nothing , just _anychar-bar-60 , inj₁ _anychar-bar-59 :: []) :: (just "P179" , nothing , just _anychar-bar-60 , inj₁ _numpunct :: []) :: []
cws-start _anychar-bar-59 = (just "P178" , nothing , just _anychar-bar-59 , inj₁ _anychar-bar-58 :: []) :: (just "P177" , nothing , just _anychar-bar-59 , inj₂ '\t' :: []) :: []
...
cws-start _anychar-bar-57 = (just "P174" , nothing , just _anychar-bar-57 , inj₁ _otherpunct :: []) :: (just "P173" , nothing , just _anychar-bar-57 , inj₂ '%' :: []) :: []
cws-start _anychar = (just "P183" , nothing , just _anychar , inj₁ _anychar-bar-61 :: []) :: []
...
len-dec-rewrite {- P162-} ((Id "P162") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-otherpunct-bar-52 ::' rest , 2)
len-dec-rewrite {- P163-} ((Id "P163") :: _::_(ParseTree parsed-otherpunct-bar-51) rest) = just (ParseTree parsed-otherpunct-bar-52 ::' rest , 2)
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-otherpunct-bar-53 ::' rest , 2)
len-dec-rewrite {- P165-} ((Id "P165") :: _::_(ParseTree parsed-otherpunct-bar-52) rest) = just (ParseTree parsed-otherpunct-bar-53 ::' rest , 2)
len-dec-rewrite {- P166-} ((Id "P166") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-otherpunct-bar-54 ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(InputChar '|') rest) = just (ParseTree parsed-otherpunct-bar-56 ::' rest , 2)
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(ParseTree parsed-otherpunct-bar-55) rest) = just (ParseTree parsed-otherpunct-bar-56 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree parsed-otherpunct-bar-56) rest) = just (ParseTree parsed-otherpunct ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(InputChar '%') rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
...
len-dec-rewrite {- P179-} ((Id "P179") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anychar-bar-60 ::' rest , 2)
...
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anychar-bar-61 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(ParseTree parsed-anychar-bar-60) rest) = just (ParseTree parsed-anychar-bar-61 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree parsed-anychar-bar-61) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-62) rest) = just (ParseTree parsed-comment-star-62 ::' rest , 3)
len-dec-rewrite {- P186-} ((Id "P186") :: (InputChar '%') :: (ParseTree parsed-comment-star-62) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P187-} ((Id "P187") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-63 ::' rest , 2)
len-dec-rewrite {- P188-} ((Id "P188") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-63 ::' rest , 2)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-64 ::' rest , 2)
len-dec-rewrite {- P19-} ((Id "P19") :: _::_(InputChar 't') rest) = just (ParseTree parsed-alpha-range-1 ::' rest , 2)
len-dec-rewrite {- P190-} ((Id "P190") :: _::_(ParseTree parsed-aws-bar-63) rest) = just (ParseTree parsed-aws-bar-64 ::' rest , 2)
len-dec-rewrite {- P191-} ((Id "P191") :: _::_(ParseTree parsed-aws-bar-64) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-65 ::' rest , 2)
len-dec-rewrite {- P193-} ((Id "P193") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-65) rest) = just (ParseTree parsed-ws-plus-65 ::' rest , 3)
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(ParseTree parsed-ws-plus-65) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P195-} ((Id "P195") :: _::_(ParseTree parsed-numpunct) rest) = just (ParseTree parsed-anynonwschar-bar-66 ::' rest , 2)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anynonwschar-bar-66 ::' rest , 2)
len-dec-rewrite {- P197-} ((Id "P197") :: _::_(ParseTree parsed-alpha) rest) = just (ParseTree parsed-anynonwschar-bar-67 ::' rest , 2)
len-dec-rewrite {- P198-} ((Id "P198") :: _::_(ParseTree parsed-anynonwschar-bar-66) rest) = just (ParseTree parsed-anynonwschar-bar-67 ::' rest , 2)
len-dec-rewrite {- P199-} ((Id "P199") :: _::_(ParseTree parsed-anynonwschar-bar-67) rest) = just (ParseTree parsed-anynonwschar ::' rest , 2)
...
len-dec-rewrite {- P200-} ((Id "P200") :: _::_(ParseTree parsed-anynonwschar) rest) = just (ParseTree parsed-nonws-plus-68 ::' rest , 2)
len-dec-rewrite {- P201-} ((Id "P201") :: (ParseTree parsed-anynonwschar) :: _::_(ParseTree parsed-nonws-plus-68) rest) = just (ParseTree parsed-nonws-plus-68 ::' rest , 3)
len-dec-rewrite {- P202-} ((Id "P202") :: _::_(ParseTree parsed-nonws-plus-68) rest) = just (ParseTree parsed-nonws ::' rest , 2)
...
len-dec-rewrite {- P184-} (_::_(Id "P184") rest) = just (ParseTree parsed-comment-star-62 ::' rest , 1)
