...
get-ctxt-from-toplevel-state (mk-toplevel-state _ _ _ _ _ context) = context
...
normalize-tree Γ (ParseTree (parsed-term t) :: []) = "TODO someone broke normalize-tree, it needs fixed" -- to-string (hnf Γ unfold-all t tt)
normalize-tree Γ (ParseTree (parsed-type t) :: []) = "TODO someone broke normalize-tree, it needs fixed" -- to-string (hnf Γ unfold-all t tt)
...
normalize-cmd-h (str :: start-pos :: end-pos :: filename :: local-ctxt) (mk-toplevel-state _ _ _ _ _ Γ) nt =
...
normalize-cmd(text :: []) (mk-toplevel-state _ _ _ _ _ Γ) = (normalize-prompt Γ text)
