...
is-free-in-term ce x (Fold pi pi' tp t) = is-free-in-term ce x t || (ce && is-free-in-type ce x tp)
is-free-in-term ce x (Unfold pi pi' tp t) = is-free-in-term ce x t || (ce && is-free-in-type ce x tp)
