...
are-free-in-term ce x (Let _ (DefType _ x' k t) t') =
  ...
  || are-free-in-term ce (trie-remove x x') t'
are-free-in-term ce x (OpenType _ _ t) = are-free-in-term ce x t -- return the same answer as the erasure of (OpenType ...)
are-free-in-term ce x (OpenTerm pi _) = ff -- no variables occur unbound here
