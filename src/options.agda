...
data gratr2-nt : Set where
  ...
  _num : gratr2-nt
  _comment-star-29 : gratr2-nt
  _comment : gratr2-nt
  _aws-bar-32 : gratr2-nt
  _aws-bar-31 : gratr2-nt
  _aws-bar-30 : gratr2-nt
  _aws : gratr2-nt
...
gratr2-nt-eq  _ws-plus-33 _ws-plus-33 = tt
...
gratr2-nt-eq  _ows-star-34 _ows-star-34 = tt
...
options-start _ws-plus-33 = (just "P130" , nothing , just _ws-plus-33 , inj₁ _aws :: inj₁ _ws-plus-33 :: []) :: (just "P129" , nothing , just _ws-plus-33 , inj₁ _aws :: []) :: []
options-start _ws = (just "P131" , nothing , just _ws , inj₁ _ws-plus-33 :: []) :: []
...
options-start _ows-star-34 = (just "P133" , nothing , just _ows-star-34 , inj₁ _aws :: inj₁ _ows-star-34 :: []) :: (just "P132" , nothing , just _ows-star-34 , []) :: []
options-start _ows = (just "P134" , nothing , just _ows , inj₁ _ows-star-34 :: []) :: []
options-start _opts = (just "OptsNil" , nothing , just _opts , []) :: (just "OptsCons" , nothing , just _opts , inj₁ _ows :: inj₁ _opt :: inj₁ _opts :: []) :: []
options-start _opt = (just "Lib" , nothing , just _opt , inj₂ 'i' :: inj₂ 'm' :: inj₂ 'p' :: inj₂ 'o' :: inj₂ 'r' :: inj₂ 't' :: inj₂ '-' :: inj₂ 'd' :: inj₂ 'i' :: inj₂ 'r' :: inj₂ 'e' :: inj₂ 'c' :: inj₂ 't' :: inj₂ 'o' :: inj₂ 'r' :: inj₂ 'i' :: inj₂ 'e' :: inj₂ 's' :: inj₁ _paths :: inj₁ _ows :: inj₂ '.' :: []) :: []
...
options-start _comment-star-29 = (just "P120" , nothing , just _comment-star-29 , inj₁ _anychar :: inj₁ _comment-star-29 :: []) :: (just "P119" , nothing , just _comment-star-29 , []) :: []
options-start _comment = (just "P121" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-29 :: inj₂ '\n' :: []) :: []
options-start _aws-bar-32 = (just "P127" , nothing , just _aws-bar-32 , inj₁ _aws-bar-31 :: []) :: (just "P126" , nothing , just _aws-bar-32 , inj₂ '\n' :: []) :: []
options-start _aws-bar-31 = (just "P125" , nothing , just _aws-bar-31 , inj₁ _aws-bar-30 :: []) :: (just "P124" , nothing , just _aws-bar-31 , inj₂ '\t' :: []) :: []
options-start _aws-bar-30 = (just "P123" , nothing , just _aws-bar-30 , inj₁ _comment :: []) :: (just "P122" , nothing , just _aws-bar-30 , inj₂ ' ' :: []) :: []
options-start _aws = (just "P128" , nothing , just _aws , inj₁ _aws-bar-32 :: []) :: []
options-start _anychar-bar-9 = (just "P79" , nothing , just _anychar-bar-9 , inj₂ '/' :: []) :: (just "P78" , nothing , just _anychar-bar-9 , inj₂ '>' :: []) :: []
options-start _anychar-bar-28 = (just "P117" , nothing , just _anychar-bar-28 , inj₁ _anychar-bar-27 :: []) :: (just "P116" , nothing , just _anychar-bar-28 , inj₁ _alpha :: []) :: []
options-start _anychar-bar-27 = (just "P115" , nothing , just _anychar-bar-27 , inj₁ _anychar-bar-26 :: []) :: (just "P114" , nothing , just _anychar-bar-27 , inj₁ _numpunct :: []) :: []
...
options-start _anychar = (just "P118" , nothing , just _anychar , inj₁ _anychar-bar-28 :: []) :: []
...
len-dec-rewrite {- Lib-} ((Id "Lib") :: (InputChar 'i') :: (InputChar 'm') :: (InputChar 'p') :: (InputChar 'o') :: (InputChar 'r') :: (InputChar 't') :: (InputChar '-') :: (InputChar 'd') :: (InputChar 'i') :: (InputChar 'r') :: (InputChar 'e') :: (InputChar 'c') :: (InputChar 't') :: (InputChar 'o') :: (InputChar 'r') :: (InputChar 'i') :: (InputChar 'e') :: (InputChar 's') :: (ParseTree (parsed-paths x0)) :: (ParseTree parsed-ows) :: _::_(InputChar '.') rest) = just (ParseTree (parsed-opt (norm-opt (Lib x0))) ::' rest , 22)
...
len-dec-rewrite {- P114-} ((Id "P114") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree (parsed-anychar-bar-27 (string-append 0 x0)) ::' rest , 2)
...
len-dec-rewrite {- P116-} ((Id "P116") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree (parsed-anychar-bar-28 (string-append 0 x0)) ::' rest , 2)
...
len-dec-rewrite {- P118-} ((Id "P118") :: _::_(ParseTree (parsed-anychar-bar-28 x0)) rest) = just (ParseTree (parsed-anychar (string-append 0 x0)) ::' rest , 2)
...
len-dec-rewrite {- P120-} ((Id "P120") :: (ParseTree (parsed-anychar x0)) :: _::_(ParseTree parsed-comment-star-29) rest) = just (ParseTree parsed-comment-star-29 ::' rest , 3)
len-dec-rewrite {- P121-} ((Id "P121") :: (InputChar '%') :: (ParseTree parsed-comment-star-29) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P122-} ((Id "P122") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-30 ::' rest , 2)
len-dec-rewrite {- P123-} ((Id "P123") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-30 ::' rest , 2)
len-dec-rewrite {- P124-} ((Id "P124") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-31 ::' rest , 2)
len-dec-rewrite {- P125-} ((Id "P125") :: _::_(ParseTree parsed-aws-bar-30) rest) = just (ParseTree parsed-aws-bar-31 ::' rest , 2)
len-dec-rewrite {- P126-} ((Id "P126") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-32 ::' rest , 2)
len-dec-rewrite {- P127-} ((Id "P127") :: _::_(ParseTree parsed-aws-bar-31) rest) = just (ParseTree parsed-aws-bar-32 ::' rest , 2)
len-dec-rewrite {- P128-} ((Id "P128") :: _::_(ParseTree parsed-aws-bar-32) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P129-} ((Id "P129") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-33 ::' rest , 2)
...
len-dec-rewrite {- P130-} ((Id "P130") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-33) rest) = just (ParseTree parsed-ws-plus-33 ::' rest , 3)
len-dec-rewrite {- P131-} ((Id "P131") :: _::_(ParseTree parsed-ws-plus-33) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P133-} ((Id "P133") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-34) rest) = just (ParseTree parsed-ows-star-34 ::' rest , 3)
len-dec-rewrite {- P134-} ((Id "P134") :: _::_(ParseTree parsed-ows-star-34) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P79-} ((Id "P79") :: _::_(InputChar '/') rest) = just (ParseTree (parsed-anychar-bar-9 (string-append 0 (char-to-string '/'))) ::' rest , 2)
...
len-dec-rewrite {- P119-} (_::_(Id "P119") rest) = just (ParseTree parsed-comment-star-29 ::' rest , 1)
len-dec-rewrite {- P132-} (_::_(Id "P132") rest) = just (ParseTree parsed-ows-star-34 ::' rest , 1)
