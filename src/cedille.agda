...
data gratr2-nt : Set where
  ...
  _lam : gratr2-nt
  _kvar-star-19 : gratr2-nt
  _kvar-bar-18 : gratr2-nt
  _kvar : gratr2-nt
  _kind : gratr2-nt
  _indices : gratr2-nt
  _fpth-star-16 : gratr2-nt
  _fpth-bar-17 : gratr2-nt
  _fpth-bar-15 : gratr2-nt
  _fpth-bar-14 : gratr2-nt
  _fpth : gratr2-nt
  _decls : gratr2-nt
  _decl : gratr2-nt
  ...
  _aws-bar-64 : gratr2-nt
  _aws-bar-63 : gratr2-nt
  _aws : gratr2-nt
  _atype : gratr2-nt
  _aterm : gratr2-nt
...
gratr2-nt-eq  _ws-plus-66 _ws-plus-66 = tt
...
gratr2-nt-eq  _ows-star-67 _ows-star-67 = tt
...
gratr2-nt-eq  _comment-star-62 _comment-star-62 = tt
...
gratr2-nt-eq  _aws-bar-64 _aws-bar-64 = tt
gratr2-nt-eq  _aws-bar-63 _aws-bar-63 = tt
...
cedille-start _ws-plus-66 = (just "P197" , nothing , just _ws-plus-66 , inj₁ _aws :: inj₁ _ws-plus-66 :: []) :: (just "P196" , nothing , just _ws-plus-66 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P198" , nothing , just _ws , inj₁ _ws-plus-66 :: []) :: []
...
cedille-start _ows-star-67 = (just "P200" , nothing , just _ows-star-67 , inj₁ _aws :: inj₁ _ows-star-67 :: []) :: (just "P199" , nothing , just _ows-star-67 , []) :: []
cedille-start _ows = (just "P201" , nothing , just _ows , inj₁ _ows-star-67 :: []) :: []
...
cedille-start _kvar-star-19 = (just "P99" , nothing , just _kvar-star-19 , inj₁ _kvar-bar-18 :: inj₁ _kvar-star-19 :: []) :: (just "P98" , nothing , just _kvar-star-19 , []) :: []
cedille-start _kvar-bar-18 = (just "P97" , nothing , just _kvar-bar-18 , inj₁ _numpunct :: []) :: (just "P96" , nothing , just _kvar-bar-18 , inj₁ _alpha :: []) :: []
cedille-start _kvar = (just "P100" , nothing , just _kvar , inj₂ '𝒌' :: inj₁ _kvar-star-19 :: []) :: []
...
cedille-start _fpth-star-16 = (just "P92" , nothing , just _fpth-star-16 , inj₁ _fpth-bar-15 :: inj₁ _fpth-star-16 :: []) :: (just "P91" , nothing , just _fpth-star-16 , []) :: []
cedille-start _fpth-bar-17 = (just "P94" , nothing , just _fpth-bar-17 , inj₁ _alpha :: inj₁ _fpth-star-16 :: []) :: (just "P93" , nothing , just _fpth-bar-17 , inj₂ '_' :: []) :: []
cedille-start _fpth-bar-15 = (just "P90" , nothing , just _fpth-bar-15 , inj₁ _fpth-bar-14 :: []) :: (just "P89" , nothing , just _fpth-bar-15 , inj₁ _alpha :: []) :: []
cedille-start _fpth-bar-14 = (just "P88" , nothing , just _fpth-bar-14 , inj₂ '/' :: []) :: (just "P87" , nothing , just _fpth-bar-14 , inj₁ _numpunct :: []) :: []
cedille-start _fpth = (just "P95" , nothing , just _fpth , inj₁ _fpth-bar-17 :: []) :: []
...
cedille-start _comment-star-62 = (just "P187" , nothing , just _comment-star-62 , inj₁ _anychar :: inj₁ _comment-star-62 :: []) :: (just "P186" , nothing , just _comment-star-62 , []) :: []
cedille-start _comment = (just "P188" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-62 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-65 = (just "P194" , nothing , just _aws-bar-65 , inj₁ _aws-bar-64 :: []) :: (just "P193" , nothing , just _aws-bar-65 , inj₂ '\n' :: []) :: []
cedille-start _aws-bar-64 = (just "P192" , nothing , just _aws-bar-64 , inj₁ _aws-bar-63 :: []) :: (just "P191" , nothing , just _aws-bar-64 , inj₂ '\t' :: []) :: []
cedille-start _aws-bar-63 = (just "P190" , nothing , just _aws-bar-63 , inj₁ _comment :: []) :: (just "P189" , nothing , just _aws-bar-63 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P195" , nothing , just _aws , inj₁ _aws-bar-65 :: []) :: []
...
cedille-start _anychar-bar-61 = (just "P184" , nothing , just _anychar-bar-61 , inj₁ _anychar-bar-60 :: []) :: (just "P183" , nothing , just _anychar-bar-61 , inj₁ _alpha :: []) :: []
cedille-start _anychar-bar-60 = (just "P182" , nothing , just _anychar-bar-60 , inj₁ _anychar-bar-59 :: []) :: (just "P181" , nothing , just _anychar-bar-60 , inj₁ _numpunct :: []) :: []
...
cedille-start _anychar-bar-54 = (just "P170" , nothing , just _anychar-bar-54 , inj₁ _anychar-bar-53 :: []) :: (just "P169" , nothing , just _anychar-bar-54 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-53 = (just "P168" , nothing , just _anychar-bar-53 , inj₁ _anychar-bar-52 :: []) :: (just "P167" , nothing , just _anychar-bar-53 , inj₂ 'λ' :: []) :: []
...
cedille-start _anychar-bar-51 = (just "P164" , nothing , just _anychar-bar-51 , inj₁ _anychar-bar-50 :: []) :: (just "P163" , nothing , just _anychar-bar-51 , inj₂ 'π' :: []) :: []
...
cedille-start _anychar-bar-31 = (just "P124" , nothing , just _anychar-bar-31 , inj₁ _anychar-bar-30 :: []) :: (just "P123" , nothing , just _anychar-bar-31 , inj₂ 'Λ' :: []) :: []
cedille-start _anychar-bar-30 = (just "P122" , nothing , just _anychar-bar-30 , inj₁ _anychar-bar-29 :: []) :: (just "P121" , nothing , just _anychar-bar-30 , inj₂ 'ρ' :: []) :: []
cedille-start _anychar-bar-29 = (just "P120" , nothing , just _anychar-bar-29 , inj₁ _anychar-bar-28 :: []) :: (just "P119" , nothing , just _anychar-bar-29 , inj₂ 'ε' :: []) :: []
...
cedille-start _anychar-bar-27 = (just "P116" , nothing , just _anychar-bar-27 , inj₁ _anychar-bar-26 :: []) :: (just "P115" , nothing , just _anychar-bar-27 , inj₂ '𝒌' :: []) :: []
...
cedille-start _anychar-bar-25 = (just "P112" , nothing , just _anychar-bar-25 , inj₁ _anychar-bar-24 :: []) :: (just "P111" , nothing , just _anychar-bar-25 , inj₂ 'ς' :: []) :: []
cedille-start _anychar-bar-24 = (just "P110" , nothing , just _anychar-bar-24 , inj₁ _anychar-bar-23 :: []) :: (just "P109" , nothing , just _anychar-bar-24 , inj₂ 'θ' :: []) :: []
...
cedille-start _anychar-bar-21 = (just "P104" , nothing , just _anychar-bar-21 , inj₁ _anychar-bar-20 :: []) :: (just "P103" , nothing , just _anychar-bar-21 , inj₂ '>' :: []) :: []
cedille-start _anychar-bar-20 = (just "P102" , nothing , just _anychar-bar-20 , inj₂ '\"' :: []) :: (just "P101" , nothing , just _anychar-bar-20 , inj₂ '≃' :: []) :: []
cedille-start _anychar = (just "P185" , nothing , just _anychar , inj₁ _anychar-bar-61 :: []) :: []
...
len-dec-rewrite {- P100-} ((Id "P100") :: (InputChar '𝒌') :: _::_(ParseTree (parsed-kvar-star-19 x0)) rest) = just (ParseTree (parsed-kvar (string-append 1 (char-to-string '𝒌') x0)) ::' rest , 3)
len-dec-rewrite {- P101-} ((Id "P101") :: _::_(InputChar '≃') rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P102-} ((Id "P102") :: _::_(InputChar '\"') rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P103-} ((Id "P103") :: _::_(InputChar '>') rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(ParseTree parsed-anychar-bar-20) rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
...
len-dec-rewrite {- P109-} ((Id "P109") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-anychar-bar-24 ::' rest , 2)
...
len-dec-rewrite {- P111-} ((Id "P111") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-anychar-bar-25 ::' rest , 2)
...
len-dec-rewrite {- P115-} ((Id "P115") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-27 ::' rest , 2)
...
len-dec-rewrite {- P119-} ((Id "P119") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-anychar-bar-29 ::' rest , 2)
...
len-dec-rewrite {- P121-} ((Id "P121") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-anychar-bar-30 ::' rest , 2)
len-dec-rewrite {- P122-} ((Id "P122") :: _::_(ParseTree parsed-anychar-bar-29) rest) = just (ParseTree parsed-anychar-bar-30 ::' rest , 2)
len-dec-rewrite {- P123-} ((Id "P123") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-anychar-bar-31 ::' rest , 2)
...
len-dec-rewrite {- P163-} ((Id "P163") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-anychar-bar-51 ::' rest , 2)
...
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(ParseTree parsed-anychar-bar-52) rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P169-} ((Id "P169") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
...
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree parsed-anychar-bar-60 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(ParseTree parsed-anychar-bar-59) rest) = just (ParseTree parsed-anychar-bar-60 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree parsed-anychar-bar-61 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(ParseTree parsed-anychar-bar-60) rest) = just (ParseTree parsed-anychar-bar-61 ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree parsed-anychar-bar-61) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-62) rest) = just (ParseTree parsed-comment-star-62 ::' rest , 3)
len-dec-rewrite {- P188-} ((Id "P188") :: (InputChar '%') :: (ParseTree parsed-comment-star-62) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-63 ::' rest , 2)
...
len-dec-rewrite {- P190-} ((Id "P190") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-63 ::' rest , 2)
len-dec-rewrite {- P191-} ((Id "P191") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-64 ::' rest , 2)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-aws-bar-63) rest) = just (ParseTree parsed-aws-bar-64 ::' rest , 2)
len-dec-rewrite {- P193-} ((Id "P193") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-65 ::' rest , 2)
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(ParseTree parsed-aws-bar-64) rest) = just (ParseTree parsed-aws-bar-65 ::' rest , 2)
len-dec-rewrite {- P195-} ((Id "P195") :: _::_(ParseTree parsed-aws-bar-65) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-66 ::' rest , 2)
len-dec-rewrite {- P197-} ((Id "P197") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-66) rest) = just (ParseTree parsed-ws-plus-66 ::' rest , 3)
len-dec-rewrite {- P198-} ((Id "P198") :: _::_(ParseTree parsed-ws-plus-66) rest) = just (ParseTree parsed-ws ::' rest , 2)
...
len-dec-rewrite {- P200-} ((Id "P200") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-67) rest) = just (ParseTree parsed-ows-star-67 ::' rest , 3)
len-dec-rewrite {- P201-} ((Id "P201") :: _::_(ParseTree parsed-ows-star-67) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P87-} ((Id "P87") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree (parsed-fpth-bar-14 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P88-} ((Id "P88") :: _::_(InputChar '/') rest) = just (ParseTree (parsed-fpth-bar-14 (string-append 0 (char-to-string '/'))) ::' rest , 2)
...
len-dec-rewrite {- P90-} ((Id "P90") :: _::_(ParseTree (parsed-fpth-bar-14 x0)) rest) = just (ParseTree (parsed-fpth-bar-15 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P92-} ((Id "P92") :: (ParseTree (parsed-fpth-bar-15 x0)) :: _::_(ParseTree (parsed-fpth-star-16 x1)) rest) = just (ParseTree (parsed-fpth-star-16 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P93-} ((Id "P93") :: _::_(InputChar '_') rest) = just (ParseTree (parsed-fpth-bar-17 (string-append 0 (char-to-string '_'))) ::' rest , 2)
len-dec-rewrite {- P94-} ((Id "P94") :: (ParseTree (parsed-alpha x0)) :: _::_(ParseTree (parsed-fpth-star-16 x1)) rest) = just (ParseTree (parsed-fpth-bar-17 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P95-} ((Id "P95") :: _::_(ParseTree (parsed-fpth-bar-17 x0)) rest) = just (ParseTree (parsed-fpth (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P96-} ((Id "P96") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree (parsed-kvar-bar-18 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P97-} ((Id "P97") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree (parsed-kvar-bar-18 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P99-} ((Id "P99") :: (ParseTree (parsed-kvar-bar-18 x0)) :: _::_(ParseTree (parsed-kvar-star-19 x1)) rest) = just (ParseTree (parsed-kvar-star-19 (string-append 1 x0 x1)) ::' rest , 3)
...
len-dec-rewrite {- P186-} (_::_(Id "P186") rest) = just (ParseTree parsed-comment-star-62 ::' rest , 1)
len-dec-rewrite {- P199-} (_::_(Id "P199") rest) = just (ParseTree parsed-ows-star-67 ::' rest , 1)
len-dec-rewrite {- P82-} (_::_(Id "P82") rest) = just (ParseTree (parsed-var-star-12 empty-string) ::' rest , 1)
len-dec-rewrite {- P91-} (_::_(Id "P91") rest) = just (ParseTree (parsed-fpth-star-16 empty-string) ::' rest , 1)
len-dec-rewrite {- P98-} (_::_(Id "P98") rest) = just (ParseTree (parsed-kvar-star-19 empty-string) ::' rest , 1)
