...
gratr2-nt-eq  _ws-plus-58 _ws-plus-58 = tt
...
gratr2-nt-eq  _ows-star-59 _ows-star-59 = tt
...
gratr2-nt-eq  _comment-star-54 _comment-star-54 = tt
...
cedille-start _ws-plus-58 = (just "P180" , nothing , just _ws-plus-58 , inj₁ _aws :: inj₁ _ws-plus-58 :: []) :: (just "P179" , nothing , just _ws-plus-58 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P181" , nothing , just _ws , inj₁ _ws-plus-58 :: []) :: []
...
cedille-start _ows-star-59 = (just "P183" , nothing , just _ows-star-59 , inj₁ _aws :: inj₁ _ows-star-59 :: []) :: (just "P182" , nothing , just _ows-star-59 , []) :: []
cedille-start _ows = (just "P184" , nothing , just _ows , inj₁ _ows-star-59 :: []) :: []
...
cedille-start _comment-star-54 = (just "P170" , nothing , just _comment-star-54 , inj₁ _anychar :: inj₁ _comment-star-54 :: []) :: (just "P169" , nothing , just _comment-star-54 , []) :: []
cedille-start _comment = (just "P171" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-54 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-57 = (just "P177" , nothing , just _aws-bar-57 , inj₁ _aws-bar-56 :: []) :: (just "P176" , nothing , just _aws-bar-57 , inj₂ '\n' :: []) :: []
cedille-start _aws-bar-56 = (just "P175" , nothing , just _aws-bar-56 , inj₁ _aws-bar-55 :: []) :: (just "P174" , nothing , just _aws-bar-56 , inj₂ '\t' :: []) :: []
cedille-start _aws-bar-55 = (just "P173" , nothing , just _aws-bar-55 , inj₁ _comment :: []) :: (just "P172" , nothing , just _aws-bar-55 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P178" , nothing , just _aws , inj₁ _aws-bar-57 :: []) :: []
...
cedille-start _anychar-bar-53 = (just "P167" , nothing , just _anychar-bar-53 , inj₁ _anychar-bar-52 :: []) :: (just "P166" , nothing , just _anychar-bar-53 , inj₁ _alpha :: []) :: []
cedille-start _anychar-bar-52 = (just "P165" , nothing , just _anychar-bar-52 , inj₁ _anychar-bar-51 :: []) :: (just "P164" , nothing , just _anychar-bar-52 , inj₁ _numpunct :: []) :: []
...
cedille-start _anychar-bar-46 = (just "P153" , nothing , just _anychar-bar-46 , inj₁ _anychar-bar-45 :: []) :: (just "P152" , nothing , just _anychar-bar-46 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-45 = (just "P151" , nothing , just _anychar-bar-45 , inj₁ _anychar-bar-44 :: []) :: (just "P150" , nothing , just _anychar-bar-45 , inj₂ 'λ' :: []) :: []
...
cedille-start _anychar-bar-43 = (just "P147" , nothing , just _anychar-bar-43 , inj₁ _anychar-bar-42 :: []) :: (just "P146" , nothing , just _anychar-bar-43 , inj₂ 'π' :: []) :: []
...
cedille-start _anychar-bar-23 = (just "P107" , nothing , just _anychar-bar-23 , inj₁ _anychar-bar-22 :: []) :: (just "P106" , nothing , just _anychar-bar-23 , inj₂ 'Λ' :: []) :: []
cedille-start _anychar-bar-22 = (just "P105" , nothing , just _anychar-bar-22 , inj₁ _anychar-bar-21 :: []) :: (just "P104" , nothing , just _anychar-bar-22 , inj₂ 'ρ' :: []) :: []
cedille-start _anychar-bar-21 = (just "P103" , nothing , just _anychar-bar-21 , inj₁ _anychar-bar-20 :: []) :: (just "P102" , nothing , just _anychar-bar-21 , inj₂ 'ε' :: []) :: []
...
cedille-start _anychar-bar-19 = (just "P99" , nothing , just _anychar-bar-19 , inj₁ _anychar-bar-18 :: []) :: (just "P98" , nothing , just _anychar-bar-19 , inj₂ '𝒌' :: []) :: []
...
cedille-start _anychar-bar-17 = (just "P95" , nothing , just _anychar-bar-17 , inj₁ _anychar-bar-16 :: []) :: (just "P94" , nothing , just _anychar-bar-17 , inj₂ 'ς' :: []) :: []
cedille-start _anychar-bar-16 = (just "P93" , nothing , just _anychar-bar-16 , inj₁ _anychar-bar-15 :: []) :: (just "P92" , nothing , just _anychar-bar-16 , inj₂ 'θ' :: []) :: []
...
cedille-start _anychar = (just "P168" , nothing , just _anychar , inj₁ _anychar-bar-53 :: []) :: []
...
len-dec-rewrite {- P102-} ((Id "P102") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P103-} ((Id "P103") :: _::_(ParseTree parsed-anychar-bar-20) rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(ParseTree parsed-anychar-bar-21) rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-anychar-bar-23 ::' rest , 2)
...
len-dec-rewrite {- P146-} ((Id "P146") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-anychar-bar-43 ::' rest , 2)
...
len-dec-rewrite {- P150-} ((Id "P150") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-45 ::' rest , 2)
len-dec-rewrite {- P151-} ((Id "P151") :: _::_(ParseTree parsed-anychar-bar-44) rest) = just (ParseTree parsed-anychar-bar-45 ::' rest , 2)
len-dec-rewrite {- P152-} ((Id "P152") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-46 ::' rest , 2)
...
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree parsed-anychar-bar-52 ::' rest , 2)
len-dec-rewrite {- P165-} ((Id "P165") :: _::_(ParseTree parsed-anychar-bar-51) rest) = just (ParseTree parsed-anychar-bar-52 ::' rest , 2)
len-dec-rewrite {- P166-} ((Id "P166") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(ParseTree parsed-anychar-bar-52) rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(ParseTree parsed-anychar-bar-53) rest) = just (ParseTree parsed-anychar ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-54) rest) = just (ParseTree parsed-comment-star-54 ::' rest , 3)
len-dec-rewrite {- P171-} ((Id "P171") :: (InputChar '%') :: (ParseTree parsed-comment-star-54) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-55 ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-55 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-56 ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(ParseTree parsed-aws-bar-55) rest) = just (ParseTree parsed-aws-bar-56 ::' rest , 2)
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-57 ::' rest , 2)
len-dec-rewrite {- P177-} ((Id "P177") :: _::_(ParseTree parsed-aws-bar-56) rest) = just (ParseTree parsed-aws-bar-57 ::' rest , 2)
len-dec-rewrite {- P178-} ((Id "P178") :: _::_(ParseTree parsed-aws-bar-57) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P179-} ((Id "P179") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-58 ::' rest , 2)
...
len-dec-rewrite {- P180-} ((Id "P180") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-58) rest) = just (ParseTree parsed-ws-plus-58 ::' rest , 3)
...
len-dec-rewrite {- P92-} ((Id "P92") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-anychar-bar-16 ::' rest , 2)
len-dec-rewrite {- P93-} ((Id "P93") :: _::_(ParseTree parsed-anychar-bar-15) rest) = just (ParseTree parsed-anychar-bar-16 ::' rest , 2)
len-dec-rewrite {- P94-} ((Id "P94") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-anychar-bar-17 ::' rest , 2)
...
len-dec-rewrite {- P98-} ((Id "P98") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-19 ::' rest , 2)
