...
gratr2-nt-eq  _ows-star-68 _ows-star-68 = tt
...
gratr2-nt-eq  _comment-star-63 _comment-star-63 = tt
...
cedille-start _ws-plus-67 = (just "P199" , nothing , just _ws-plus-67 , inj₁ _aws :: inj₁ _ws-plus-67 :: []) :: (just "P198" , nothing , just _ws-plus-67 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P200" , nothing , just _ws , inj₁ _ws-plus-67 :: []) :: []
...
cedille-start _ows-star-68 = (just "P202" , nothing , just _ows-star-68 , inj₁ _aws :: inj₁ _ows-star-68 :: []) :: (just "P201" , nothing , just _ows-star-68 , []) :: []
cedille-start _ows = (just "P203" , nothing , just _ows , inj₁ _ows-star-68 :: []) :: []
...
cedille-start _comment-star-63 = (just "P189" , nothing , just _comment-star-63 , inj₁ _anychar :: inj₁ _comment-star-63 :: []) :: (just "P188" , nothing , just _comment-star-63 , []) :: []
cedille-start _comment = (just "P190" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-63 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-64 = (just "P192" , nothing , just _aws-bar-64 , inj₁ _comment :: []) :: (just "P191" , nothing , just _aws-bar-64 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P197" , nothing , just _aws , inj₁ _aws-bar-66 :: []) :: []
...
cedille-start _anychar-bar-62 = (just "P186" , nothing , just _anychar-bar-62 , inj₁ _anychar-bar-61 :: []) :: (just "P185" , nothing , just _anychar-bar-62 , inj₁ _alpha :: []) :: []
cedille-start _anychar-bar-61 = (just "P184" , nothing , just _anychar-bar-61 , inj₁ _anychar-bar-60 :: []) :: (just "P183" , nothing , just _anychar-bar-61 , inj₁ _numpunct :: []) :: []
...
cedille-start _anychar-bar-55 = (just "P172" , nothing , just _anychar-bar-55 , inj₁ _anychar-bar-54 :: []) :: (just "P171" , nothing , just _anychar-bar-55 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-54 = (just "P170" , nothing , just _anychar-bar-54 , inj₁ _anychar-bar-53 :: []) :: (just "P169" , nothing , just _anychar-bar-54 , inj₂ 'λ' :: []) :: []
...
cedille-start _anychar-bar-52 = (just "P166" , nothing , just _anychar-bar-52 , inj₁ _anychar-bar-51 :: []) :: (just "P165" , nothing , just _anychar-bar-52 , inj₂ 'π' :: []) :: []
...
cedille-start _anychar-bar-32 = (just "P126" , nothing , just _anychar-bar-32 , inj₁ _anychar-bar-31 :: []) :: (just "P125" , nothing , just _anychar-bar-32 , inj₂ 'Λ' :: []) :: []
cedille-start _anychar-bar-31 = (just "P124" , nothing , just _anychar-bar-31 , inj₁ _anychar-bar-30 :: []) :: (just "P123" , nothing , just _anychar-bar-31 , inj₂ 'ρ' :: []) :: []
cedille-start _anychar-bar-30 = (just "P122" , nothing , just _anychar-bar-30 , inj₁ _anychar-bar-29 :: []) :: (just "P121" , nothing , just _anychar-bar-30 , inj₂ 'ε' :: []) :: []
...
cedille-start _anychar = (just "P187" , nothing , just _anychar , inj₁ _anychar-bar-62 :: []) :: []
...
len-dec-rewrite {- P121-} ((Id "P121") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-anychar-bar-30 ::' rest , 2)
len-dec-rewrite {- P122-} ((Id "P122") :: _::_(ParseTree parsed-anychar-bar-29) rest) = just (ParseTree parsed-anychar-bar-30 ::' rest , 2)
len-dec-rewrite {- P123-} ((Id "P123") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-anychar-bar-31 ::' rest , 2)
len-dec-rewrite {- P124-} ((Id "P124") :: _::_(ParseTree parsed-anychar-bar-30) rest) = just (ParseTree parsed-anychar-bar-31 ::' rest , 2)
len-dec-rewrite {- P125-} ((Id "P125") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-anychar-bar-32 ::' rest , 2)
...
len-dec-rewrite {- P165-} ((Id "P165") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-anychar-bar-52 ::' rest , 2)
...
len-dec-rewrite {- P169-} ((Id "P169") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-54 ::' rest , 2)
...
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
...
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree parsed-anychar-bar-61 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(ParseTree parsed-anychar-bar-60) rest) = just (ParseTree parsed-anychar-bar-61 ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree parsed-anychar-bar-62 ::' rest , 2)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(ParseTree parsed-anychar-bar-61) rest) = just (ParseTree parsed-anychar-bar-62 ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: _::_(ParseTree parsed-anychar-bar-62) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P189-} ((Id "P189") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-63) rest) = just (ParseTree parsed-comment-star-63 ::' rest , 3)
...
len-dec-rewrite {- P190-} ((Id "P190") :: (InputChar '%') :: (ParseTree parsed-comment-star-63) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P191-} ((Id "P191") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-64 ::' rest , 2)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-64 ::' rest , 2)
...
len-dec-rewrite {- P195-} ((Id "P195") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-66 ::' rest , 2)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(ParseTree parsed-aws-bar-65) rest) = just (ParseTree parsed-aws-bar-66 ::' rest , 2)
len-dec-rewrite {- P197-} ((Id "P197") :: _::_(ParseTree parsed-aws-bar-66) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P198-} ((Id "P198") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-67 ::' rest , 2)
len-dec-rewrite {- P199-} ((Id "P199") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-67) rest) = just (ParseTree parsed-ws-plus-67 ::' rest , 3)
...
len-dec-rewrite {- P200-} ((Id "P200") :: _::_(ParseTree parsed-ws-plus-67) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P202-} ((Id "P202") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-68) rest) = just (ParseTree parsed-ows-star-68 ::' rest , 3)
len-dec-rewrite {- P203-} ((Id "P203") :: _::_(ParseTree parsed-ows-star-68) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P188-} (_::_(Id "P188") rest) = just (ParseTree parsed-comment-star-63 ::' rest , 1)
len-dec-rewrite {- P201-} (_::_(Id "P201") rest) = just (ParseTree parsed-ows-star-68 ::' rest , 1)
