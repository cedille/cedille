...
gratr2-nt-eq  _ws-plus-61 _ws-plus-61 = tt
...
gratr2-nt-eq  _ows-star-62 _ows-star-62 = tt
...
gratr2-nt-eq  _comment-star-57 _comment-star-57 = tt
...
cedille-start _ws-plus-61 = (just "P186" , nothing , just _ws-plus-61 , inj₁ _aws :: inj₁ _ws-plus-61 :: []) :: (just "P185" , nothing , just _ws-plus-61 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P187" , nothing , just _ws , inj₁ _ws-plus-61 :: []) :: []
...
cedille-start _ows-star-62 = (just "P189" , nothing , just _ows-star-62 , inj₁ _aws :: inj₁ _ows-star-62 :: []) :: (just "P188" , nothing , just _ows-star-62 , []) :: []
cedille-start _ows = (just "P190" , nothing , just _ows , inj₁ _ows-star-62 :: []) :: []
...
cedille-start _comment-star-57 = (just "P176" , nothing , just _comment-star-57 , inj₁ _anychar :: inj₁ _comment-star-57 :: []) :: (just "P175" , nothing , just _comment-star-57 , []) :: []
cedille-start _comment = (just "P177" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-57 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-58 = (just "P179" , nothing , just _aws-bar-58 , inj₁ _comment :: []) :: (just "P178" , nothing , just _aws-bar-58 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P184" , nothing , just _aws , inj₁ _aws-bar-60 :: []) :: []
...
cedille-start _anychar-bar-56 = (just "P173" , nothing , just _anychar-bar-56 , inj₁ _anychar-bar-55 :: []) :: (just "P172" , nothing , just _anychar-bar-56 , inj₁ _alpha :: []) :: []
cedille-start _anychar-bar-55 = (just "P171" , nothing , just _anychar-bar-55 , inj₁ _anychar-bar-54 :: []) :: (just "P170" , nothing , just _anychar-bar-55 , inj₁ _numpunct :: []) :: []
...
cedille-start _anychar-bar-50 = (just "P161" , nothing , just _anychar-bar-50 , inj₁ _anychar-bar-49 :: []) :: (just "P160" , nothing , just _anychar-bar-50 , inj₂ 'Π' :: []) :: []
cedille-start _anychar-bar-49 = (just "P159" , nothing , just _anychar-bar-49 , inj₁ _anychar-bar-48 :: []) :: (just "P158" , nothing , just _anychar-bar-49 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-48 = (just "P157" , nothing , just _anychar-bar-48 , inj₁ _anychar-bar-47 :: []) :: (just "P156" , nothing , just _anychar-bar-48 , inj₂ 'λ' :: []) :: []
...
cedille-start _anychar-bar-26 = (just "P113" , nothing , just _anychar-bar-26 , inj₁ _anychar-bar-25 :: []) :: (just "P112" , nothing , just _anychar-bar-26 , inj₂ 'Λ' :: []) :: []
cedille-start _anychar-bar-25 = (just "P111" , nothing , just _anychar-bar-25 , inj₁ _anychar-bar-24 :: []) :: (just "P110" , nothing , just _anychar-bar-25 , inj₂ 'ρ' :: []) :: []
cedille-start _anychar-bar-24 = (just "P109" , nothing , just _anychar-bar-24 , inj₁ _anychar-bar-23 :: []) :: (just "P108" , nothing , just _anychar-bar-24 , inj₂ 'ε' :: []) :: []
...
cedille-start _anychar-bar-22 = (just "P105" , nothing , just _anychar-bar-22 , inj₁ _anychar-bar-21 :: []) :: (just "P104" , nothing , just _anychar-bar-22 , inj₂ '𝒌' :: []) :: []
...
cedille-start _anychar-bar-20 = (just "P101" , nothing , just _anychar-bar-20 , inj₁ _anychar-bar-19 :: []) :: (just "P100" , nothing , just _anychar-bar-20 , inj₂ 'ς' :: []) :: []
cedille-start _anychar-bar-19 = (just "P99" , nothing , just _anychar-bar-19 , inj₁ _anychar-bar-18 :: []) :: (just "P98" , nothing , just _anychar-bar-19 , inj₂ 'θ' :: []) :: []
...
cedille-start _anychar = (just "P174" , nothing , just _anychar , inj₁ _anychar-bar-56 :: []) :: []
...
len-dec-rewrite {- P100-} ((Id "P100") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
...
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
...
len-dec-rewrite {- P108-} ((Id "P108") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-anychar-bar-24 ::' rest , 2)
...
len-dec-rewrite {- P110-} ((Id "P110") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-anychar-bar-25 ::' rest , 2)
len-dec-rewrite {- P111-} ((Id "P111") :: _::_(ParseTree parsed-anychar-bar-24) rest) = just (ParseTree parsed-anychar-bar-25 ::' rest , 2)
len-dec-rewrite {- P112-} ((Id "P112") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-anychar-bar-26 ::' rest , 2)
...
len-dec-rewrite {- P156-} ((Id "P156") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-48 ::' rest , 2)
len-dec-rewrite {- P157-} ((Id "P157") :: _::_(ParseTree parsed-anychar-bar-47) rest) = just (ParseTree parsed-anychar-bar-48 ::' rest , 2)
len-dec-rewrite {- P158-} ((Id "P158") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-49 ::' rest , 2)
...
len-dec-rewrite {- P160-} ((Id "P160") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-anychar-bar-50 ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(ParseTree parsed-anychar-bar-54) rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(ParseTree parsed-anychar-bar-55) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree parsed-anychar-bar-56) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P176-} ((Id "P176") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-57) rest) = just (ParseTree parsed-comment-star-57 ::' rest , 3)
len-dec-rewrite {- P177-} ((Id "P177") :: (InputChar '%') :: (ParseTree parsed-comment-star-57) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P178-} ((Id "P178") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-58 ::' rest , 2)
len-dec-rewrite {- P179-} ((Id "P179") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-58 ::' rest , 2)
...
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-60 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree parsed-aws-bar-59) rest) = just (ParseTree parsed-aws-bar-60 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(ParseTree parsed-aws-bar-60) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-61 ::' rest , 2)
len-dec-rewrite {- P186-} ((Id "P186") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-61) rest) = just (ParseTree parsed-ws-plus-61 ::' rest , 3)
len-dec-rewrite {- P187-} ((Id "P187") :: _::_(ParseTree parsed-ws-plus-61) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P189-} ((Id "P189") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-62) rest) = just (ParseTree parsed-ows-star-62 ::' rest , 3)
...
len-dec-rewrite {- P190-} ((Id "P190") :: _::_(ParseTree parsed-ows-star-62) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P98-} ((Id "P98") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-anychar-bar-19 ::' rest , 2)
...
len-dec-rewrite {- P175-} (_::_(Id "P175") rest) = just (ParseTree parsed-comment-star-57 ::' rest , 1)
len-dec-rewrite {- P188-} (_::_(Id "P188") rest) = just (ParseTree parsed-ows-star-62 ::' rest , 1)
