...
data gratr2-nt : Set where
  ...
  _lam : gratr2-nt
  _kvar-star-21 : gratr2-nt
  _kvar-bar-20 : gratr2-nt
  _kvar : gratr2-nt
  _kind : gratr2-nt
  _indices : gratr2-nt
  _fpth-star-18 : gratr2-nt
  _fpth-plus-14 : gratr2-nt
  _fpth-bar-19 : gratr2-nt
...
gratr2-nt-eq  _ws-plus-68 _ws-plus-68 = tt
...
gratr2-nt-eq  _ows-star-69 _ows-star-69 = tt
...
gratr2-nt-eq  _kvar-star-21 _kvar-star-21 = tt
gratr2-nt-eq  _kvar-bar-20 _kvar-bar-20 = tt
...
gratr2-nt-eq  _fpth-bar-19 _fpth-bar-19 = tt
...
cedille-start _ws-plus-68 = (just "P201" , nothing , just _ws-plus-68 , inj₁ _aws :: inj₁ _ws-plus-68 :: []) :: (just "P200" , nothing , just _ws-plus-68 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P202" , nothing , just _ws , inj₁ _ws-plus-68 :: []) :: []
...
cedille-start _ows-star-69 = (just "P204" , nothing , just _ows-star-69 , inj₁ _aws :: inj₁ _ows-star-69 :: []) :: (just "P203" , nothing , just _ows-star-69 , []) :: []
cedille-start _ows = (just "P205" , nothing , just _ows , inj₁ _ows-star-69 :: []) :: []
...
cedille-start _kvar-star-21 = (just "P103" , nothing , just _kvar-star-21 , inj₁ _kvar-bar-20 :: inj₁ _kvar-star-21 :: []) :: (just "P102" , nothing , just _kvar-star-21 , []) :: []
cedille-start _kvar-bar-20 = (just "P101" , nothing , just _kvar-bar-20 , inj₁ _numpunct :: []) :: (just "P100" , nothing , just _kvar-bar-20 , inj₁ _alpha :: []) :: []
cedille-start _kvar = (just "P104" , nothing , just _kvar , inj₂ '𝒌' :: inj₁ _kvar-star-21 :: []) :: []
...
cedille-start _fpth-bar-19 = (just "P98" , nothing , just _fpth-bar-19 , inj₁ _fpth-bar-15 :: inj₁ _fpth-star-18 :: []) :: (just "P97" , nothing , just _fpth-bar-19 , inj₂ '_' :: []) :: []
...
cedille-start _fpth = (just "P99" , nothing , just _fpth , inj₁ _fpth-bar-19 :: []) :: []
...
cedille-start _comment-star-64 = (just "P191" , nothing , just _comment-star-64 , inj₁ _anychar :: inj₁ _comment-star-64 :: []) :: (just "P190" , nothing , just _comment-star-64 , []) :: []
cedille-start _comment = (just "P192" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-64 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-67 = (just "P198" , nothing , just _aws-bar-67 , inj₁ _aws-bar-66 :: []) :: (just "P197" , nothing , just _aws-bar-67 , inj₂ '\n' :: []) :: []
cedille-start _aws-bar-66 = (just "P196" , nothing , just _aws-bar-66 , inj₁ _aws-bar-65 :: []) :: (just "P195" , nothing , just _aws-bar-66 , inj₂ '\t' :: []) :: []
cedille-start _aws-bar-65 = (just "P194" , nothing , just _aws-bar-65 , inj₁ _comment :: []) :: (just "P193" , nothing , just _aws-bar-65 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P199" , nothing , just _aws , inj₁ _aws-bar-67 :: []) :: []
...
cedille-start _anychar-bar-63 = (just "P188" , nothing , just _anychar-bar-63 , inj₁ _anychar-bar-62 :: []) :: (just "P187" , nothing , just _anychar-bar-63 , inj₁ _alpha :: []) :: []
cedille-start _anychar-bar-62 = (just "P186" , nothing , just _anychar-bar-62 , inj₁ _anychar-bar-61 :: []) :: (just "P185" , nothing , just _anychar-bar-62 , inj₁ _numpunct :: []) :: []
...
cedille-start _anychar-bar-58 = (just "P178" , nothing , just _anychar-bar-58 , inj₁ _anychar-bar-57 :: []) :: (just "P177" , nothing , just _anychar-bar-58 , inj₂ '□' :: []) :: []
cedille-start _anychar-bar-57 = (just "P176" , nothing , just _anychar-bar-57 , inj₁ _anychar-bar-56 :: []) :: (just "P175" , nothing , just _anychar-bar-57 , inj₂ 'Π' :: []) :: []
cedille-start _anychar-bar-56 = (just "P174" , nothing , just _anychar-bar-56 , inj₁ _anychar-bar-55 :: []) :: (just "P173" , nothing , just _anychar-bar-56 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-55 = (just "P172" , nothing , just _anychar-bar-55 , inj₁ _anychar-bar-54 :: []) :: (just "P171" , nothing , just _anychar-bar-55 , inj₂ 'λ' :: []) :: []
...
cedille-start _anychar-bar-53 = (just "P168" , nothing , just _anychar-bar-53 , inj₁ _anychar-bar-52 :: []) :: (just "P167" , nothing , just _anychar-bar-53 , inj₂ 'π' :: []) :: []
...
cedille-start _anychar-bar-35 = (just "P132" , nothing , just _anychar-bar-35 , inj₁ _anychar-bar-34 :: []) :: (just "P131" , nothing , just _anychar-bar-35 , inj₂ '⇒' :: []) :: []
cedille-start _anychar-bar-34 = (just "P130" , nothing , just _anychar-bar-34 , inj₁ _anychar-bar-33 :: []) :: (just "P129" , nothing , just _anychar-bar-34 , inj₂ '?' :: []) :: []
cedille-start _anychar-bar-33 = (just "P128" , nothing , just _anychar-bar-33 , inj₁ _anychar-bar-32 :: []) :: (just "P127" , nothing , just _anychar-bar-33 , inj₂ 'Λ' :: []) :: []
cedille-start _anychar-bar-32 = (just "P126" , nothing , just _anychar-bar-32 , inj₁ _anychar-bar-31 :: []) :: (just "P125" , nothing , just _anychar-bar-32 , inj₂ 'ρ' :: []) :: []
cedille-start _anychar-bar-31 = (just "P124" , nothing , just _anychar-bar-31 , inj₁ _anychar-bar-30 :: []) :: (just "P123" , nothing , just _anychar-bar-31 , inj₂ 'ε' :: []) :: []
...
cedille-start _anychar-bar-29 = (just "P120" , nothing , just _anychar-bar-29 , inj₁ _anychar-bar-28 :: []) :: (just "P119" , nothing , just _anychar-bar-29 , inj₂ '𝒌' :: []) :: []
...
cedille-start _anychar-bar-27 = (just "P116" , nothing , just _anychar-bar-27 , inj₁ _anychar-bar-26 :: []) :: (just "P115" , nothing , just _anychar-bar-27 , inj₂ 'ς' :: []) :: []
cedille-start _anychar-bar-26 = (just "P114" , nothing , just _anychar-bar-26 , inj₁ _anychar-bar-25 :: []) :: (just "P113" , nothing , just _anychar-bar-26 , inj₂ 'θ' :: []) :: []
...
cedille-start _anychar-bar-22 = (just "P106" , nothing , just _anychar-bar-22 , inj₂ '\"' :: []) :: (just "P105" , nothing , just _anychar-bar-22 , inj₂ '≃' :: []) :: []
cedille-start _anychar = (just "P189" , nothing , just _anychar , inj₁ _anychar-bar-63 :: []) :: []
...
len-dec-rewrite {- P100-} ((Id "P100") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree (parsed-kvar-bar-20 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P101-} ((Id "P101") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree (parsed-kvar-bar-20 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P103-} ((Id "P103") :: (ParseTree (parsed-kvar-bar-20 x0)) :: _::_(ParseTree (parsed-kvar-star-21 x1)) rest) = just (ParseTree (parsed-kvar-star-21 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P104-} ((Id "P104") :: (InputChar '𝒌') :: _::_(ParseTree (parsed-kvar-star-21 x0)) rest) = just (ParseTree (parsed-kvar (string-append 1 (char-to-string '𝒌') x0)) ::' rest , 3)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(InputChar '≃') rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar '\"') rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
...
len-dec-rewrite {- P113-} ((Id "P113") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-anychar-bar-26 ::' rest , 2)
len-dec-rewrite {- P114-} ((Id "P114") :: _::_(ParseTree parsed-anychar-bar-25) rest) = just (ParseTree parsed-anychar-bar-26 ::' rest , 2)
len-dec-rewrite {- P115-} ((Id "P115") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-anychar-bar-27 ::' rest , 2)
...
len-dec-rewrite {- P119-} ((Id "P119") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-29 ::' rest , 2)
...
len-dec-rewrite {- P123-} ((Id "P123") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-anychar-bar-31 ::' rest , 2)
len-dec-rewrite {- P124-} ((Id "P124") :: _::_(ParseTree parsed-anychar-bar-30) rest) = just (ParseTree parsed-anychar-bar-31 ::' rest , 2)
len-dec-rewrite {- P125-} ((Id "P125") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-anychar-bar-32 ::' rest , 2)
len-dec-rewrite {- P126-} ((Id "P126") :: _::_(ParseTree parsed-anychar-bar-31) rest) = just (ParseTree parsed-anychar-bar-32 ::' rest , 2)
len-dec-rewrite {- P127-} ((Id "P127") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-anychar-bar-33 ::' rest , 2)
len-dec-rewrite {- P128-} ((Id "P128") :: _::_(ParseTree parsed-anychar-bar-32) rest) = just (ParseTree parsed-anychar-bar-33 ::' rest , 2)
len-dec-rewrite {- P129-} ((Id "P129") :: _::_(InputChar '?') rest) = just (ParseTree parsed-anychar-bar-34 ::' rest , 2)
...
len-dec-rewrite {- P131-} ((Id "P131") :: _::_(InputChar '⇒') rest) = just (ParseTree parsed-anychar-bar-35 ::' rest , 2)
...
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-anychar-bar-53 ::' rest , 2)
...
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree parsed-anychar-bar-54) rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree parsed-anychar-bar-55) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(ParseTree parsed-anychar-bar-56) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P177-} ((Id "P177") :: _::_(InputChar '□') rest) = just (ParseTree parsed-anychar-bar-58 ::' rest , 2)
...
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree parsed-anychar-bar-62 ::' rest , 2)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(ParseTree parsed-anychar-bar-61) rest) = just (ParseTree parsed-anychar-bar-62 ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree parsed-anychar-bar-63 ::' rest , 2)
len-dec-rewrite {- P188-} ((Id "P188") :: _::_(ParseTree parsed-anychar-bar-62) rest) = just (ParseTree parsed-anychar-bar-63 ::' rest , 2)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(ParseTree parsed-anychar-bar-63) rest) = just (ParseTree parsed-anychar ::' rest , 2)
...
len-dec-rewrite {- P191-} ((Id "P191") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-64) rest) = just (ParseTree parsed-comment-star-64 ::' rest , 3)
len-dec-rewrite {- P192-} ((Id "P192") :: (InputChar '%') :: (ParseTree parsed-comment-star-64) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P193-} ((Id "P193") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-65 ::' rest , 2)
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-65 ::' rest , 2)
len-dec-rewrite {- P195-} ((Id "P195") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-66 ::' rest , 2)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(ParseTree parsed-aws-bar-65) rest) = just (ParseTree parsed-aws-bar-66 ::' rest , 2)
len-dec-rewrite {- P197-} ((Id "P197") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-67 ::' rest , 2)
len-dec-rewrite {- P198-} ((Id "P198") :: _::_(ParseTree parsed-aws-bar-66) rest) = just (ParseTree parsed-aws-bar-67 ::' rest , 2)
len-dec-rewrite {- P199-} ((Id "P199") :: _::_(ParseTree parsed-aws-bar-67) rest) = just (ParseTree parsed-aws ::' rest , 2)
...
len-dec-rewrite {- P200-} ((Id "P200") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-68 ::' rest , 2)
len-dec-rewrite {- P201-} ((Id "P201") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-68) rest) = just (ParseTree parsed-ws-plus-68 ::' rest , 3)
len-dec-rewrite {- P202-} ((Id "P202") :: _::_(ParseTree parsed-ws-plus-68) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P204-} ((Id "P204") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-69) rest) = just (ParseTree parsed-ows-star-69 ::' rest , 3)
len-dec-rewrite {- P205-} ((Id "P205") :: _::_(ParseTree parsed-ows-star-69) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P97-} ((Id "P97") :: _::_(InputChar '_') rest) = just (ParseTree (parsed-fpth-bar-19 (string-append 0 (char-to-string '_'))) ::' rest , 2)
len-dec-rewrite {- P98-} ((Id "P98") :: (ParseTree (parsed-fpth-bar-15 x0)) :: _::_(ParseTree (parsed-fpth-star-18 x1)) rest) = just (ParseTree (parsed-fpth-bar-19 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P99-} ((Id "P99") :: _::_(ParseTree (parsed-fpth-bar-19 x0)) rest) = just (ParseTree (parsed-fpth (string-append 0 x0)) ::' rest , 2)
...
len-dec-rewrite {- P102-} (_::_(Id "P102") rest) = just (ParseTree (parsed-kvar-star-21 empty-string) ::' rest , 1)
len-dec-rewrite {- P190-} (_::_(Id "P190") rest) = just (ParseTree parsed-comment-star-64 ::' rest , 1)
len-dec-rewrite {- P203-} (_::_(Id "P203") rest) = just (ParseTree parsed-ows-star-69 ::' rest , 1)
