...
data gratr2-nt : Set where
  ...
  _lam : gratr2-nt
  _kvar-star-15 : gratr2-nt
  _kvar-bar-14 : gratr2-nt
  _kvar : gratr2-nt
  _kind : gratr2-nt
  _indices : gratr2-nt
  _decls : gratr2-nt
  ...
  _binder : gratr2-nt
  _aws-bar-61 : gratr2-nt
  _aws-bar-60 : gratr2-nt
  _aws-bar-59 : gratr2-nt
  _aws : gratr2-nt
  _atype : gratr2-nt
  _aterm : gratr2-nt
  _anychar-bar-57 : gratr2-nt
  _anychar-bar-56 : gratr2-nt
...
gratr2-nt-eq  _ws-plus-62 _ws-plus-62 = tt
...
gratr2-nt-eq  _ows-star-63 _ows-star-63 = tt
...
gratr2-nt-eq  _kvar-star-15 _kvar-star-15 = tt
gratr2-nt-eq  _kvar-bar-14 _kvar-bar-14 = tt
...
gratr2-nt-eq  _comment-star-58 _comment-star-58 = tt
...
gratr2-nt-eq  _aws-bar-61 _aws-bar-61 = tt
gratr2-nt-eq  _aws-bar-60 _aws-bar-60 = tt
...
gratr2-nt-eq  _anychar-bar-57 _anychar-bar-57 = tt
gratr2-nt-eq  _anychar-bar-56 _anychar-bar-56 = tt
...
cedille-start _ws-plus-62 = (just "P188" , nothing , just _ws-plus-62 , inj₁ _aws :: inj₁ _ws-plus-62 :: []) :: (just "P187" , nothing , just _ws-plus-62 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P189" , nothing , just _ws , inj₁ _ws-plus-62 :: []) :: []
...
cedille-start _ows-star-63 = (just "P191" , nothing , just _ows-star-63 , inj₁ _aws :: inj₁ _ows-star-63 :: []) :: (just "P190" , nothing , just _ows-star-63 , []) :: []
cedille-start _ows = (just "P192" , nothing , just _ows , inj₁ _ows-star-63 :: []) :: []
...
cedille-start _kvar-star-15 = (just "P90" , nothing , just _kvar-star-15 , inj₁ _kvar-bar-14 :: inj₁ _kvar-star-15 :: []) :: (just "P89" , nothing , just _kvar-star-15 , []) :: []
cedille-start _kvar-bar-14 = (just "P88" , nothing , just _kvar-bar-14 , inj₁ _numpunct :: []) :: (just "P87" , nothing , just _kvar-bar-14 , inj₁ _alpha :: []) :: []
cedille-start _kvar = (just "P91" , nothing , just _kvar , inj₂ '𝒌' :: inj₁ _kvar-star-15 :: []) :: []
...
cedille-start _comment-star-58 = (just "P178" , nothing , just _comment-star-58 , inj₁ _anychar :: inj₁ _comment-star-58 :: []) :: (just "P177" , nothing , just _comment-star-58 , []) :: []
cedille-start _comment = (just "P179" , nothing , just _comment , inj₂ '%' :: inj₁ _comment-star-58 :: inj₂ '\n' :: []) :: []
...
cedille-start _aws-bar-61 = (just "P185" , nothing , just _aws-bar-61 , inj₁ _aws-bar-60 :: []) :: (just "P184" , nothing , just _aws-bar-61 , inj₂ '\n' :: []) :: []
cedille-start _aws-bar-60 = (just "P183" , nothing , just _aws-bar-60 , inj₁ _aws-bar-59 :: []) :: (just "P182" , nothing , just _aws-bar-60 , inj₂ '\t' :: []) :: []
cedille-start _aws-bar-59 = (just "P181" , nothing , just _aws-bar-59 , inj₁ _comment :: []) :: (just "P180" , nothing , just _aws-bar-59 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P186" , nothing , just _aws , inj₁ _aws-bar-61 :: []) :: []
...
cedille-start _anychar-bar-57 = (just "P175" , nothing , just _anychar-bar-57 , inj₁ _anychar-bar-56 :: []) :: (just "P174" , nothing , just _anychar-bar-57 , inj₁ _alpha :: []) :: []
cedille-start _anychar-bar-56 = (just "P173" , nothing , just _anychar-bar-56 , inj₁ _anychar-bar-55 :: []) :: (just "P172" , nothing , just _anychar-bar-56 , inj₁ _numpunct :: []) :: []
cedille-start _anychar-bar-55 = (just "P171" , nothing , just _anychar-bar-55 , inj₁ _anychar-bar-54 :: []) :: (just "P170" , nothing , just _anychar-bar-55 , inj₂ '\t' :: []) :: []
...
cedille-start _anychar-bar-52 = (just "P165" , nothing , just _anychar-bar-52 , inj₁ _anychar-bar-51 :: []) :: (just "P164" , nothing , just _anychar-bar-52 , inj₂ '□' :: []) :: []
cedille-start _anychar-bar-51 = (just "P163" , nothing , just _anychar-bar-51 , inj₁ _anychar-bar-50 :: []) :: (just "P162" , nothing , just _anychar-bar-51 , inj₂ 'Π' :: []) :: []
cedille-start _anychar-bar-50 = (just "P161" , nothing , just _anychar-bar-50 , inj₁ _anychar-bar-49 :: []) :: (just "P160" , nothing , just _anychar-bar-50 , inj₂ 'ι' :: []) :: []
cedille-start _anychar-bar-49 = (just "P159" , nothing , just _anychar-bar-49 , inj₁ _anychar-bar-48 :: []) :: (just "P158" , nothing , just _anychar-bar-49 , inj₂ 'λ' :: []) :: []
...
cedille-start _anychar-bar-47 = (just "P155" , nothing , just _anychar-bar-47 , inj₁ _anychar-bar-46 :: []) :: (just "P154" , nothing , just _anychar-bar-47 , inj₂ 'π' :: []) :: []
...
cedille-start _anychar-bar-45 = (just "P151" , nothing , just _anychar-bar-45 , inj₁ _anychar-bar-44 :: []) :: (just "P150" , nothing , just _anychar-bar-45 , inj₂ '☆' :: []) :: []
cedille-start _anychar-bar-44 = (just "P149" , nothing , just _anychar-bar-44 , inj₁ _anychar-bar-43 :: []) :: (just "P148" , nothing , just _anychar-bar-44 , inj₂ '·' :: []) :: []
...
cedille-start _anychar-bar-27 = (just "P115" , nothing , just _anychar-bar-27 , inj₁ _anychar-bar-26 :: []) :: (just "P114" , nothing , just _anychar-bar-27 , inj₂ 'Λ' :: []) :: []
cedille-start _anychar-bar-26 = (just "P113" , nothing , just _anychar-bar-26 , inj₁ _anychar-bar-25 :: []) :: (just "P112" , nothing , just _anychar-bar-26 , inj₂ 'ρ' :: []) :: []
cedille-start _anychar-bar-25 = (just "P111" , nothing , just _anychar-bar-25 , inj₁ _anychar-bar-24 :: []) :: (just "P110" , nothing , just _anychar-bar-25 , inj₂ 'ε' :: []) :: []
...
cedille-start _anychar-bar-23 = (just "P107" , nothing , just _anychar-bar-23 , inj₁ _anychar-bar-22 :: []) :: (just "P106" , nothing , just _anychar-bar-23 , inj₂ '𝒌' :: []) :: []
cedille-start _anychar-bar-22 = (just "P105" , nothing , just _anychar-bar-22 , inj₁ _anychar-bar-21 :: []) :: (just "P104" , nothing , just _anychar-bar-22 , inj₂ '=' :: []) :: []
cedille-start _anychar-bar-21 = (just "P103" , nothing , just _anychar-bar-21 , inj₁ _anychar-bar-20 :: []) :: (just "P102" , nothing , just _anychar-bar-21 , inj₂ 'ς' :: []) :: []
cedille-start _anychar-bar-20 = (just "P101" , nothing , just _anychar-bar-20 , inj₁ _anychar-bar-19 :: []) :: (just "P100" , nothing , just _anychar-bar-20 , inj₂ 'θ' :: []) :: []
...
cedille-start _anychar-bar-16 = (just "P93" , nothing , just _anychar-bar-16 , inj₂ '\"' :: []) :: (just "P92" , nothing , just _anychar-bar-16 , inj₂ '≃' :: []) :: []
cedille-start _anychar = (just "P176" , nothing , just _anychar , inj₁ _anychar-bar-57 :: []) :: []
...
len-dec-rewrite {- P100-} ((Id "P100") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P101-} ((Id "P101") :: _::_(ParseTree parsed-anychar-bar-19) rest) = just (ParseTree parsed-anychar-bar-20 ::' rest , 2)
len-dec-rewrite {- P102-} ((Id "P102") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P103-} ((Id "P103") :: _::_(ParseTree parsed-anychar-bar-20) rest) = just (ParseTree parsed-anychar-bar-21 ::' rest , 2)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar '=') rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(ParseTree parsed-anychar-bar-21) rest) = just (ParseTree parsed-anychar-bar-22 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-23 ::' rest , 2)
...
len-dec-rewrite {- P110-} ((Id "P110") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-anychar-bar-25 ::' rest , 2)
len-dec-rewrite {- P111-} ((Id "P111") :: _::_(ParseTree parsed-anychar-bar-24) rest) = just (ParseTree parsed-anychar-bar-25 ::' rest , 2)
len-dec-rewrite {- P112-} ((Id "P112") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-anychar-bar-26 ::' rest , 2)
len-dec-rewrite {- P113-} ((Id "P113") :: _::_(ParseTree parsed-anychar-bar-25) rest) = just (ParseTree parsed-anychar-bar-26 ::' rest , 2)
len-dec-rewrite {- P114-} ((Id "P114") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-anychar-bar-27 ::' rest , 2)
...
len-dec-rewrite {- P148-} ((Id "P148") :: _::_(InputChar '·') rest) = just (ParseTree parsed-anychar-bar-44 ::' rest , 2)
...
len-dec-rewrite {- P150-} ((Id "P150") :: _::_(InputChar '☆') rest) = just (ParseTree parsed-anychar-bar-45 ::' rest , 2)
...
len-dec-rewrite {- P154-} ((Id "P154") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-anychar-bar-47 ::' rest , 2)
...
len-dec-rewrite {- P158-} ((Id "P158") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-anychar-bar-49 ::' rest , 2)
...
len-dec-rewrite {- P160-} ((Id "P160") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-anychar-bar-50 ::' rest , 2)
len-dec-rewrite {- P161-} ((Id "P161") :: _::_(ParseTree parsed-anychar-bar-49) rest) = just (ParseTree parsed-anychar-bar-50 ::' rest , 2)
len-dec-rewrite {- P162-} ((Id "P162") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-anychar-bar-51 ::' rest , 2)
len-dec-rewrite {- P163-} ((Id "P163") :: _::_(ParseTree parsed-anychar-bar-50) rest) = just (ParseTree parsed-anychar-bar-51 ::' rest , 2)
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(InputChar '□') rest) = just (ParseTree parsed-anychar-bar-52 ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(ParseTree parsed-anychar-bar-54) rest) = just (ParseTree parsed-anychar-bar-55 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(ParseTree parsed-anychar-bar-55) rest) = just (ParseTree parsed-anychar-bar-56 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(ParseTree parsed-anychar-bar-56) rest) = just (ParseTree parsed-anychar-bar-57 ::' rest , 2)
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(ParseTree parsed-anychar-bar-57) rest) = just (ParseTree parsed-anychar ::' rest , 2)
len-dec-rewrite {- P178-} ((Id "P178") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-58) rest) = just (ParseTree parsed-comment-star-58 ::' rest , 3)
len-dec-rewrite {- P179-} ((Id "P179") :: (InputChar '%') :: (ParseTree parsed-comment-star-58) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
...
len-dec-rewrite {- P180-} ((Id "P180") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-59 ::' rest , 2)
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-59 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-60 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(ParseTree parsed-aws-bar-59) rest) = just (ParseTree parsed-aws-bar-60 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-61 ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(ParseTree parsed-aws-bar-60) rest) = just (ParseTree parsed-aws-bar-61 ::' rest , 2)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(ParseTree parsed-aws-bar-61) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-62 ::' rest , 2)
len-dec-rewrite {- P188-} ((Id "P188") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-62) rest) = just (ParseTree parsed-ws-plus-62 ::' rest , 3)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(ParseTree parsed-ws-plus-62) rest) = just (ParseTree parsed-ws ::' rest , 2)
...
len-dec-rewrite {- P191-} ((Id "P191") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-63) rest) = just (ParseTree parsed-ows-star-63 ::' rest , 3)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-ows-star-63) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P87-} ((Id "P87") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree (parsed-kvar-bar-14 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P88-} ((Id "P88") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree (parsed-kvar-bar-14 (string-append 0 x0)) ::' rest , 2)
...
len-dec-rewrite {- P90-} ((Id "P90") :: (ParseTree (parsed-kvar-bar-14 x0)) :: _::_(ParseTree (parsed-kvar-star-15 x1)) rest) = just (ParseTree (parsed-kvar-star-15 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P91-} ((Id "P91") :: (InputChar '𝒌') :: _::_(ParseTree (parsed-kvar-star-15 x0)) rest) = just (ParseTree (parsed-kvar (string-append 1 (char-to-string '𝒌') x0)) ::' rest , 3)
len-dec-rewrite {- P92-} ((Id "P92") :: _::_(InputChar '≃') rest) = just (ParseTree parsed-anychar-bar-16 ::' rest , 2)
len-dec-rewrite {- P93-} ((Id "P93") :: _::_(InputChar '\"') rest) = just (ParseTree parsed-anychar-bar-16 ::' rest , 2)
...
len-dec-rewrite {- P177-} (_::_(Id "P177") rest) = just (ParseTree parsed-comment-star-58 ::' rest , 1)
len-dec-rewrite {- P190-} (_::_(Id "P190") rest) = just (ParseTree parsed-ows-star-63 ::' rest , 1)
len-dec-rewrite {- P82-} (_::_(Id "P82") rest) = just (ParseTree (parsed-var-star-12 empty-string) ::' rest , 1)
len-dec-rewrite {- P89-} (_::_(Id "P89") rest) = just (ParseTree (parsed-kvar-star-15 empty-string) ::' rest , 1)
