...
gratr2-nt-eq  _var-bar-13 _var-bar-13 = tt
...
cedille-start _ws-plus-77 = (just "P220" , nothing , just _ws-plus-77 , inj₁ _aws :: inj₁ _ws-plus-77 :: []) :: (just "P219" , nothing , just _ws-plus-77 , inj₁ _aws :: []) :: []
cedille-start _ws = (just "P221" , nothing , just _ws , inj₁ _ws-plus-77 :: []) :: []
...
cedille-start _var-bar-11 = (just "P81" , nothing , just _var-bar-11 , inj₁ _numpunct :: []) :: (just "P80" , nothing , just _var-bar-11 , inj₁ _alpha :: []) :: []
cedille-start _var = (just "P86" , nothing , just _var , inj₁ _var-bar-13 :: []) :: []
cedille-start _type = (just "embed" , just "embed_end" , just _type , inj₁ _ltype :: []) :: (just "TpLambda" , nothing , just _type , inj₁ _posinfo :: inj₂ 'λ' :: inj₁ _ows :: inj₁ _posinfo :: inj₁ _var :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _tk :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _type :: []) :: (just "TpEq" , nothing , just _type , inj₁ _term :: inj₁ _ows :: inj₂ '≃' :: inj₁ _ows :: inj₁ _term :: []) :: (just "TpArrow" , nothing , just _type , inj₁ _ltype :: inj₁ _ows :: inj₁ _arrowtype :: inj₁ _ows :: inj₁ _type :: []) :: (just "NoSpans" , nothing , just _type , inj₂ '{' :: inj₂ '^' :: inj₁ _type :: inj₁ _posinfo :: inj₂ '^' :: inj₂ '}' :: []) :: (just "Mu" , nothing , just _type , inj₁ _posinfo :: inj₂ 'μ' :: inj₁ _ows :: inj₁ _posinfo :: inj₁ _var :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _kind :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _type :: []) :: (just "IotaEx" , nothing , just _type , inj₁ _posinfo :: inj₁ _ie :: inj₁ _ows :: inj₁ _posinfo :: inj₁ _var :: inj₁ _optType :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _type :: []) :: (just "Abs" , nothing , just _type , inj₁ _posinfo :: inj₁ _binder :: inj₁ _ows :: inj₁ _posinfo :: inj₁ _var :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _tk :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _type :: []) :: []
...
cedille-start _ows = (just "P224" , nothing , just _ows , inj₁ _ows-star-78 :: []) :: []
cedille-start _otherpunct-bar-67 = (just "P196" , nothing , just _otherpunct-bar-67 , inj₁ _otherpunct-bar-66 :: []) :: (just "P195" , nothing , just _otherpunct-bar-67 , inj₂ '|' :: []) :: []
cedille-start _otherpunct-bar-66 = (just "P194" , nothing , just _otherpunct-bar-66 , inj₁ _otherpunct-bar-65 :: []) :: (just "P193" , nothing , just _otherpunct-bar-66 , inj₂ '□' :: []) :: []
cedille-start _otherpunct-bar-65 = (just "P192" , nothing , just _otherpunct-bar-65 , inj₁ _otherpunct-bar-64 :: []) :: (just "P191" , nothing , just _otherpunct-bar-65 , inj₂ 'Π' :: []) :: []
cedille-start _otherpunct-bar-64 = (just "P190" , nothing , just _otherpunct-bar-64 , inj₁ _otherpunct-bar-63 :: []) :: (just "P189" , nothing , just _otherpunct-bar-64 , inj₂ 'ι' :: []) :: []
cedille-start _otherpunct-bar-63 = (just "P188" , nothing , just _otherpunct-bar-63 , inj₁ _otherpunct-bar-62 :: []) :: (just "P187" , nothing , just _otherpunct-bar-63 , inj₂ 'λ' :: []) :: []
cedille-start _otherpunct-bar-62 = (just "P186" , nothing , just _otherpunct-bar-62 , inj₁ _otherpunct-bar-61 :: []) :: (just "P185" , nothing , just _otherpunct-bar-62 , inj₂ '∀' :: []) :: []
cedille-start _otherpunct-bar-61 = (just "P184" , nothing , just _otherpunct-bar-61 , inj₁ _otherpunct-bar-60 :: []) :: (just "P183" , nothing , just _otherpunct-bar-61 , inj₂ 'π' :: []) :: []
cedille-start _otherpunct-bar-60 = (just "P182" , nothing , just _otherpunct-bar-60 , inj₁ _otherpunct-bar-59 :: []) :: (just "P181" , nothing , just _otherpunct-bar-60 , inj₂ '★' :: []) :: []
cedille-start _otherpunct-bar-59 = (just "P180" , nothing , just _otherpunct-bar-59 , inj₁ _otherpunct-bar-58 :: []) :: (just "P179" , nothing , just _otherpunct-bar-59 , inj₂ '☆' :: []) :: []
cedille-start _otherpunct-bar-58 = (just "P178" , nothing , just _otherpunct-bar-58 , inj₁ _otherpunct-bar-57 :: []) :: (just "P177" , nothing , just _otherpunct-bar-58 , inj₂ '·' :: []) :: []
cedille-start _otherpunct-bar-57 = (just "P176" , nothing , just _otherpunct-bar-57 , inj₁ _otherpunct-bar-56 :: []) :: (just "P175" , nothing , just _otherpunct-bar-57 , inj₂ '⇐' :: []) :: []
cedille-start _otherpunct-bar-56 = (just "P174" , nothing , just _otherpunct-bar-56 , inj₁ _otherpunct-bar-55 :: []) :: (just "P173" , nothing , just _otherpunct-bar-56 , inj₂ '➔' :: []) :: []
cedille-start _otherpunct-bar-55 = (just "P172" , nothing , just _otherpunct-bar-55 , inj₁ _otherpunct-bar-54 :: []) :: (just "P171" , nothing , just _otherpunct-bar-55 , inj₂ '➾' :: []) :: []
cedille-start _otherpunct-bar-54 = (just "P170" , nothing , just _otherpunct-bar-54 , inj₁ _otherpunct-bar-53 :: []) :: (just "P169" , nothing , just _otherpunct-bar-54 , inj₂ '↑' :: []) :: []
cedille-start _otherpunct-bar-53 = (just "P168" , nothing , just _otherpunct-bar-53 , inj₁ _otherpunct-bar-52 :: []) :: (just "P167" , nothing , just _otherpunct-bar-53 , inj₂ '●' :: []) :: []
cedille-start _otherpunct-bar-52 = (just "P166" , nothing , just _otherpunct-bar-52 , inj₁ _otherpunct-bar-51 :: []) :: (just "P165" , nothing , just _otherpunct-bar-52 , inj₂ '(' :: []) :: []
cedille-start _otherpunct-bar-51 = (just "P164" , nothing , just _otherpunct-bar-51 , inj₁ _otherpunct-bar-50 :: []) :: (just "P163" , nothing , just _otherpunct-bar-51 , inj₂ ')' :: []) :: []
cedille-start _otherpunct-bar-50 = (just "P162" , nothing , just _otherpunct-bar-50 , inj₁ _otherpunct-bar-49 :: []) :: (just "P161" , nothing , just _otherpunct-bar-50 , inj₂ ':' :: []) :: []
cedille-start _otherpunct-bar-49 = (just "P160" , nothing , just _otherpunct-bar-49 , inj₁ _otherpunct-bar-48 :: []) :: (just "P159" , nothing , just _otherpunct-bar-49 , inj₂ '.' :: []) :: []
cedille-start _otherpunct-bar-48 = (just "P158" , nothing , just _otherpunct-bar-48 , inj₁ _otherpunct-bar-47 :: []) :: (just "P157" , nothing , just _otherpunct-bar-48 , inj₂ '[' :: []) :: []
cedille-start _otherpunct-bar-47 = (just "P156" , nothing , just _otherpunct-bar-47 , inj₁ _otherpunct-bar-46 :: []) :: (just "P155" , nothing , just _otherpunct-bar-47 , inj₂ ']' :: []) :: []
cedille-start _otherpunct-bar-46 = (just "P154" , nothing , just _otherpunct-bar-46 , inj₁ _otherpunct-bar-45 :: []) :: (just "P153" , nothing , just _otherpunct-bar-46 , inj₂ ',' :: []) :: []
cedille-start _otherpunct-bar-45 = (just "P152" , nothing , just _otherpunct-bar-45 , inj₁ _otherpunct-bar-44 :: []) :: (just "P151" , nothing , just _otherpunct-bar-45 , inj₂ '!' :: []) :: []
cedille-start _otherpunct-bar-44 = (just "P150" , nothing , just _otherpunct-bar-44 , inj₁ _otherpunct-bar-43 :: []) :: (just "P149" , nothing , just _otherpunct-bar-44 , inj₂ '{' :: []) :: []
cedille-start _otherpunct-bar-43 = (just "P148" , nothing , just _otherpunct-bar-43 , inj₁ _otherpunct-bar-42 :: []) :: (just "P147" , nothing , just _otherpunct-bar-43 , inj₂ '}' :: []) :: []
cedille-start _otherpunct-bar-42 = (just "P146" , nothing , just _otherpunct-bar-42 , inj₁ _otherpunct-bar-41 :: []) :: (just "P145" , nothing , just _otherpunct-bar-42 , inj₂ '⇒' :: []) :: []
cedille-start _otherpunct-bar-41 = (just "P144" , nothing , just _otherpunct-bar-41 , inj₁ _otherpunct-bar-40 :: []) :: (just "P143" , nothing , just _otherpunct-bar-41 , inj₂ '?' :: []) :: []
cedille-start _otherpunct-bar-40 = (just "P142" , nothing , just _otherpunct-bar-40 , inj₁ _otherpunct-bar-39 :: []) :: (just "P141" , nothing , just _otherpunct-bar-40 , inj₂ 'Λ' :: []) :: []
cedille-start _otherpunct-bar-39 = (just "P140" , nothing , just _otherpunct-bar-39 , inj₁ _otherpunct-bar-38 :: []) :: (just "P139" , nothing , just _otherpunct-bar-39 , inj₂ 'ρ' :: []) :: []
cedille-start _otherpunct-bar-38 = (just "P138" , nothing , just _otherpunct-bar-38 , inj₁ _otherpunct-bar-37 :: []) :: (just "P137" , nothing , just _otherpunct-bar-38 , inj₂ 'ε' :: []) :: []
cedille-start _otherpunct-bar-37 = (just "P136" , nothing , just _otherpunct-bar-37 , inj₁ _otherpunct-bar-36 :: []) :: (just "P135" , nothing , just _otherpunct-bar-37 , inj₂ 'β' :: []) :: []
cedille-start _otherpunct-bar-36 = (just "P134" , nothing , just _otherpunct-bar-36 , inj₁ _otherpunct-bar-35 :: []) :: (just "P133" , nothing , just _otherpunct-bar-36 , inj₂ '-' :: []) :: []
cedille-start _otherpunct-bar-35 = (just "P132" , nothing , just _otherpunct-bar-35 , inj₁ _otherpunct-bar-34 :: []) :: (just "P131" , nothing , just _otherpunct-bar-35 , inj₂ '𝒌' :: []) :: []
cedille-start _otherpunct-bar-34 = (just "P130" , nothing , just _otherpunct-bar-34 , inj₁ _otherpunct-bar-33 :: []) :: (just "P129" , nothing , just _otherpunct-bar-34 , inj₂ '=' :: []) :: []
cedille-start _otherpunct-bar-33 = (just "P128" , nothing , just _otherpunct-bar-33 , inj₁ _otherpunct-bar-32 :: []) :: (just "P127" , nothing , just _otherpunct-bar-33 , inj₂ 'ς' :: []) :: []
cedille-start _otherpunct-bar-32 = (just "P126" , nothing , just _otherpunct-bar-32 , inj₁ _otherpunct-bar-31 :: []) :: (just "P125" , nothing , just _otherpunct-bar-32 , inj₂ 'θ' :: []) :: []
cedille-start _otherpunct-bar-31 = (just "P124" , nothing , just _otherpunct-bar-31 , inj₁ _otherpunct-bar-30 :: []) :: (just "P123" , nothing , just _otherpunct-bar-31 , inj₂ '+' :: []) :: []
cedille-start _otherpunct-bar-30 = (just "P122" , nothing , just _otherpunct-bar-30 , inj₁ _otherpunct-bar-29 :: []) :: (just "P121" , nothing , just _otherpunct-bar-30 , inj₂ '<' :: []) :: []
cedille-start _otherpunct-bar-29 = (just "P120" , nothing , just _otherpunct-bar-29 , inj₁ _otherpunct-bar-28 :: []) :: (just "P119" , nothing , just _otherpunct-bar-29 , inj₂ '>' :: []) :: []
cedille-start _otherpunct-bar-28 = (just "P118" , nothing , just _otherpunct-bar-28 , inj₁ _otherpunct-bar-27 :: []) :: (just "P117" , nothing , just _otherpunct-bar-28 , inj₂ '≃' :: []) :: []
cedille-start _otherpunct-bar-27 = (just "P116" , nothing , just _otherpunct-bar-27 , inj₁ _otherpunct-bar-26 :: []) :: (just "P115" , nothing , just _otherpunct-bar-27 , inj₂ '\"' :: []) :: []
cedille-start _otherpunct-bar-26 = (just "P114" , nothing , just _otherpunct-bar-26 , inj₁ _otherpunct-bar-25 :: []) :: (just "P113" , nothing , just _otherpunct-bar-26 , inj₂ 'δ' :: []) :: []
cedille-start _otherpunct-bar-25 = (just "P112" , nothing , just _otherpunct-bar-25 , inj₁ _otherpunct-bar-24 :: []) :: (just "P111" , nothing , just _otherpunct-bar-25 , inj₂ 'χ' :: []) :: []
cedille-start _otherpunct-bar-24 = (just "P110" , nothing , just _otherpunct-bar-24 , inj₁ _otherpunct-bar-23 :: []) :: (just "P109" , nothing , just _otherpunct-bar-24 , inj₂ 'μ' :: []) :: []
cedille-start _otherpunct-bar-23 = (just "P108" , nothing , just _otherpunct-bar-23 , inj₁ _otherpunct-bar-22 :: []) :: (just "P107" , nothing , just _otherpunct-bar-23 , inj₂ 'υ' :: []) :: []
cedille-start _otherpunct-bar-22 = (just "P106" , nothing , just _otherpunct-bar-22 , inj₁ _otherpunct-bar-21 :: []) :: (just "P105" , nothing , just _otherpunct-bar-22 , inj₂ 'φ' :: []) :: []
cedille-start _otherpunct-bar-21 = (just "P104" , nothing , just _otherpunct-bar-21 , inj₂ 'ω' :: []) :: (just "P103" , nothing , just _otherpunct-bar-21 , inj₂ '◂' :: []) :: []
cedille-start _otherpunct = (just "P197" , nothing , just _otherpunct , inj₁ _otherpunct-bar-67 :: []) :: []
...
cedille-start _lterm = (just "embed" , just "embed_end" , just _lterm , inj₁ _pterm :: []) :: (just "Sigma" , nothing , just _lterm , inj₁ _posinfo :: inj₂ 'ς' :: inj₁ _ows :: inj₁ _lterm :: []) :: (just "Rho" , nothing , just _lterm , inj₁ _posinfo :: inj₁ _rho :: inj₁ _ows :: inj₁ _lterm :: inj₁ _ows :: inj₂ '-' :: inj₁ _ows :: inj₁ _lterm :: []) :: (just "PiInj" , nothing , just _lterm , inj₁ _posinfo :: inj₂ 'π' :: inj₁ _num :: inj₁ _ows :: inj₁ _lterm :: []) :: (just "Omega" , nothing , just _lterm , inj₁ _posinfo :: inj₂ 'ω' :: inj₁ _ows :: inj₁ _lterm :: []) :: (just "Epsilon" , nothing , just _lterm , inj₁ _posinfo :: inj₂ 'ε' :: inj₁ _leftRight :: inj₁ _maybeMinus :: inj₁ _ows :: inj₁ _lterm :: []) :: (just "Delta" , nothing , just _lterm , inj₁ _posinfo :: inj₂ 'δ' :: inj₁ _ows :: inj₁ _lterm :: []) :: (just "Chi" , nothing , just _lterm , inj₁ _posinfo :: inj₂ 'χ' :: inj₁ _maybeAtype :: inj₁ _ows :: inj₂ '-' :: inj₁ _ows :: inj₁ _lterm :: []) :: (just "Beta" , nothing , just _lterm , inj₁ _posinfo :: inj₂ 'β' :: inj₁ _optTerm :: []) :: []
...
cedille-start _kvar-star-20 = (just "P101" , nothing , just _kvar-star-20 , inj₁ _kvar-bar-19 :: inj₁ _kvar-star-20 :: []) :: (just "P100" , nothing , just _kvar-star-20 , []) :: []
cedille-start _kvar-bar-19 = (just "P99" , nothing , just _kvar-bar-19 , inj₁ _numpunct :: []) :: (just "P98" , nothing , just _kvar-bar-19 , inj₁ _alpha :: []) :: []
cedille-start _kvar = (just "P102" , nothing , just _kvar , inj₂ '𝒌' :: inj₁ _kvar-star-20 :: []) :: []
cedille-start _kind = (just "Star" , nothing , just _kind , inj₁ _posinfo :: inj₂ '★' :: []) :: (just "KndVar" , nothing , just _kind , inj₁ _posinfo :: inj₁ _kvar :: inj₁ _args :: []) :: (just "KndTpArrow" , nothing , just _kind , inj₁ _ltype :: inj₁ _ows :: inj₂ '➔' :: inj₁ _ows :: inj₁ _kind :: []) :: (just "KndPi" , nothing , just _kind , inj₁ _posinfo :: inj₂ 'Π' :: inj₁ _ows :: inj₁ _posinfo :: inj₁ _var :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _tk :: inj₁ _ows :: inj₂ '.' :: inj₁ _ows :: inj₁ _kind :: []) :: (just "KndParens" , nothing , just _kind , inj₁ _posinfo :: inj₂ '(' :: inj₁ _ows :: inj₁ _kind :: inj₁ _ows :: inj₂ ')' :: inj₁ _posinfo :: []) :: []
cedille-start _ie = (just "Iota" , nothing , just _ie , inj₂ 'ι' :: []) :: (just "Exists" , nothing , just _ie , inj₂ '∃' :: []) :: []
cedille-start _fpth-star-18 = (just "P96" , nothing , just _fpth-star-18 , inj₁ _fpth-bar-17 :: inj₁ _fpth-star-18 :: []) :: (just "P95" , nothing , just _fpth-star-18 , []) :: []
cedille-start _fpth-plus-14 = (just "P88" , nothing , just _fpth-plus-14 , inj₂ '.' :: inj₂ '.' :: inj₂ '/' :: inj₁ _fpth-plus-14 :: []) :: (just "P87" , nothing , just _fpth-plus-14 , inj₂ '.' :: inj₂ '.' :: inj₂ '/' :: []) :: []
cedille-start _fpth-bar-17 = (just "P94" , nothing , just _fpth-bar-17 , inj₁ _fpth-bar-16 :: []) :: (just "P93" , nothing , just _fpth-bar-17 , inj₁ _alpha :: []) :: []
cedille-start _fpth-bar-16 = (just "P92" , nothing , just _fpth-bar-16 , inj₂ '/' :: []) :: (just "P91" , nothing , just _fpth-bar-16 , inj₁ _numpunct :: []) :: []
cedille-start _fpth-bar-15 = (just "P90" , nothing , just _fpth-bar-15 , inj₁ _fpth-plus-14 :: []) :: (just "P89" , nothing , just _fpth-bar-15 , inj₁ _alpha :: []) :: []
cedille-start _fpth = (just "P97" , nothing , just _fpth , inj₁ _fpth-bar-15 :: inj₁ _fpth-star-18 :: []) :: []
cedille-start _decl = (just "Decl" , nothing , just _decl , inj₁ _posinfo :: inj₂ '(' :: inj₁ _ows :: inj₁ _posinfo :: inj₁ _var :: inj₁ _ows :: inj₂ ':' :: inj₁ _ows :: inj₁ _tk :: inj₁ _ows :: inj₂ ')' :: inj₁ _posinfo :: []) :: []
...
cedille-start _aws-bar-74 = (just "P213" , nothing , just _aws-bar-74 , inj₁ _comment :: []) :: (just "P212" , nothing , just _aws-bar-74 , inj₂ ' ' :: []) :: []
cedille-start _aws = (just "P218" , nothing , just _aws , inj₁ _aws-bar-76 :: []) :: []
cedille-start _atype = (just "TpVar" , nothing , just _atype , inj₁ _posinfo :: inj₁ _var :: []) :: (just "TpParens" , nothing , just _atype , inj₁ _posinfo :: inj₂ '(' :: inj₁ _ows :: inj₁ _type :: inj₁ _ows :: inj₂ ')' :: inj₁ _posinfo :: []) :: (just "TpHole" , nothing , just _atype , inj₁ _posinfo :: inj₂ '●' :: []) :: []
...
cedille-start _anychar-bar-72 = (just "P207" , nothing , just _anychar-bar-72 , inj₁ _anychar-bar-71 :: []) :: (just "P206" , nothing , just _anychar-bar-72 , inj₁ _alpha :: []) :: []
cedille-start _anychar-bar-71 = (just "P205" , nothing , just _anychar-bar-71 , inj₁ _anychar-bar-70 :: []) :: (just "P204" , nothing , just _anychar-bar-71 , inj₁ _numpunct :: []) :: []
cedille-start _anychar-bar-70 = (just "P203" , nothing , just _anychar-bar-70 , inj₁ _anychar-bar-69 :: []) :: (just "P202" , nothing , just _anychar-bar-70 , inj₂ '\t' :: []) :: []
cedille-start _anychar-bar-69 = (just "P201" , nothing , just _anychar-bar-69 , inj₁ _anychar-bar-68 :: []) :: (just "P200" , nothing , just _anychar-bar-69 , inj₂ ' ' :: []) :: []
cedille-start _anychar-bar-68 = (just "P199" , nothing , just _anychar-bar-68 , inj₁ _otherpunct :: []) :: (just "P198" , nothing , just _anychar-bar-68 , inj₂ '%' :: []) :: []
cedille-start _anychar = (just "P208" , nothing , just _anychar , inj₁ _anychar-bar-72 :: []) :: []
...
len-dec-rewrite {- CheckKind-} ((Id "CheckKind") :: (ParseTree (parsed-kind x0)) :: (ParseTree parsed-ows) :: (InputChar '.') :: _::_(ParseTree (parsed-posinfo x1)) rest) = just (ParseTree (parsed-cmd (norm-cmd (CheckKind x0 x1))) ::' rest , 5)
len-dec-rewrite {- CheckTerm-} ((Id "CheckTerm") :: (ParseTree (parsed-term x0)) :: (ParseTree (parsed-maybeCheckType x1)) :: (ParseTree parsed-ows) :: (ParseTree (parsed-cmdTerminator x2)) :: _::_(ParseTree (parsed-posinfo x3)) rest) = just (ParseTree (parsed-cmd (norm-cmd (CheckTerm x0 x1 x2 x3))) ::' rest , 6)
len-dec-rewrite {- CheckType-} ((Id "CheckType") :: (ParseTree (parsed-type x0)) :: (ParseTree (parsed-checkKind x1)) :: (ParseTree parsed-ows) :: (ParseTree (parsed-cmdTerminator x2)) :: _::_(ParseTree (parsed-posinfo x3)) rest) = just (ParseTree (parsed-cmd (norm-cmd (CheckType x0 x1 x2 x3))) ::' rest , 6)
...
len-dec-rewrite {- DefTerm-} ((Id "DefTerm") :: (ParseTree (parsed-posinfo x0)) :: (ParseTree (parsed-var x1)) :: (ParseTree (parsed-maybeCheckType x2)) :: (ParseTree parsed-ows) :: (InputChar '=') :: (ParseTree parsed-ows) :: (ParseTree (parsed-term x3)) :: (ParseTree parsed-ows) :: (ParseTree (parsed-cmdTerminator x4)) :: _::_(ParseTree (parsed-posinfo x5)) rest) = just (ParseTree (parsed-cmd (norm-cmd (DefTerm x0 x1 x2 x3 x4 x5))) ::' rest , 11)
len-dec-rewrite {- DefType-} ((Id "DefType") :: (ParseTree (parsed-posinfo x0)) :: (ParseTree (parsed-var x1)) :: (ParseTree (parsed-checkKind x2)) :: (ParseTree parsed-ows) :: (InputChar '=') :: (ParseTree parsed-ows) :: (ParseTree (parsed-type x3)) :: (ParseTree parsed-ows) :: (ParseTree (parsed-cmdTerminator x4)) :: _::_(ParseTree (parsed-posinfo x5)) rest) = just (ParseTree (parsed-cmd (norm-cmd (DefType x0 x1 x2 x3 x4 x5))) ::' rest , 11)
...
len-dec-rewrite {- EraseOnly-} ((Id "EraseOnly") :: _::_(InputChar '.') rest) = just (ParseTree (parsed-cmdTerminator (norm-cmdTerminator EraseOnly)) ::' rest , 2)
...
len-dec-rewrite {- Exists-} ((Id "Exists") :: _::_(InputChar '∃') rest) = just (ParseTree (parsed-ie (norm-ie Exists)) ::' rest , 2)
...
len-dec-rewrite {- Hanf-} ((Id "Hanf") :: (InputChar '!') :: (InputChar '!') :: _::_(InputChar '-') rest) = just (ParseTree (parsed-cmdTerminator (norm-cmdTerminator Hanf)) ::' rest , 4)
len-dec-rewrite {- Hnf-} ((Id "Hnf") :: (InputChar '!') :: _::_(InputChar '!') rest) = just (ParseTree (parsed-cmdTerminator (norm-cmdTerminator Hnf)) ::' rest , 3)
...
len-dec-rewrite {- Omega-} ((Id "Omega") :: (ParseTree (parsed-posinfo x0)) :: (InputChar 'ω') :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-lterm x1)) rest) = just (ParseTree (parsed-lterm (norm-term (Omega x0 x1))) ::' rest , 5)
...
len-dec-rewrite {- P103-} ((Id "P103") :: _::_(InputChar '◂') rest) = just (ParseTree parsed-otherpunct-bar-21 ::' rest , 2)
len-dec-rewrite {- P104-} ((Id "P104") :: _::_(InputChar 'ω') rest) = just (ParseTree parsed-otherpunct-bar-21 ::' rest , 2)
len-dec-rewrite {- P105-} ((Id "P105") :: _::_(InputChar 'φ') rest) = just (ParseTree parsed-otherpunct-bar-22 ::' rest , 2)
len-dec-rewrite {- P106-} ((Id "P106") :: _::_(ParseTree parsed-otherpunct-bar-21) rest) = just (ParseTree parsed-otherpunct-bar-22 ::' rest , 2)
len-dec-rewrite {- P107-} ((Id "P107") :: _::_(InputChar 'υ') rest) = just (ParseTree parsed-otherpunct-bar-23 ::' rest , 2)
len-dec-rewrite {- P108-} ((Id "P108") :: _::_(ParseTree parsed-otherpunct-bar-22) rest) = just (ParseTree parsed-otherpunct-bar-23 ::' rest , 2)
len-dec-rewrite {- P109-} ((Id "P109") :: _::_(InputChar 'μ') rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
...
len-dec-rewrite {- P110-} ((Id "P110") :: _::_(ParseTree parsed-otherpunct-bar-23) rest) = just (ParseTree parsed-otherpunct-bar-24 ::' rest , 2)
len-dec-rewrite {- P111-} ((Id "P111") :: _::_(InputChar 'χ') rest) = just (ParseTree parsed-otherpunct-bar-25 ::' rest , 2)
len-dec-rewrite {- P112-} ((Id "P112") :: _::_(ParseTree parsed-otherpunct-bar-24) rest) = just (ParseTree parsed-otherpunct-bar-25 ::' rest , 2)
len-dec-rewrite {- P113-} ((Id "P113") :: _::_(InputChar 'δ') rest) = just (ParseTree parsed-otherpunct-bar-26 ::' rest , 2)
len-dec-rewrite {- P114-} ((Id "P114") :: _::_(ParseTree parsed-otherpunct-bar-25) rest) = just (ParseTree parsed-otherpunct-bar-26 ::' rest , 2)
len-dec-rewrite {- P115-} ((Id "P115") :: _::_(InputChar '\"') rest) = just (ParseTree parsed-otherpunct-bar-27 ::' rest , 2)
len-dec-rewrite {- P116-} ((Id "P116") :: _::_(ParseTree parsed-otherpunct-bar-26) rest) = just (ParseTree parsed-otherpunct-bar-27 ::' rest , 2)
len-dec-rewrite {- P117-} ((Id "P117") :: _::_(InputChar '≃') rest) = just (ParseTree parsed-otherpunct-bar-28 ::' rest , 2)
len-dec-rewrite {- P118-} ((Id "P118") :: _::_(ParseTree parsed-otherpunct-bar-27) rest) = just (ParseTree parsed-otherpunct-bar-28 ::' rest , 2)
len-dec-rewrite {- P119-} ((Id "P119") :: _::_(InputChar '>') rest) = just (ParseTree parsed-otherpunct-bar-29 ::' rest , 2)
...
len-dec-rewrite {- P120-} ((Id "P120") :: _::_(ParseTree parsed-otherpunct-bar-28) rest) = just (ParseTree parsed-otherpunct-bar-29 ::' rest , 2)
len-dec-rewrite {- P121-} ((Id "P121") :: _::_(InputChar '<') rest) = just (ParseTree parsed-otherpunct-bar-30 ::' rest , 2)
len-dec-rewrite {- P122-} ((Id "P122") :: _::_(ParseTree parsed-otherpunct-bar-29) rest) = just (ParseTree parsed-otherpunct-bar-30 ::' rest , 2)
len-dec-rewrite {- P123-} ((Id "P123") :: _::_(InputChar '+') rest) = just (ParseTree parsed-otherpunct-bar-31 ::' rest , 2)
len-dec-rewrite {- P124-} ((Id "P124") :: _::_(ParseTree parsed-otherpunct-bar-30) rest) = just (ParseTree parsed-otherpunct-bar-31 ::' rest , 2)
len-dec-rewrite {- P125-} ((Id "P125") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-otherpunct-bar-32 ::' rest , 2)
len-dec-rewrite {- P126-} ((Id "P126") :: _::_(ParseTree parsed-otherpunct-bar-31) rest) = just (ParseTree parsed-otherpunct-bar-32 ::' rest , 2)
len-dec-rewrite {- P127-} ((Id "P127") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-otherpunct-bar-33 ::' rest , 2)
len-dec-rewrite {- P128-} ((Id "P128") :: _::_(ParseTree parsed-otherpunct-bar-32) rest) = just (ParseTree parsed-otherpunct-bar-33 ::' rest , 2)
len-dec-rewrite {- P129-} ((Id "P129") :: _::_(InputChar '=') rest) = just (ParseTree parsed-otherpunct-bar-34 ::' rest , 2)
...
len-dec-rewrite {- P130-} ((Id "P130") :: _::_(ParseTree parsed-otherpunct-bar-33) rest) = just (ParseTree parsed-otherpunct-bar-34 ::' rest , 2)
len-dec-rewrite {- P131-} ((Id "P131") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-otherpunct-bar-35 ::' rest , 2)
len-dec-rewrite {- P132-} ((Id "P132") :: _::_(ParseTree parsed-otherpunct-bar-34) rest) = just (ParseTree parsed-otherpunct-bar-35 ::' rest , 2)
len-dec-rewrite {- P133-} ((Id "P133") :: _::_(InputChar '-') rest) = just (ParseTree parsed-otherpunct-bar-36 ::' rest , 2)
len-dec-rewrite {- P134-} ((Id "P134") :: _::_(ParseTree parsed-otherpunct-bar-35) rest) = just (ParseTree parsed-otherpunct-bar-36 ::' rest , 2)
len-dec-rewrite {- P135-} ((Id "P135") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-otherpunct-bar-37 ::' rest , 2)
len-dec-rewrite {- P136-} ((Id "P136") :: _::_(ParseTree parsed-otherpunct-bar-36) rest) = just (ParseTree parsed-otherpunct-bar-37 ::' rest , 2)
len-dec-rewrite {- P137-} ((Id "P137") :: _::_(InputChar 'ε') rest) = just (ParseTree parsed-otherpunct-bar-38 ::' rest , 2)
len-dec-rewrite {- P138-} ((Id "P138") :: _::_(ParseTree parsed-otherpunct-bar-37) rest) = just (ParseTree parsed-otherpunct-bar-38 ::' rest , 2)
len-dec-rewrite {- P139-} ((Id "P139") :: _::_(InputChar 'ρ') rest) = just (ParseTree parsed-otherpunct-bar-39 ::' rest , 2)
...
len-dec-rewrite {- P140-} ((Id "P140") :: _::_(ParseTree parsed-otherpunct-bar-38) rest) = just (ParseTree parsed-otherpunct-bar-39 ::' rest , 2)
len-dec-rewrite {- P141-} ((Id "P141") :: _::_(InputChar 'Λ') rest) = just (ParseTree parsed-otherpunct-bar-40 ::' rest , 2)
len-dec-rewrite {- P142-} ((Id "P142") :: _::_(ParseTree parsed-otherpunct-bar-39) rest) = just (ParseTree parsed-otherpunct-bar-40 ::' rest , 2)
len-dec-rewrite {- P143-} ((Id "P143") :: _::_(InputChar '?') rest) = just (ParseTree parsed-otherpunct-bar-41 ::' rest , 2)
len-dec-rewrite {- P144-} ((Id "P144") :: _::_(ParseTree parsed-otherpunct-bar-40) rest) = just (ParseTree parsed-otherpunct-bar-41 ::' rest , 2)
len-dec-rewrite {- P145-} ((Id "P145") :: _::_(InputChar '⇒') rest) = just (ParseTree parsed-otherpunct-bar-42 ::' rest , 2)
len-dec-rewrite {- P146-} ((Id "P146") :: _::_(ParseTree parsed-otherpunct-bar-41) rest) = just (ParseTree parsed-otherpunct-bar-42 ::' rest , 2)
len-dec-rewrite {- P147-} ((Id "P147") :: _::_(InputChar '}') rest) = just (ParseTree parsed-otherpunct-bar-43 ::' rest , 2)
len-dec-rewrite {- P148-} ((Id "P148") :: _::_(ParseTree parsed-otherpunct-bar-42) rest) = just (ParseTree parsed-otherpunct-bar-43 ::' rest , 2)
len-dec-rewrite {- P149-} ((Id "P149") :: _::_(InputChar '{') rest) = just (ParseTree parsed-otherpunct-bar-44 ::' rest , 2)
...
len-dec-rewrite {- P150-} ((Id "P150") :: _::_(ParseTree parsed-otherpunct-bar-43) rest) = just (ParseTree parsed-otherpunct-bar-44 ::' rest , 2)
len-dec-rewrite {- P151-} ((Id "P151") :: _::_(InputChar '!') rest) = just (ParseTree parsed-otherpunct-bar-45 ::' rest , 2)
len-dec-rewrite {- P152-} ((Id "P152") :: _::_(ParseTree parsed-otherpunct-bar-44) rest) = just (ParseTree parsed-otherpunct-bar-45 ::' rest , 2)
len-dec-rewrite {- P153-} ((Id "P153") :: _::_(InputChar ',') rest) = just (ParseTree parsed-otherpunct-bar-46 ::' rest , 2)
len-dec-rewrite {- P154-} ((Id "P154") :: _::_(ParseTree parsed-otherpunct-bar-45) rest) = just (ParseTree parsed-otherpunct-bar-46 ::' rest , 2)
len-dec-rewrite {- P155-} ((Id "P155") :: _::_(InputChar ']') rest) = just (ParseTree parsed-otherpunct-bar-47 ::' rest , 2)
len-dec-rewrite {- P156-} ((Id "P156") :: _::_(ParseTree parsed-otherpunct-bar-46) rest) = just (ParseTree parsed-otherpunct-bar-47 ::' rest , 2)
len-dec-rewrite {- P157-} ((Id "P157") :: _::_(InputChar '[') rest) = just (ParseTree parsed-otherpunct-bar-48 ::' rest , 2)
len-dec-rewrite {- P158-} ((Id "P158") :: _::_(ParseTree parsed-otherpunct-bar-47) rest) = just (ParseTree parsed-otherpunct-bar-48 ::' rest , 2)
len-dec-rewrite {- P159-} ((Id "P159") :: _::_(InputChar '.') rest) = just (ParseTree parsed-otherpunct-bar-49 ::' rest , 2)
...
len-dec-rewrite {- P160-} ((Id "P160") :: _::_(ParseTree parsed-otherpunct-bar-48) rest) = just (ParseTree parsed-otherpunct-bar-49 ::' rest , 2)
len-dec-rewrite {- P161-} ((Id "P161") :: _::_(InputChar ':') rest) = just (ParseTree parsed-otherpunct-bar-50 ::' rest , 2)
len-dec-rewrite {- P162-} ((Id "P162") :: _::_(ParseTree parsed-otherpunct-bar-49) rest) = just (ParseTree parsed-otherpunct-bar-50 ::' rest , 2)
len-dec-rewrite {- P163-} ((Id "P163") :: _::_(InputChar ')') rest) = just (ParseTree parsed-otherpunct-bar-51 ::' rest , 2)
len-dec-rewrite {- P164-} ((Id "P164") :: _::_(ParseTree parsed-otherpunct-bar-50) rest) = just (ParseTree parsed-otherpunct-bar-51 ::' rest , 2)
len-dec-rewrite {- P165-} ((Id "P165") :: _::_(InputChar '(') rest) = just (ParseTree parsed-otherpunct-bar-52 ::' rest , 2)
len-dec-rewrite {- P166-} ((Id "P166") :: _::_(ParseTree parsed-otherpunct-bar-51) rest) = just (ParseTree parsed-otherpunct-bar-52 ::' rest , 2)
len-dec-rewrite {- P167-} ((Id "P167") :: _::_(InputChar '●') rest) = just (ParseTree parsed-otherpunct-bar-53 ::' rest , 2)
len-dec-rewrite {- P168-} ((Id "P168") :: _::_(ParseTree parsed-otherpunct-bar-52) rest) = just (ParseTree parsed-otherpunct-bar-53 ::' rest , 2)
len-dec-rewrite {- P169-} ((Id "P169") :: _::_(InputChar '↑') rest) = just (ParseTree parsed-otherpunct-bar-54 ::' rest , 2)
...
len-dec-rewrite {- P170-} ((Id "P170") :: _::_(ParseTree parsed-otherpunct-bar-53) rest) = just (ParseTree parsed-otherpunct-bar-54 ::' rest , 2)
len-dec-rewrite {- P171-} ((Id "P171") :: _::_(InputChar '➾') rest) = just (ParseTree parsed-otherpunct-bar-55 ::' rest , 2)
len-dec-rewrite {- P172-} ((Id "P172") :: _::_(ParseTree parsed-otherpunct-bar-54) rest) = just (ParseTree parsed-otherpunct-bar-55 ::' rest , 2)
len-dec-rewrite {- P173-} ((Id "P173") :: _::_(InputChar '➔') rest) = just (ParseTree parsed-otherpunct-bar-56 ::' rest , 2)
len-dec-rewrite {- P174-} ((Id "P174") :: _::_(ParseTree parsed-otherpunct-bar-55) rest) = just (ParseTree parsed-otherpunct-bar-56 ::' rest , 2)
len-dec-rewrite {- P175-} ((Id "P175") :: _::_(InputChar '⇐') rest) = just (ParseTree parsed-otherpunct-bar-57 ::' rest , 2)
len-dec-rewrite {- P176-} ((Id "P176") :: _::_(ParseTree parsed-otherpunct-bar-56) rest) = just (ParseTree parsed-otherpunct-bar-57 ::' rest , 2)
len-dec-rewrite {- P177-} ((Id "P177") :: _::_(InputChar '·') rest) = just (ParseTree parsed-otherpunct-bar-58 ::' rest , 2)
len-dec-rewrite {- P178-} ((Id "P178") :: _::_(ParseTree parsed-otherpunct-bar-57) rest) = just (ParseTree parsed-otherpunct-bar-58 ::' rest , 2)
len-dec-rewrite {- P179-} ((Id "P179") :: _::_(InputChar '☆') rest) = just (ParseTree parsed-otherpunct-bar-59 ::' rest , 2)
...
len-dec-rewrite {- P180-} ((Id "P180") :: _::_(ParseTree parsed-otherpunct-bar-58) rest) = just (ParseTree parsed-otherpunct-bar-59 ::' rest , 2)
len-dec-rewrite {- P181-} ((Id "P181") :: _::_(InputChar '★') rest) = just (ParseTree parsed-otherpunct-bar-60 ::' rest , 2)
len-dec-rewrite {- P182-} ((Id "P182") :: _::_(ParseTree parsed-otherpunct-bar-59) rest) = just (ParseTree parsed-otherpunct-bar-60 ::' rest , 2)
len-dec-rewrite {- P183-} ((Id "P183") :: _::_(InputChar 'π') rest) = just (ParseTree parsed-otherpunct-bar-61 ::' rest , 2)
len-dec-rewrite {- P184-} ((Id "P184") :: _::_(ParseTree parsed-otherpunct-bar-60) rest) = just (ParseTree parsed-otherpunct-bar-61 ::' rest , 2)
len-dec-rewrite {- P185-} ((Id "P185") :: _::_(InputChar '∀') rest) = just (ParseTree parsed-otherpunct-bar-62 ::' rest , 2)
len-dec-rewrite {- P186-} ((Id "P186") :: _::_(ParseTree parsed-otherpunct-bar-61) rest) = just (ParseTree parsed-otherpunct-bar-62 ::' rest , 2)
len-dec-rewrite {- P187-} ((Id "P187") :: _::_(InputChar 'λ') rest) = just (ParseTree parsed-otherpunct-bar-63 ::' rest , 2)
len-dec-rewrite {- P188-} ((Id "P188") :: _::_(ParseTree parsed-otherpunct-bar-62) rest) = just (ParseTree parsed-otherpunct-bar-63 ::' rest , 2)
len-dec-rewrite {- P189-} ((Id "P189") :: _::_(InputChar 'ι') rest) = just (ParseTree parsed-otherpunct-bar-64 ::' rest , 2)
...
len-dec-rewrite {- P190-} ((Id "P190") :: _::_(ParseTree parsed-otherpunct-bar-63) rest) = just (ParseTree parsed-otherpunct-bar-64 ::' rest , 2)
len-dec-rewrite {- P191-} ((Id "P191") :: _::_(InputChar 'Π') rest) = just (ParseTree parsed-otherpunct-bar-65 ::' rest , 2)
len-dec-rewrite {- P192-} ((Id "P192") :: _::_(ParseTree parsed-otherpunct-bar-64) rest) = just (ParseTree parsed-otherpunct-bar-65 ::' rest , 2)
len-dec-rewrite {- P193-} ((Id "P193") :: _::_(InputChar '□') rest) = just (ParseTree parsed-otherpunct-bar-66 ::' rest , 2)
len-dec-rewrite {- P194-} ((Id "P194") :: _::_(ParseTree parsed-otherpunct-bar-65) rest) = just (ParseTree parsed-otherpunct-bar-66 ::' rest , 2)
len-dec-rewrite {- P195-} ((Id "P195") :: _::_(InputChar '|') rest) = just (ParseTree parsed-otherpunct-bar-67 ::' rest , 2)
len-dec-rewrite {- P196-} ((Id "P196") :: _::_(ParseTree parsed-otherpunct-bar-66) rest) = just (ParseTree parsed-otherpunct-bar-67 ::' rest , 2)
len-dec-rewrite {- P197-} ((Id "P197") :: _::_(ParseTree parsed-otherpunct-bar-67) rest) = just (ParseTree parsed-otherpunct ::' rest , 2)
len-dec-rewrite {- P198-} ((Id "P198") :: _::_(InputChar '%') rest) = just (ParseTree parsed-anychar-bar-68 ::' rest , 2)
len-dec-rewrite {- P199-} ((Id "P199") :: _::_(ParseTree parsed-otherpunct) rest) = just (ParseTree parsed-anychar-bar-68 ::' rest , 2)
...
len-dec-rewrite {- P200-} ((Id "P200") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-anychar-bar-69 ::' rest , 2)
len-dec-rewrite {- P201-} ((Id "P201") :: _::_(ParseTree parsed-anychar-bar-68) rest) = just (ParseTree parsed-anychar-bar-69 ::' rest , 2)
len-dec-rewrite {- P202-} ((Id "P202") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-anychar-bar-70 ::' rest , 2)
len-dec-rewrite {- P203-} ((Id "P203") :: _::_(ParseTree parsed-anychar-bar-69) rest) = just (ParseTree parsed-anychar-bar-70 ::' rest , 2)
len-dec-rewrite {- P204-} ((Id "P204") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree parsed-anychar-bar-71 ::' rest , 2)
len-dec-rewrite {- P205-} ((Id "P205") :: _::_(ParseTree parsed-anychar-bar-70) rest) = just (ParseTree parsed-anychar-bar-71 ::' rest , 2)
len-dec-rewrite {- P206-} ((Id "P206") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree parsed-anychar-bar-72 ::' rest , 2)
len-dec-rewrite {- P207-} ((Id "P207") :: _::_(ParseTree parsed-anychar-bar-71) rest) = just (ParseTree parsed-anychar-bar-72 ::' rest , 2)
len-dec-rewrite {- P208-} ((Id "P208") :: _::_(ParseTree parsed-anychar-bar-72) rest) = just (ParseTree parsed-anychar ::' rest , 2)
...
len-dec-rewrite {- P210-} ((Id "P210") :: (ParseTree parsed-anychar) :: _::_(ParseTree parsed-comment-star-73) rest) = just (ParseTree parsed-comment-star-73 ::' rest , 3)
len-dec-rewrite {- P211-} ((Id "P211") :: (InputChar '%') :: (ParseTree parsed-comment-star-73) :: _::_(InputChar '\n') rest) = just (ParseTree parsed-comment ::' rest , 4)
len-dec-rewrite {- P212-} ((Id "P212") :: _::_(InputChar ' ') rest) = just (ParseTree parsed-aws-bar-74 ::' rest , 2)
len-dec-rewrite {- P213-} ((Id "P213") :: _::_(ParseTree parsed-comment) rest) = just (ParseTree parsed-aws-bar-74 ::' rest , 2)
len-dec-rewrite {- P214-} ((Id "P214") :: _::_(InputChar '\t') rest) = just (ParseTree parsed-aws-bar-75 ::' rest , 2)
len-dec-rewrite {- P215-} ((Id "P215") :: _::_(ParseTree parsed-aws-bar-74) rest) = just (ParseTree parsed-aws-bar-75 ::' rest , 2)
len-dec-rewrite {- P216-} ((Id "P216") :: _::_(InputChar '\n') rest) = just (ParseTree parsed-aws-bar-76 ::' rest , 2)
len-dec-rewrite {- P217-} ((Id "P217") :: _::_(ParseTree parsed-aws-bar-75) rest) = just (ParseTree parsed-aws-bar-76 ::' rest , 2)
len-dec-rewrite {- P218-} ((Id "P218") :: _::_(ParseTree parsed-aws-bar-76) rest) = just (ParseTree parsed-aws ::' rest , 2)
len-dec-rewrite {- P219-} ((Id "P219") :: _::_(ParseTree parsed-aws) rest) = just (ParseTree parsed-ws-plus-77 ::' rest , 2)
...
len-dec-rewrite {- P220-} ((Id "P220") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ws-plus-77) rest) = just (ParseTree parsed-ws-plus-77 ::' rest , 3)
len-dec-rewrite {- P221-} ((Id "P221") :: _::_(ParseTree parsed-ws-plus-77) rest) = just (ParseTree parsed-ws ::' rest , 2)
len-dec-rewrite {- P223-} ((Id "P223") :: (ParseTree parsed-aws) :: _::_(ParseTree parsed-ows-star-78) rest) = just (ParseTree parsed-ows-star-78 ::' rest , 3)
len-dec-rewrite {- P224-} ((Id "P224") :: _::_(ParseTree parsed-ows-star-78) rest) = just (ParseTree parsed-ows ::' rest , 2)
...
len-dec-rewrite {- P80-} ((Id "P80") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree (parsed-var-bar-11 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P81-} ((Id "P81") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree (parsed-var-bar-11 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P83-} ((Id "P83") :: (ParseTree (parsed-var-bar-11 x0)) :: _::_(ParseTree (parsed-var-star-12 x1)) rest) = just (ParseTree (parsed-var-star-12 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P84-} ((Id "P84") :: _::_(InputChar '_') rest) = just (ParseTree (parsed-var-bar-13 (string-append 0 (char-to-string '_'))) ::' rest , 2)
len-dec-rewrite {- P85-} ((Id "P85") :: (ParseTree (parsed-alpha x0)) :: _::_(ParseTree (parsed-var-star-12 x1)) rest) = just (ParseTree (parsed-var-bar-13 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P86-} ((Id "P86") :: _::_(ParseTree (parsed-var-bar-13 x0)) rest) = just (ParseTree (parsed-var (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P87-} ((Id "P87") :: (InputChar '.') :: (InputChar '.') :: _::_(InputChar '/') rest) = just (ParseTree (parsed-fpth-plus-14 (string-append 2 (char-to-string '.') (char-to-string '.') (char-to-string '/'))) ::' rest , 4)
len-dec-rewrite {- P88-} ((Id "P88") :: (InputChar '.') :: (InputChar '.') :: (InputChar '/') :: _::_(ParseTree (parsed-fpth-plus-14 x0)) rest) = just (ParseTree (parsed-fpth-plus-14 (string-append 3 (char-to-string '.') (char-to-string '.') (char-to-string '/') x0)) ::' rest , 5)
len-dec-rewrite {- P89-} ((Id "P89") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree (parsed-fpth-bar-15 (string-append 0 x0)) ::' rest , 2)
...
len-dec-rewrite {- P90-} ((Id "P90") :: _::_(ParseTree (parsed-fpth-plus-14 x0)) rest) = just (ParseTree (parsed-fpth-bar-15 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P91-} ((Id "P91") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree (parsed-fpth-bar-16 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P92-} ((Id "P92") :: _::_(InputChar '/') rest) = just (ParseTree (parsed-fpth-bar-16 (string-append 0 (char-to-string '/'))) ::' rest , 2)
len-dec-rewrite {- P93-} ((Id "P93") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree (parsed-fpth-bar-17 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P94-} ((Id "P94") :: _::_(ParseTree (parsed-fpth-bar-16 x0)) rest) = just (ParseTree (parsed-fpth-bar-17 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P96-} ((Id "P96") :: (ParseTree (parsed-fpth-bar-17 x0)) :: _::_(ParseTree (parsed-fpth-star-18 x1)) rest) = just (ParseTree (parsed-fpth-star-18 (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P97-} ((Id "P97") :: (ParseTree (parsed-fpth-bar-15 x0)) :: _::_(ParseTree (parsed-fpth-star-18 x1)) rest) = just (ParseTree (parsed-fpth (string-append 1 x0 x1)) ::' rest , 3)
len-dec-rewrite {- P98-} ((Id "P98") :: _::_(ParseTree (parsed-alpha x0)) rest) = just (ParseTree (parsed-kvar-bar-19 (string-append 0 x0)) ::' rest , 2)
len-dec-rewrite {- P99-} ((Id "P99") :: _::_(ParseTree (parsed-numpunct x0)) rest) = just (ParseTree (parsed-kvar-bar-19 (string-append 0 x0)) ::' rest , 2)
...
len-dec-rewrite {- PiInj-} ((Id "PiInj") :: (ParseTree (parsed-posinfo x0)) :: (InputChar 'π') :: (ParseTree (parsed-num x1)) :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-lterm x2)) rest) = just (ParseTree (parsed-lterm (norm-term (PiInj x0 x1 x2))) ::' rest , 6)
...
len-dec-rewrite {- TpLambda-} ((Id "TpLambda") :: (ParseTree (parsed-posinfo x0)) :: (InputChar 'λ') :: (ParseTree parsed-ows) :: (ParseTree (parsed-posinfo x1)) :: (ParseTree (parsed-var x2)) :: (ParseTree parsed-ows) :: (InputChar ':') :: (ParseTree parsed-ows) :: (ParseTree (parsed-tk x3)) :: (ParseTree parsed-ows) :: (InputChar '.') :: (ParseTree parsed-ows) :: _::_(ParseTree (parsed-type x4)) rest) = just (ParseTree (parsed-type (norm-type (TpLambda x0 x1 x2 x3 x4))) ::' rest , 14)
...
len-dec-rewrite {- P222-} (_::_(Id "P222") rest) = just (ParseTree parsed-ows-star-78 ::' rest , 1)
