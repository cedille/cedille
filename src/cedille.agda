...
cedille-start _anychar-bar-30 = (just "P122" , nothing , just _anychar-bar-30 , inj₁ _anychar-bar-29 :: []) :: (just "P121" , nothing , just _anychar-bar-30 , inj₂ 'β' :: []) :: []
...
cedille-start _anychar-bar-28 = (just "P118" , nothing , just _anychar-bar-28 , inj₁ _anychar-bar-27 :: []) :: (just "P117" , nothing , just _anychar-bar-28 , inj₂ '𝒌' :: []) :: []
...
cedille-start _anychar-bar-26 = (just "P114" , nothing , just _anychar-bar-26 , inj₁ _anychar-bar-25 :: []) :: (just "P113" , nothing , just _anychar-bar-26 , inj₂ 'ς' :: []) :: []
cedille-start _anychar-bar-25 = (just "P112" , nothing , just _anychar-bar-25 , inj₁ _anychar-bar-24 :: []) :: (just "P111" , nothing , just _anychar-bar-25 , inj₂ 'θ' :: []) :: []
...
cedille-start _anychar-bar-21 = (just "P104" , nothing , just _anychar-bar-21 , inj₂ '\"' :: []) :: (just "P103" , nothing , just _anychar-bar-21 , inj₂ '≃' :: []) :: []
...
len-dec-rewrite {- P111-} ((Id "P111") :: _::_(InputChar 'θ') rest) = just (ParseTree parsed-anychar-bar-25 ::' rest , 2)
len-dec-rewrite {- P112-} ((Id "P112") :: _::_(ParseTree parsed-anychar-bar-24) rest) = just (ParseTree parsed-anychar-bar-25 ::' rest , 2)
len-dec-rewrite {- P113-} ((Id "P113") :: _::_(InputChar 'ς') rest) = just (ParseTree parsed-anychar-bar-26 ::' rest , 2)
...
len-dec-rewrite {- P117-} ((Id "P117") :: _::_(InputChar '𝒌') rest) = just (ParseTree parsed-anychar-bar-28 ::' rest , 2)
...
len-dec-rewrite {- P121-} ((Id "P121") :: _::_(InputChar 'β') rest) = just (ParseTree parsed-anychar-bar-30 ::' rest , 2)
